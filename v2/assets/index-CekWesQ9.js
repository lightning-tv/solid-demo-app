...
class CoreNode extends EventEmitter {
    ...
    set src(imageUrl) {
        ...
        this.texture = this.stage.txManager.createTexture("ImageTexture", {
            ...
            enableAlphaChannel: (_a = this.props.textureOptions) == null ? void 0 : _a.enableAlphaChannel,
            loadOnMainThread: (_b = this.props.textureOptions) == null ? void 0 : _b.loadOnMainThread
        });
    }
    set imageType(type2) {
...
const _ImageTexture = class _ImageTexture extends Texture {
    ...
    static recordMetric(src, method, startTime) {
        const duration = performance.now() - startTime;
        _ImageTexture.loadMetrics.push({
            src: src,
            loadTime: duration,
            method: method,
            timestamp: Date.now()
    ...
    async loadImage(src) {
        const {premultiplyAlpha: premultiplyAlpha, sx: sx, sy: sy, sw: sw, sh: sh, loadOnMainThread: loadOnMainThread} = this.props;
        ...
        if (this.txManager.hasCreateImageBitmap === true) {
            if (loadOnMainThread !== true && isBase64Image(src) === false && this.txManager.hasWorker === true && this.txManager.imageWorkerManager !== null) {
                return this.txManager.imageWorkerManager.getImage(src, premultiplyAlpha, sx, sy, sw, sh).then(result => {
                    _ImageTexture.recordMetric(src, "worker", startTime);
                    return result;
                });
            }
            let blob;
            ...
            return this.createImageBitmap(blob, premultiplyAlpha, sx, sy, sw, sh).then(result => {
                _ImageTexture.recordMetric(src, "main", startTime);
                return result;
            });
        }
        return this.loadImageFallback(src, premultiplyAlpha != null ? premultiplyAlpha : true).then(result => {
            _ImageTexture.recordMetric(src, "main", startTime);
            return result;
        });
    }
    async getTextureSource() {
        ...
        return {
            ...
            enableAlphaChannel: (_b = this.props.enableAlphaChannel) != null ? _b : false
        };
    }
    ...
    static resolveDefaults(props2) {
        ...
        return {
            ...
            enableAlphaChannel: (_l = props2.enableAlphaChannel) != null ? _l : null,
            loadOnMainThread: (_m = props2.loadOnMainThread) != null ? _m : false
        };
    }
};

__publicField(_ImageTexture, "loadMetrics", []);
...
class CoreTextureManager extends EventEmitter {
    constructor(stage, settings) {
        ...
        __publicField(this, "enableAlphaChannel");
        __publicField(this, "textureEnableAlphaFormats");
        __publicField(this, "platform");
        ...
        const {numImageWorkers: numImageWorkers2, createImageBitmapSupport: createImageBitmapSupport, maxRetryCount: maxRetryCount, enableAlphaChannel: enableAlphaChannel, textureEnableAlphaFormats: textureEnableAlphaFormats} = settings;
        this.stage = stage;
        this.platform = stage.platform;
        this.numImageWorkers = numImageWorkers2;
        this.maxRetryCount = maxRetryCount;
        this.enableAlphaChannel = enableAlphaChannel;
        this.textureEnableAlphaFormats = textureEnableAlphaFormats;
    ...
    createTexture(textureType, props2) {
        ...
        if (textureType === "ImageTexture" && props2) {
            const p = props2;
            if (p.enableAlphaChannel === void 0 || p.enableAlphaChannel === null) {
                let useTransparency = this.enableAlphaChannel;
                if (this.textureEnableAlphaFormats && typeof p.src === "string") {
                    const ext = (_a = p.src.split(".").pop()) == null ? void 0 : _a.toLowerCase();
...
class SdfRenderOp extends CoreRenderOp {
    constructor(renderer2, shader, sdfShaderProps, quadBufferCollection, worldAlpha, clippingRect, width, height, rtt, parentHasRenderTexture, framebufferDimensions) {
        super();
        __publicField(this, "renderer");
        ...
        this.shader = shader;
        this.sdfShaderProps = sdfShaderProps;
...
class CoreTextNode extends CoreNode {
    constructor(stage, props2, textRenderer) {
        ...
        __publicField(this, "_cachedRenderOp", null);
    ...
    renderQuads(renderer2) {
        ...
        if (!this._cachedRenderOp) {
            const op = this.textRenderer.renderQuads(renderer2, this._cachedLayout, this._lastVertexBuffer, {
        ...
        if (this._cachedRenderOp) {
            ...
            renderer2.addRenderOp(this._cachedRenderOp);
        }
    }
    destroy() {
...
class Stage {
    constructor(options) {
        ...
        rootNode2.globalTransform = Matrix3d.copy(rootNode2.localTransform);
    ...
    startLoop(stage) {
        ...
        const runLoop = (currentTime = 0) => {
            ...
            if (!stage.hasSceneUpdates()) {
                stage.calculateFps();
                setTimeout(() => requestAnimationFrame(runLoop), Math.max(targetFrameTime, 15));
                if (isIdle === false) {
...
class RendererMain extends EventEmitter {
    constructor(settings, target) {
        ...
        settings = {
            ...
            enableClear: (_b = settings.enableClear) != null ? _b : true,
            targetFPS: settings.targetFPS || 0,
            numImageWorkers: settings.numImageWorkers !== void 0 ? settings.numImageWorkers : 2,
            enableContextSpy: (_c = settings.enableContextSpy) != null ? _c : false,
            forceWebGL2: (_d = settings.forceWebGL2) != null ? _d : false,
            inspector: (_e = settings.inspector) != null ? _e : false,
            inspectorOptions: (_f = settings.inspectorOptions) != null ? _f : {},
            renderEngine: settings.renderEngine,
            quadBufferSize: (_g = settings.quadBufferSize) != null ? _g : 4 * 1024 * 1024,
            fontEngines: (_h = settings.fontEngines) != null ? _h : [],
            textureProcessingTimeLimit: settings.textureProcessingTimeLimit || 10,
            canvas: settings.canvas,
            createImageBitmapSupport: settings.createImageBitmapSupport || "full",
            platform: settings.platform || null,
            maxRetryCount: (_i = settings.maxRetryCount) != null ? _i : 5,
            enableAlphaChannel: (_j = settings.enableAlphaChannel) != null ? _j : true,
        ...
        this.stage = new Stage({
            ...
            platform: platform,
            maxRetryCount: (_k = settings.maxRetryCount) != null ? _k : 5,
...
class WebGlShaderProgram {
    ...
    reuseRenderOp(node, currentRenderOp) {
        ...
        const {time: time, worldAlpha: worldAlpha, width: width, height: height} = node;
    ...
    bindRenderOp(renderOp) {
        ...
        if (parentHasRenderTexture === true && framebufferDimensions) {
            const {w: w, h: h} = framebufferDimensions;
        ...
        if (isCoreNode === false && renderOp.sdfShaderProps !== void 0) {
            const opShader = renderOp.shader;
            (_a = opShader.shaderType.onSdfBind) == null ? void 0 : _a.call(this.glw, renderOp.sdfShaderProps);
            return;
        }
...
class WebGlCtxTexture extends CoreContextTexture {
    ...
    async onLoadRequest() {
        ...
        const alpha = (_a = textureData.enableAlphaChannel) != null ? _a : false;
        const format = alpha ? glw.RGBA : glw.RGB;
        const formatBytes = alpha ? 4 : 3;
        ...
        if (isImageBitmap || tdata instanceof ImageData || isHTMLImageElement(tdata) === true) {
            ...
            this.setTextureMemUse((_c = (_b = mipmaps[0]) == null ? void 0 : _b.byteLength) != null ? _c : 0);
...
class WebGlRenderer extends CoreRenderer {
    ...
    addQuad(node) {
        ...
        let tx = props2.texture || this.stage.defaultTexture;
...
const renderQuads$1 = (renderer2, layout, vertexBuffer, renderProps) => {
    ...
    const renderOp = new SdfRenderOp(renderer2, sdfShader, {
    ...
    renderContext(node) {
        ...
        if (textureType !== TextureType.color) {
            ...
            if (textureType !== TextureType.subTexture) {
                ...
                this.context.globalAlpha = (_a = tintColor.a) != null ? _a : node.worldAlpha;
                this.context.drawImage(image2, tx, ty, width, height);
                this.context.globalAlpha = 1;
                return;
            }
            const image = texture.parentTexture.ctxTexture.getImage(tintColor);
            const props2 = texture.props;
            this.context.globalAlpha = (_b = tintColor.a) != null ? _b : node.worldAlpha;
            this.context.drawImage(image, props2.x, props2.y, props2.w, props2.h, tx, ty, width, height);
            this.context.globalAlpha = 1;
            return;
        }
...
const basePath$1 = "/solid-demo-app/v2/";
...
const basePath = "/solid-demo-app/v2/";
...
const Player = lazy(() => __vitePreload(() => import("./Player-BXI-3lwx.js"), true ? [] : void 0));

const Grid = lazy(() => __vitePreload(() => import("./Grid-ClziUlY6.js"), true ? [] : void 0));

const Loops = lazy(() => __vitePreload(() => import("./Loops-CDU43UnO.js"), true ? [] : void 0));

const Infinite = lazy(() => __vitePreload(() => import("./Infinite-Dt6yuPOv.js"), true ? [] : void 0));

const TMDBGrid = lazy(() => __vitePreload(() => import("./TMDBGrid-BjMRLJOb.js"), true ? [] : void 0));

const Portal = lazy(() => __vitePreload(() => import("./Portal-DmWyBTS2.js"), true ? [] : void 0));

const MatrixPage = lazy(() => __vitePreload(() => import("./Matrix-zMcAe2kD.js"), true ? [] : void 0));

const TextPage = lazy(() => __vitePreload(() => import("./Text-BHIuoBnc.js"), true ? [] : void 0));

const TextPosterPage = lazy(() => __vitePreload(() => import("./TextPoster-B1z9EYw5.js"), true ? [] : void 0));

const CreatePage = lazy(() => __vitePreload(() => import("./Create-B_NuAhBM.js"), true ? [] : void 0));

const ViewportPage = lazy(() => __vitePreload(() => import("./Viewport-D2i3T5U_.js"), true ? [] : void 0));

const PositioningPage = lazy(() => __vitePreload(() => import("./Positioning-CcEwWshx.js"), true ? [] : void 0));

const LayoutPage = lazy(() => __vitePreload(() => import("./Layout-PZ8M7HBT.js"), true ? [] : void 0));

const FocusBasicsPage = lazy(() => __vitePreload(() => import("./FocusBasics-D3PVp7hT.js"), true ? [] : void 0));

const KeyHandlingPage = lazy(() => __vitePreload(() => import("./KeyHandling-DQ8yA_6x.js"), true ? [] : void 0));

const TransitionsPage = lazy(() => __vitePreload(() => import("./Transitions-rRLxzNGc.js"), true ? [] : void 0));

const ComponentsPage = lazy(() => __vitePreload(() => import("./Components-B4v1fySS.js"), true ? [] : void 0));

const FocusHandlingPage = lazy(() => __vitePreload(() => import("./FocusHandling-XU51BUUF.js"), true ? [] : void 0));

const GradientsPage = lazy(() => __vitePreload(() => import("./Gradients-DLRieG4M.js"), true ? [] : void 0));

const FlexPage = lazy(() => __vitePreload(() => import("./Flex-CbOE1Tkb.js"), true ? [] : void 0));

const FlexGrowPage = lazy(() => __vitePreload(() => import("./FlexGrow-DqBtwLc2.js"), true ? [] : void 0));

const FlexMenuPage = lazy(() => __vitePreload(() => import("./FlexMenu-ByOSCguI.js"), true ? [] : void 0));

const FlexSizePage = lazy(() => __vitePreload(() => import("./FlexSize-Dkf8dfXE.js"), true ? [] : void 0));

const FlexColumnSizePage = lazy(() => __vitePreload(() => import("./FlexColumnSize-D3n6wNSJ.js"), true ? [] : void 0));

const FlexColumnPage = lazy(() => __vitePreload(() => import("./FlexColumn-NFpH_ucQ.js"), true ? [] : void 0));

const ButtonsMaterialPage = lazy(() => __vitePreload(() => import("./ButtonsMaterial-BTjevP1M.js"), true ? [] : void 0));

const SuperFlexPage = lazy(() => __vitePreload(() => import("./SuperFlex-DN1x4lwY.js"), true ? [] : void 0));

const Entity = lazy(() => __vitePreload(() => import("./Entity-CXgsryDw.js"), true ? [] : void 0));

const People = lazy(() => __vitePreload(() => import("./People-HMsaVX0P.js"), true ? [] : void 0));

const FireboltPage = lazy(() => __vitePreload(() => import("./Firebolt-DBtE4Hgn.js"), true ? [] : void 0));

const LoginPage = lazy(() => __vitePreload(() => import("./Login-CTIcFD38.js"), true ? [] : void 0));

const VirtualPage = lazy(() => __vitePreload(() => import("./Virtual-DcsgDs1T.js"), true ? [] : void 0));

const TagsPage = lazy(() => __vitePreload(() => import("./Tags-DVuKIQdN.js"), true ? [] : void 0));
                ...
                return [ createComponent(Route, {
                    ...
                    get children() {
                        return [ createComponent(Route, {
                            ...
                            path: "nested",
                            get component() {
                                return lazy(() => __vitePreload(() => import("./Nested-Bl4LdCnt.js"), true ? [] : void 0));
                            }
                        }), createComponent(Route, {
                            path: "textposter",
                            ...
                            path: "keepalive",
                            get component() {
                                return lazy(() => __vitePreload(() => import("./KeepAlive-00tOKlyv.js"), true ? [] : void 0));
                            }
                        }), createComponent(Route, {
                            path: "suspense",
                            get component() {
                                return lazy(() => __vitePreload(() => import("./suspense-srxibvMf.js"), true ? [] : void 0));
                            }
                        }), createComponent(Route, {
                            path: "superflex",
