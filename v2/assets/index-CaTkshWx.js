...
class RendererMain extends EventEmitter {
    constructor(settings, target) {
        ...
        this.stage = new Stage({
            ...
            platform: platform,
            maxRetryCount: (_j = settings.maxRetryCount) != null ? _j : 5
        });
...
function resolveNodeDefaults(props2) {
    ...
    return {
        ...
        pivot: (_Q = props2.pivot) != null ? _Q : .5,
        pivotX: (_S = (_R = props2.pivotX) != null ? _R : props2.pivot) != null ? _S : .5,
        pivotY: (_U = (_T = props2.pivotY) != null ? _T : props2.pivot) != null ? _U : .5,
...
const Player = lazy(() => __vitePreload(() => import("./Player-BKjb0TBq.js"), true ? [] : void 0));

const Grid = lazy(() => __vitePreload(() => import("./Grid-DzmEsa1V.js"), true ? [] : void 0));

const Loops = lazy(() => __vitePreload(() => import("./Loops-Bf9emFac.js"), true ? [] : void 0));

const Infinite = lazy(() => __vitePreload(() => import("./Infinite-mnhX2r7h.js"), true ? [] : void 0));

const TMDBGrid = lazy(() => __vitePreload(() => import("./TMDBGrid-dGI0V6PT.js"), true ? [] : void 0));

const Portal = lazy(() => __vitePreload(() => import("./Portal-C3_xCzVD.js"), true ? [] : void 0));

const MatrixPage = lazy(() => __vitePreload(() => import("./Matrix-ClLpS5N2.js"), true ? [] : void 0));

const TextPage = lazy(() => __vitePreload(() => import("./Text-nudimupY.js"), true ? [] : void 0));

const TextPosterPage = lazy(() => __vitePreload(() => import("./TextPoster-DMYb-ckO.js"), true ? [] : void 0));

const CreatePage = lazy(() => __vitePreload(() => import("./Create-BQliTsCh.js"), true ? [] : void 0));

const ViewportPage = lazy(() => __vitePreload(() => import("./Viewport-ZMjMawFP.js"), true ? [] : void 0));

const PositioningPage = lazy(() => __vitePreload(() => import("./Positioning-Be1pRcBU.js"), true ? [] : void 0));

const LayoutPage = lazy(() => __vitePreload(() => import("./Layout-qeQwSKaK.js"), true ? [] : void 0));

const FocusBasicsPage = lazy(() => __vitePreload(() => import("./FocusBasics-h2xQbzCF.js"), true ? [] : void 0));

const KeyHandlingPage = lazy(() => __vitePreload(() => import("./KeyHandling-DoA5ljMA.js"), true ? [] : void 0));

const TransitionsPage = lazy(() => __vitePreload(() => import("./Transitions-CAZstV4W.js"), true ? [] : void 0));

const ComponentsPage = lazy(() => __vitePreload(() => import("./Components-vRTPbm1q.js"), true ? [] : void 0));

const FocusHandlingPage = lazy(() => __vitePreload(() => import("./FocusHandling-CPpB0JAC.js"), true ? [] : void 0));

const GradientsPage = lazy(() => __vitePreload(() => import("./Gradients-BSwDwqdT.js"), true ? [] : void 0));

const FlexPage = lazy(() => __vitePreload(() => import("./Flex-DMLBQdXP.js"), true ? [] : void 0));

const FlexGrowPage = lazy(() => __vitePreload(() => import("./FlexGrow-DFmSxOsM.js"), true ? [] : void 0));

const FlexMenuPage = lazy(() => __vitePreload(() => import("./FlexMenu-CQUEj19X.js"), true ? [] : void 0));

const FlexSizePage = lazy(() => __vitePreload(() => import("./FlexSize-Bj4IHWQV.js"), true ? [] : void 0));

const FlexColumnSizePage = lazy(() => __vitePreload(() => import("./FlexColumnSize-D501hcfU.js"), true ? [] : void 0));

const FlexColumnPage = lazy(() => __vitePreload(() => import("./FlexColumn-DECNNAlm.js"), true ? [] : void 0));

const ButtonsMaterialPage = lazy(() => __vitePreload(() => import("./ButtonsMaterial-Ce-y9gzv.js"), true ? [] : void 0));

const SuperFlexPage = lazy(() => __vitePreload(() => import("./SuperFlex-BXr3UmBY.js"), true ? [] : void 0));

const Entity = lazy(() => __vitePreload(() => import("./Entity-A_VzHWmG.js"), true ? [] : void 0));

const People = lazy(() => __vitePreload(() => import("./People-BWn2W32v.js"), true ? [] : void 0));

const FireboltPage = lazy(() => __vitePreload(() => import("./Firebolt-C8uTe3BE.js"), true ? [] : void 0));

const LoginPage = lazy(() => __vitePreload(() => import("./Login-Bf3YOrKq.js"), true ? [] : void 0));

const VirtualPage = lazy(() => __vitePreload(() => import("./Virtual-WxYw7D00.js"), true ? [] : void 0));

const TagsPage = lazy(() => __vitePreload(() => import("./Tags-Bfu2I87N.js"), true ? [] : void 0));
                ...
                return [ createComponent(Route, {
                    ...
                    get children() {
                        return [ createComponent(Route, {
                            ...
                            path: "nested",
                            get component() {
                                return lazy(() => __vitePreload(() => import("./Nested-p0cVv3i3.js"), true ? [] : void 0));
                            }
                        }), createComponent(Route, {
                            path: "textposter",
                            ...
                            path: "keepalive",
                            get component() {
                                return lazy(() => __vitePreload(() => import("./KeepAlive-DcFhDH4o.js"), true ? [] : void 0));
                            }
                        }), createComponent(Route, {
                            path: "suspense",
                            get component() {
                                return lazy(() => __vitePreload(() => import("./suspense-B8YVcPuO.js"), true ? [] : void 0));
                            }
                        }), createComponent(Route, {
                            path: "superflex",
