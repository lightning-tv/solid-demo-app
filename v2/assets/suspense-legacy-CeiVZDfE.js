    ...
    System.register([ "./index-legacy-Dc7vSCGh.js" ], function(exports, module) {
        ...
        return {
            setters: [ function(module) {
                ...
                Suspense = module.aa;
                createTextNode = module.ab;
                insertNode = module.a7;
                use = module.p;
            ...
            execute: function execute() {
                ...
                function SuspensePage() {
                    ...
                    var lastCount = 0;
                    var _createResource = createResource(_asyncToGenerator(_regenerator().m(function _callee() {
                    ...
                    }))), _createResource2 = _slicedToArray(_createResource, 2), data = _createResource2[0], refetch = _createResource2[1].refetch;
                    return function() {
                        ...
                        insert(_el$, createComponent(Suspense, {
                            ...
                            get children() {
                                ...
                                use(function(elm) {
                                    var _createSignal = createSignal(0), _createSignal2 = _slicedToArray(_createSignal, 2), count = _createSignal2[0], setCount = _createSignal2[1];
                                    onMount(function() {
