        ...
        return {
            ...
            execute: function execute() {
                ...
                var Input = function Input(props) {
                    ...
                    var _ref = (_props$valueSignal = props.valueSignal) !== null && _props$valueSignal !== void 0 ? _props$valueSignal : createSignal(""), _ref2 = _slicedToArray(_ref, 2), value = _ref2[0], setValue = _ref2[1];
                    var _createSignal = createSignal((_props$position = props.position) !== null && _props$position !== void 0 ? _props$position : value().length), _createSignal2 = _slicedToArray(_createSignal, 2), position = _createSignal2[0], setPosition = _createSignal2[1];
                    var _ref3 = (_props$keyEvents = props.keyEvents) !== null && _props$keyEvents !== void 0 ? _props$keyEvents : createSignal(""), _ref4 = _slicedToArray(_ref3, 2), keyEvent = _ref4[0], setKeyEvent = _ref4[1];
                ...
                var Keyboard = function Keyboard(props) {
                    var _createSignal3 = createSignal("default"), _createSignal4 = _slicedToArray(_createSignal3, 2), layout = _createSignal4[0], setLayout = _createSignal4[1];
                ...
                var LoginPage = exports("default", function() {
                    ...
                    var _keyEvent2 = _slicedToArray(keyEvent, 2), _keyEvent = _keyEvent2[0], setKeyEvent = _keyEvent2[1];
                    var onEnter = function onEnter(_e, _keyboard, key) {
                        if (typeof key.key === "string") {
                            setKeyEvent(key.key);
