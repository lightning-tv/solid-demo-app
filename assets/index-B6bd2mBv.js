...
const Player = lazy(() => __vitePreload(() => import("./Player-Cmt82dn6.js"), true ? [] : void 0));

const Grid = lazy(() => __vitePreload(() => import("./Grid-ecirrI9r.js"), true ? [] : void 0));

const Loops = lazy(() => __vitePreload(() => import("./Loops-B-DsZCxN.js"), true ? [] : void 0));

const Infinite = lazy(() => __vitePreload(() => import("./Infinite-DLD56dc7.js"), true ? [] : void 0));

const TMDBGrid = lazy(() => __vitePreload(() => import("./TMDBGrid-CI7doMPI.js"), true ? [] : void 0));

const Portal = lazy(() => __vitePreload(() => import("./Portal-BSSafRdY.js"), true ? [] : void 0));

const MatrixPage = lazy(() => __vitePreload(() => import("./Matrix-U21eUtRq.js"), true ? [] : void 0));

const TextPage = lazy(() => __vitePreload(() => import("./Text-DKdpFYMw.js"), true ? [] : void 0));

const TextPosterPage = lazy(() => __vitePreload(() => import("./TextPoster-Q5Dh00IP.js"), true ? [] : void 0));

const CreatePage = lazy(() => __vitePreload(() => import("./Create-Dj2ToMPb.js"), true ? [] : void 0));

const ViewportPage = lazy(() => __vitePreload(() => import("./Viewport-Bgh7MMAm.js"), true ? [] : void 0));

const PositioningPage = lazy(() => __vitePreload(() => import("./Positioning-DM2H4Dbe.js"), true ? [] : void 0));

const LayoutPage = lazy(() => __vitePreload(() => import("./Layout-CeZqlsa0.js"), true ? [] : void 0));

const FocusBasicsPage = lazy(() => __vitePreload(() => import("./FocusBasics-CLr-ic1j.js"), true ? [] : void 0));

const KeyHandlingPage = lazy(() => __vitePreload(() => import("./KeyHandling-CLOtdbZJ.js"), true ? [] : void 0));

const TransitionsPage = lazy(() => __vitePreload(() => import("./Transitions-CyBlJ-Hb.js"), true ? [] : void 0));

const ComponentsPage = lazy(() => __vitePreload(() => import("./Components-DwXU7xNe.js"), true ? [] : void 0));

const FocusHandlingPage = lazy(() => __vitePreload(() => import("./FocusHandling-RoTkBcjg.js"), true ? [] : void 0));

const GradientsPage = lazy(() => __vitePreload(() => import("./Gradients-C5zahZGK.js"), true ? [] : void 0));

const FlexPage = lazy(() => __vitePreload(() => import("./Flex-BO6fYVL-.js"), true ? [] : void 0));

const FlexGrowPage = lazy(() => __vitePreload(() => import("./FlexGrow-DLwCUXzS.js"), true ? [] : void 0));

const FlexMenuPage = lazy(() => __vitePreload(() => import("./FlexMenu-BloBVMWp.js"), true ? [] : void 0));

const FlexSizePage = lazy(() => __vitePreload(() => import("./FlexSize-Iy0M2UVJ.js"), true ? [] : void 0));

const FlexColumnSizePage = lazy(() => __vitePreload(() => import("./FlexColumnSize-CP2JsyB4.js"), true ? [] : void 0));

const FlexColumnPage = lazy(() => __vitePreload(() => import("./FlexColumn-DIVVFfHY.js"), true ? [] : void 0));

const ButtonsMaterialPage = lazy(() => __vitePreload(() => import("./ButtonsMaterial-Bm7gmi0x.js"), true ? [] : void 0));

const SuperFlexPage = lazy(() => __vitePreload(() => import("./SuperFlex-BDM-ob_i.js"), true ? [] : void 0));

const Entity = lazy(() => __vitePreload(() => import("./Entity-BGNxbMxx.js"), true ? [] : void 0));

const People = lazy(() => __vitePreload(() => import("./People-DlfqEGiI.js"), true ? [] : void 0));

const FireboltPage = lazy(() => __vitePreload(() => import("./Firebolt-CbEa8V0E.js"), true ? [] : void 0));

const LoginPage = lazy(() => __vitePreload(() => import("./Login-CHySZ5lr.js"), true ? [] : void 0));

const VirtualPage = lazy(() => __vitePreload(() => import("./Virtual-DkTrAvdD.js"), true ? [] : void 0));

const TagsPage = lazy(() => __vitePreload(() => import("./Tags-CMuSLUjX.js"), true ? [] : void 0));

const ImagePerformance = lazy(() => __vitePreload(() => import("./ImagePerformance-jUYzKF67.js"), true ? [] : void 0));

const LargeImagePerformance = lazy(() => __vitePreload(() => import("./LargeImagePerformance-JMfqCLcT.js"), true ? [] : void 0));

const MixedImagePerformance = lazy(() => __vitePreload(() => import("./MixedImagePerformance-D3CeC7VL.js"), true ? [] : void 0));

const TextureCompressionPerformance = lazy(() => __vitePreload(() => import("./TextureCompressionPerformance-BklPnJvI.js"), true ? [] : void 0));
                ...
                return [ createComponent(Route, {
                    ...
                    get children() {
                        return [ createComponent(Route, {
                            ...
                            path: "nested",
                            get component() {
                                return lazy(() => __vitePreload(() => import("./Nested-vBU-cp80.js"), true ? [] : void 0));
                            }
                        }), createComponent(Route, {
                            path: "textposter",
                            ...
                            path: "keepalive",
                            get component() {
                                return lazy(() => __vitePreload(() => import("./KeepAlive-CdeXTJsy.js"), true ? [] : void 0));
                            }
                        }), createComponent(Route, {
                            path: "suspense",
                            get component() {
                                return lazy(() => __vitePreload(() => import("./suspense-o25W1-Tk.js"), true ? [] : void 0));
                            }
                        }), createComponent(Route, {
                            path: "superflex",
