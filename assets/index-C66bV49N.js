const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Buttons-1khF2JdL.js","assets/Button-wp-Gs1bP.js","assets/Components-CDf_H5VW.js","assets/Entity-B7b77sOZ.js","assets/Login-BcWm02DQ.js"])))=>i.map(i=>d[i]);
...
class CoreNode extends EventEmitter {
  ...
  destroy() {
    ...
    for (let i = 0, length = children2.length; i < length; i++) {
      children2[i].destroy();
    }
    this.parent = null;
    if (this.rtt) {
...
function createRouterContext(integration, branches, getContext, options = {}) {
  ...
  const collectDynamicParams = (branches2) => {
    const dynamicParams = [];
    branches2.forEach((branch) => {
      branch.routes.forEach((route) => {
        if (route.pattern) {
          const matches2 = route.pattern.match(/:(\w+)/g);
          if (matches2) {
            matches2.forEach((param) => {
  ...
  const SUPPORTS_PROXY2 = typeof Proxy === "function";
  const paramsHandler = () => {
    const m = matches();
    const params3 = {};
  ...
  const params2 = SUPPORTS_PROXY2 ? createMemoObject(paramsHandler) : createMemoWithoutProxy(paramsHandler, collectDynamicParams(branches()));
  const baseRoute = {
    pattern: basePath2,
    path: () => basePath2,
    outlet: () => null,
...
function withScrolling(isRow) {
  ...
  return (selected, componentRef, selectedElement, lastSelected) => {
    ...
    let rootPosition = (_b = (_a2 = componentRef._targetPosition) != null ? _a2 : componentRef[axis]) != null ? _b : 0;
  ...
  return createComponent(View, mergeProps(props, {
    ...
    get style() {
      ...
      return [
        props.style,
        //
        styles$6.Container.tones[(_a2 = props.tone) != null ? _a2 : styles$6.tone],
  ...
  return createComponent(View, mergeProps(props, {
    ...
    get style() {
      ...
      return [
        props.style,
        //
        styles$3.Container.tones[(_a2 = props.tone) != null ? _a2 : styles$3.tone],
        styles$3.Container.base
      ];
    }
  }));
};
...
const Grid = lazy(() => __vitePreload(() => import("./Grid-DXkj_laK.js"), true ? [] : void 0));
const Portal = lazy(() => __vitePreload(() => import("./Portal-Ch_7NrXP.js"), true ? [] : void 0));
const TextPage = lazy(() => __vitePreload(() => import("./Text-B8tdjB05.js"), true ? [] : void 0));
const CreatePage = lazy(() => __vitePreload(() => import("./Create-B1Ds0bc6.js"), true ? [] : void 0));
const ViewportPage = lazy(() => __vitePreload(() => import("./Viewport-vwrv57US.js"), true ? [] : void 0));
const ButtonsPage = lazy(() => __vitePreload(() => import("./Buttons-1khF2JdL.js"), true ? __vite__mapDeps([0,1]) : void 0));
const PositioningPage = lazy(() => __vitePreload(() => import("./Positioning-DtGnxVzd.js"), true ? [] : void 0));
const TransitionsPage = lazy(() => __vitePreload(() => import("./Transitions-CtkINIG8.js"), true ? [] : void 0));
const ComponentsPage = lazy(() => __vitePreload(() => import("./Components-CDf_H5VW.js"), true ? __vite__mapDeps([2,1]) : void 0));
const FocusHandlingPage = lazy(() => __vitePreload(() => import("./FocusHandling-7Zfe-xAN.js"), true ? [] : void 0));
const GradientsPage = lazy(() => __vitePreload(() => import("./Gradients-BtSi3prm.js"), true ? [] : void 0));
const FlexPage = lazy(() => __vitePreload(() => import("./Flex-Bwjqd1Mb.js"), true ? [] : void 0));
const FlexSizePage = lazy(() => __vitePreload(() => import("./FlexSize-BIpnoQvQ.js"), true ? [] : void 0));
const FlexColumnSizePage = lazy(() => __vitePreload(() => import("./FlexColumnSize-Bwhpf8pn.js"), true ? [] : void 0));
const FlexColumnPage = lazy(() => __vitePreload(() => import("./FlexColumn-Bi9Hhwxg.js"), true ? [] : void 0));
const ButtonsMaterialPage = lazy(() => __vitePreload(() => import("./ButtonsMaterial-Cur3W0DH.js"), true ? [] : void 0));
const SuperFlexPage = lazy(() => __vitePreload(() => import("./SuperFlex-Bxs-lz9X.js"), true ? [] : void 0));
const Entity = lazy(() => __vitePreload(() => import("./Entity-B7b77sOZ.js"), true ? __vite__mapDeps([3,1]) : void 0));
const People = lazy(() => __vitePreload(() => import("./People-DCwZss8g.js"), true ? [] : void 0));
const LoginPage = lazy(() => __vitePreload(() => import("./Login-BcWm02DQ.js"), true ? __vite__mapDeps([4,1]) : void 0));
