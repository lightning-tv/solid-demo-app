...
(function () {
  ...
  System.register(['./index-legacy-DI1vmr81.js'], function (exports, module) {
    ...
    var useNavigate, useFocusStack, children, createSelector, createEffect, Announcer, createComponent, memo, View, Text, Column, Row, For, mergeProps, assertTruthy, createSignal;
    return {
      setters: [function (module) {
        useNavigate = module.y;
        useFocusStack = module.z;
        children = module.A;
