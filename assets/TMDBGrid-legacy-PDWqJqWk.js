  ...
  System.register(['./index-legacy-nyPv-R9z.js'], function (exports, module) {
    ...
    return {
      setters: [module => {
        ...
        activeElement = module.l;
        Text = module.T;
        ContentBlock = module.n;
        Poster = module.P;
      }],
      execute: function execute() {
        var Grid = props => {
          ...
          var baseColumns = 4;
          var columns = createMemo(() => props.columns || baseColumns);
          var totalWidth = createMemo(() => {
          ...
          var handleHorizontalFocus = (delta, elm) => {
            if (!props.items || props.items.length === 0) return false;
            var newIndex = focusedIndex() + delta;
          ...
          var scrollY = createMemo(() => -Math.floor(focusedIndex() / columns()) * totalHeight() + (props.y || 0));
        ...
        var TMDB = exports("default", props => {
