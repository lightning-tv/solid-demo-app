  ...
  `);
    ...
    `;
        ...
        function createComputed(fn, value, options) {
          var c = createComputation(fn, value, true, STALE, options);
          updateComputation(c);
        }
        function createRenderEffect(fn, value, options) {
          var c = createComputation(fn, value, false, STALE, options);
          updateComputation(c);
        }
        ...
        function createMemo(fn, value, options) {
          options = options ? Object.assign({}, signalOptions, options) : signalOptions;
          var c = createComputation(fn, value, true, 0, options);
          c.observers = null;
        ...
        function devComponent(Comp, props) {
          var c = createComputation(() => untrack(() => {
            Object.assign(Comp, {
              [$DEVCOMP]: true
            });
            return Comp(props);
        ...
        function children(fn) {
          ...
          var memo = createMemo(() => resolveChildren(children()), undefined, {
            name: "children"
          });
          memo.toArray = () => {
            var c = memo();
        ...
        var Grid = lazy(() => __vitePreload(() => module.import('./Grid-legacy-bmy_OVxt.js'), false ? __VITE_PRELOAD__ : void 0));
        var Portal = lazy(() => __vitePreload(() => module.import('./Portal-legacy-DMw7aq_U.js'), false ? __VITE_PRELOAD__ : void 0));
        var TextPage = lazy(() => __vitePreload(() => module.import('./Text-legacy-BYBeVOKx.js'), false ? __VITE_PRELOAD__ : void 0));
        var CreatePage = lazy(() => __vitePreload(() => module.import('./Create-legacy-COF3Pyg4.js'), false ? __VITE_PRELOAD__ : void 0));
        var ViewportPage = lazy(() => __vitePreload(() => module.import('./Viewport-legacy-ifynQ9Sx.js'), false ? __VITE_PRELOAD__ : void 0));
        var ButtonsPage = lazy(() => __vitePreload(() => module.import('./Buttons-legacy-cwK07CYP.js'), false ? __VITE_PRELOAD__ : void 0));
        var FlexPage = lazy(() => __vitePreload(() => module.import('./Flex-legacy-COFBGo7n.js'), false ? __VITE_PRELOAD__ : void 0));
        var FlexSizePage = lazy(() => __vitePreload(() => module.import('./FlexSize-legacy-29JGWtQt.js'), false ? __VITE_PRELOAD__ : void 0));
        var FlexColumnSizePage = lazy(() => __vitePreload(() => module.import('./FlexColumnSize-legacy-BHZPFIuV.js'), false ? __VITE_PRELOAD__ : void 0));
        var FlexColumnPage = lazy(() => __vitePreload(() => module.import('./FlexColumn-legacy-BV8I47SH.js'), false ? __VITE_PRELOAD__ : void 0));
        var ButtonsMaterialPage = lazy(() => __vitePreload(() => module.import('./ButtonsMaterial-legacy-DjMLXq7F.js'), false ? __VITE_PRELOAD__ : void 0));
        var SuperFlexPage = lazy(() => __vitePreload(() => module.import('./SuperFlex-legacy-DxHKHNdd.js'), false ? __VITE_PRELOAD__ : void 0));
        var Entity = lazy(() => __vitePreload(() => module.import('./Entity-legacy-xnzVUP8Z.js'), false ? __VITE_PRELOAD__ : void 0));
        var People = lazy(() => __vitePreload(() => module.import('./People-legacy-EZxvtJHE.js'), false ? __VITE_PRELOAD__ : void 0));
        var LoginPage = lazy(() => __vitePreload(() => module.import('./Login-legacy-B4ZUvGos.js'), false ? __VITE_PRELOAD__ : void 0));
...
//# sourceMappingURL=index-legacy-DNGf9Mtw.js.map
