...
(function () {
  ...
  System.register(['./index-legacy-B0YqatHW.js', './Button-legacy-C09y2T3l.js'], function (exports, module) {
    ...
    var createSignal, createRenderEffect, on, createRoot, ElementNode, onCleanup, memo, children, setGlobalBackground, createComponent, View, Text, Dynamic, For, mergeProps, Button;
    return {
      setters: [function (module) {
        createSignal = module.c;
        createRenderEffect = module.r;
        on = module.o;
        createRoot = module.v;
