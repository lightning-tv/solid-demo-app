        ...
        return {
            ...
            execute: function execute() {
                ...
                function createPersistentComponent(fn) {
                    ...
                    var owner;
                    var dispose = null;
                    var _createSignal = createSignal(null), _createSignal2 = _slicedToArray(_createSignal, 2), props = _createSignal2[0], setProps = _createSignal2[1];
                ...
                function KeepAlivePage() {
                    var _createSignal3 = createSignal(0), _createSignal4 = _slicedToArray(_createSignal3, 2), counter = _createSignal4[0], setCounter = _createSignal4[1];
