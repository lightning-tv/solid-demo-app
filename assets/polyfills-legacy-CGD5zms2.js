(function () {
  ...
  var toString$p = uncurryThis$Y({}.toString);
  ...
  var process$3 = globalThis$Q.process;
  ...
  var defineGlobalProperty$3 = function (key, value) {
    try {
      defineProperty$b(globalThis$O, key, { value: value, configurable: true, writable: true });
    } catch (error) {
  ...
  var toString$o = uncurryThis$U(1.0.toString);
  ...
  var ie8DomDefine = !DESCRIPTORS$A && !fails$U(function () {
    // eslint-disable-next-line es/no-object-defineproperty -- required for testing
  ...
  var v8PrototypeDefineBug = DESCRIPTORS$y && fails$T(function () {
    // eslint-disable-next-line es/no-object-defineproperty -- required for testing
  ...
  var createNonEnumerableProperty$e = DESCRIPTORS$w ? function (object, key, value) {
  ...
  var TypeError$8 = globalThis$J.TypeError;
  ...
  var CONFIGURABLE_LENGTH = DESCRIPTORS$u && !fails$S(function () {
  ...
  var makeBuiltIn$2 = makeBuiltIn$3.exports = function (value, name, options) {
    ...
    if (!hasOwn$q(value, 'name') || (CONFIGURABLE_FUNCTION_NAME$2 && value.name !== name)) {
      if (DESCRIPTORS$u) defineProperty$a(value, 'name', { value: name, configurable: true });
    ...
    try {
      if (options && hasOwn$q(options, 'constructor') && options.constructor) {
        if (DESCRIPTORS$u) defineProperty$a(value, 'prototype', { writable: false });
  ...
  var concat$3 = uncurryThis$Q([].concat);
  ...
  var isForced$5 = function (feature, detection) {
    ...
    return value === POLYFILL ? true
      : value === NATIVE ? false
      : isCallable$m(detection) ? fails$R(detection)
      : !!detection;
  };
  ...
  */
  ...
  var exec$7 = uncurryThis$M(constructorRegExp.exec);
  ...
  var isConstructor$4 = !construct$1 || fails$Q(function () {
    var called;
  ...
  var $Symbol = globalThis$G.Symbol;
  var SymbolPrototype$1 = $Symbol && $Symbol[PROTOTYPE$1];
  var RangeError$4 = globalThis$G.RangeError;
  var TypeError$7 = globalThis$G.TypeError;
  var QObject = globalThis$G.QObject;
  ...
  var setSymbolDescriptor = DESCRIPTORS$s && fails$P(function () {
  ...
  var $defineProperties = function defineProperties(O, Properties) {
    ...
    $forEach$2(keys, function (key) {
      if (!DESCRIPTORS$s || call$y($propertyIsEnumerable$1, properties, key)) $defineProperty(O, key, properties[key]);
    });
    return O;
  };
  ...
  if (!NATIVE_SYMBOL$5) {
    $Symbol = function Symbol() {
      ...
      var setter = function (value) {
        var $this = this === undefined ? globalThis$G : this;
      ...
      if (DESCRIPTORS$s && USE_SETTER) setSymbolDescriptor(ObjectPrototype$4, tag, { configurable: true, set: setter });
  ...
  $$1f({ global: true, constructor: true, wrap: true, forced: !NATIVE_SYMBOL$5, sham: !NATIVE_SYMBOL$5 }, {
    Symbol: $Symbol
  });
  ...
  $$1f({ target: SYMBOL, stat: true, forced: !NATIVE_SYMBOL$5 }, {
    useSetter: function () { USE_SETTER = true; },
    useSimple: function () { USE_SETTER = false; }
  });

  $$1f({ target: 'Object', stat: true, forced: !NATIVE_SYMBOL$5, sham: !DESCRIPTORS$s }, {
    // `Object.create` method
    // https://tc39.es/ecma262/#sec-object.create
    create: $create,
    // `Object.defineProperty` method
  ...
  $$1f({ target: 'Object', stat: true, forced: !NATIVE_SYMBOL$5 }, {
    // `Object.getOwnPropertyNames` method
    // https://tc39.es/ecma262/#sec-object.getownpropertynames
  ...
  $$1e({ target: 'Symbol', stat: true, forced: !NATIVE_SYMBOL_REGISTRY$1 }, {
    'for': function (key) {
  ...
  $$1d({ target: 'Symbol', stat: true, forced: !NATIVE_SYMBOL_REGISTRY }, {
  ...
  var getJsonReplacerFunction = function (replacer) {
    ...
    for (var i = 0; i < rawLength; i++) {
      ...
      else if (typeof element == 'number' || classof$e(element) === 'Number' || classof$e(element) === 'String') push$b(keys, toString$l(element));
    }
  ...
  var WRONG_SYMBOLS_CONVERSION = !NATIVE_SYMBOL$3 || fails$O(function () {
  ...
  if ($stringify) {
    ...
    $$1c({ target: 'JSON', stat: true, arity: 3, forced: WRONG_SYMBOLS_CONVERSION || ILL_FORMED_UNICODE }, {
      // eslint-disable-next-line no-unused-vars -- required for `.length`
  ...
  var FORCED$e = !NATIVE_SYMBOL$2 || fails$N(function () { getOwnPropertySymbolsModule$1.f(1); });

  // `Object.getOwnPropertySymbols` method
  // https://tc39.es/ecma262/#sec-object.getownpropertysymbols
  $$1b({ target: 'Object', stat: true, forced: FORCED$e }, {
  ...
  if (DESCRIPTORS$r && isCallable$h(NativeSymbol) && (!('description' in SymbolPrototype) ||
    // Safari 12 bug
    ...
    $$1a({ global: true, constructor: true, forced: true }, {
  ...
  var functionUncurryThisAccessor = function (object, key, method) {
    try {
      // eslint-disable-next-line es/no-object-getownpropertydescriptor -- safe
      return uncurryThis$G(aCallable$j(Object.getOwnPropertyDescriptor(object, key)[method]));
    } catch (error) { /* empty */ }
  };
  ...
  var exportGlobalErrorCauseWrapper = function (ERROR_NAME, wrapper) {
    ...
    $$19({ global: true, constructor: true, arity: 1, forced: FORCED$d }, O);
  };
  ...
  var exportWebAssemblyErrorCauseWrapper = function (ERROR_NAME, wrapper) {
    if (WebAssembly && WebAssembly[ERROR_NAME]) {
      ...
      $$19({ target: WEB_ASSEMBLY, stat: true, constructor: true, arity: 1, forced: FORCED$d }, O);
    }
  };
  ...
  $$18({ target: 'Array', proto: true, arity: 1, forced: FORCED$c }, {
    // eslint-disable-next-line no-unused-vars -- required for `.length`
  ...
  $$16({ target: 'Array', proto: true, forced: !HAS_SPECIES_SUPPORT$3 }, {
  ...
  // `Array.prototype.find` method
  // https://tc39.es/ecma262/#sec-array.prototype.find
  $$15({ target: 'Array', proto: true, forced: SKIPS_HOLES$1 }, {
  ...
  var NEW_ITERATOR_PROTOTYPE = !isObject$j(IteratorPrototype$4) || fails$G(function () {
    var test = {};
  ...
  $$_({ target: 'Array', proto: true, arity: 1, forced: FORCED$a }, {
    // eslint-disable-next-line no-unused-vars -- required for `.length`
  ...
  var FORCED$9 = CHROME_BUG || !arrayMethodIsStrict$3('reduce');

  // `Array.prototype.reduce` method
  // https://tc39.es/ecma262/#sec-array.prototype.reduce
  $$Z({ target: 'Array', proto: true, forced: FORCED$9 }, {
  ...
  $$Y({ target: 'Array', proto: true, forced: !HAS_SPECIES_SUPPORT$1 }, {
  ...
  var push$a = uncurryThis$D(test.push);
  ...
  $$X({ target: 'Array', proto: true, forced: FORCED$8 }, {
  ...
  $$V({ target: 'Array', proto: true, arity: 1, forced: FORCED$7 }, {
    // eslint-disable-next-line no-unused-vars -- required for `.length`
  ...
  var TypeError$6 = globalThis$C.TypeError;
  ...
  var slice$5 = ArrayBufferPrototype$4 && uncurryThis$C(ArrayBufferPrototype$4.slice);
  ...
  if (DESCRIPTORS$m && !('detached' in ArrayBufferPrototype$3)) {
  ...
  var slice$4 = uncurryThis$B(ArrayBufferPrototype$2.slice);
  ...
  var getInt8 = uncurryThis$B(DataViewPrototype$1.getInt8);
  ...
  setToStringTag$8(globalThis$w.JSON, 'JSON', true);
  ...
  var FAILS_ON_PRIMITIVES$4 = fails$B(function () { $isExtensible(1); });
  ...
  var collection$3 = function (CONSTRUCTOR_NAME, wrapper, common) {
    ...
    var NativeConstructor = globalThis$v[CONSTRUCTOR_NAME];
    ...
    var REPLACE = isForced$3(
      CONSTRUCTOR_NAME,
      !isCallable$c(NativeConstructor) || !(IS_WEAK || NativePrototype.forEach && !fails$z(function () {
  ...
  var collectionStrong$2 = {
    getConstructor: function (wrapper, CONSTRUCTOR_NAME, IS_MAP, ADDER) {
      ...
      if (DESCRIPTORS$k) defineBuiltInAccessor$a(Prototype, 'size', {
        configurable: true,
        get: function () {
  ...
  var thisNumberValue$1 = uncurryThis$y(1.0.valueOf);
  ...
  var NUMBER = 'Number';
  var NativeNumber = globalThis$u[NUMBER];
  path[NUMBER];
  ...
  var calledWithNew = function (dummy) {
    ...
    return isPrototypeOf$4(NumberPrototype, dummy) && fails$y(function () { thisNumberValue(dummy); });
  };
  ...
  if (FORCED$6 && !IS_PURE$3) NumberPrototype.constructor = NumberWrapper;

  $$Q({ global: true, constructor: true, wrap: true, forced: FORCED$6 }, {
    Number: NumberWrapper
  });

  // Use `internal/copy-constructor-properties` helper in `core-js@4`
  var copyConstructorProperties$1 = function (target, source) {
    for (var keys = DESCRIPTORS$j ? getOwnPropertyNames$3(source) : (
      // ES3:
      ...
      if (hasOwn$e(source, key = keys[j]) && !hasOwn$e(target, key)) {
        defineProperty$2(target, key, getOwnPropertyDescriptor$4(source, key));
      }
    }
  };
  if (FORCED$6 || IS_PURE$3) copyConstructorProperties$1(path[NUMBER], NativeNumber);
  ...
  var IE_BUG = DESCRIPTORS$h && fails$w(function () {
    // eslint-disable-next-line es/no-object-create -- safe
  ...
  $$N({ target: 'Object', stat: true, forced: FAILS_ON_PRIMITIVES$3, sham: !FREEZING$1 }, {
  ...
  var FORCED$5 = !DESCRIPTORS$g || fails$u(function () { nativeGetOwnPropertyDescriptor$1(1); });

  // `Object.getOwnPropertyDescriptor` method
  // https://tc39.es/ecma262/#sec-object.getownpropertydescriptor
  $$L({ target: 'Object', stat: true, forced: FORCED$5, sham: !DESCRIPTORS$g }, {
  ...
  // https://tc39.es/ecma262/#sec-object.getownpropertydescriptors
  $$J({ target: 'Object', stat: true, sham: !DESCRIPTORS$f }, {
  ...
  // `Object.getPrototypeOf` method
  // https://tc39.es/ecma262/#sec-object.getprototypeof
  $$H({ target: 'Object', stat: true, forced: FAILS_ON_PRIMITIVES, sham: !CORRECT_PROTOTYPE_GETTER }, {
  ...
  if (!TO_STRING_TAG_SUPPORT) {
    defineBuiltIn$b(Object.prototype, 'toString', toString$g, { unsafe: true });
  }
  ...
  $$z({ target: 'Promise', proto: true, real: true, forced: NON_GENERIC }, {
  ...
  $$w({ target: 'Reflect', stat: true, forced: MS_EDGE_BUG }, {
    set: set$1
  });
