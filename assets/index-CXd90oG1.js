const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Buttons-hPF4A6Pw.js","assets/Button-CPVKWBFL.js","assets/Components-DC-9Gwtb.js","assets/Entity-P05NLR0S.js","assets/Login-UknaIzwu.js"])))=>i.map(i=>d[i]);
...
function convertEffectsToShader(node, styleEffects) {
  const cacheKey = "".concat(node.width, ",").concat(node.height) + JSON.stringify(styleEffects);
    ...
    if (this.transition && this.rendered && Config.animationsEnabled && (this.transition === true || this.transition[name])) {
      ...
      if (isFunc(this.onAnimationStarted)) {
        animationController.once("animating", (controller) => {
          var _a2;
          (_a2 = this.onAnimationStarted) == null ? void 0 : _a2.call(this, controller, name, value);
        });
      }
      if (isFunc(this.onAnimationFinished)) {
        animationController.once("stopped", (controller) => {
          var _a2;
          (_a2 = this.onAnimationFinished) == null ? void 0 : _a2.call(this, controller, name, value);
        });
      }
...
const Grid = lazy(() => __vitePreload(() => import("./Grid-Dq7P5gUh.js"), true ? [] : void 0));
const Portal = lazy(() => __vitePreload(() => import("./Portal-A-JGOqjg.js"), true ? [] : void 0));
const TextPage = lazy(() => __vitePreload(() => import("./Text-CosfN7xh.js"), true ? [] : void 0));
const CreatePage = lazy(() => __vitePreload(() => import("./Create-DnwUPnZN.js"), true ? [] : void 0));
const ViewportPage = lazy(() => __vitePreload(() => import("./Viewport-B3pfub-i.js"), true ? [] : void 0));
const ButtonsPage = lazy(() => __vitePreload(() => import("./Buttons-hPF4A6Pw.js"), true ? __vite__mapDeps([0,1]) : void 0));
const PositioningPage = lazy(() => __vitePreload(() => import("./Positioning-CQYRX2UQ.js"), true ? [] : void 0));
const TransitionsPage = lazy(() => __vitePreload(() => import("./Transitions-Ba9PxBkM.js"), true ? [] : void 0));
const ComponentsPage = lazy(() => __vitePreload(() => import("./Components-DC-9Gwtb.js"), true ? __vite__mapDeps([2,1]) : void 0));
const FocusHandlingPage = lazy(() => __vitePreload(() => import("./FocusHandling-B6tTqeGO.js"), true ? [] : void 0));
const GradientsPage = lazy(() => __vitePreload(() => import("./Gradients-CvBmRcao.js"), true ? [] : void 0));
const FlexPage = lazy(() => __vitePreload(() => import("./Flex-BetNrtsl.js"), true ? [] : void 0));
const FlexSizePage = lazy(() => __vitePreload(() => import("./FlexSize-CAB4oL3y.js"), true ? [] : void 0));
const FlexColumnSizePage = lazy(() => __vitePreload(() => import("./FlexColumnSize-niAOVw7h.js"), true ? [] : void 0));
const FlexColumnPage = lazy(() => __vitePreload(() => import("./FlexColumn-DqsrD2nZ.js"), true ? [] : void 0));
const ButtonsMaterialPage = lazy(() => __vitePreload(() => import("./ButtonsMaterial-Dj8oB8Ov.js"), true ? [] : void 0));
const SuperFlexPage = lazy(() => __vitePreload(() => import("./SuperFlex-BElVhTv_.js"), true ? [] : void 0));
const Entity = lazy(() => __vitePreload(() => import("./Entity-P05NLR0S.js"), true ? __vite__mapDeps([3,1]) : void 0));
const People = lazy(() => __vitePreload(() => import("./People-D-xpXa4U.js"), true ? [] : void 0));
const LoginPage = lazy(() => __vitePreload(() => import("./Login-UknaIzwu.js"), true ? __vite__mapDeps([4,1]) : void 0));
