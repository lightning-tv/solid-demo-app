const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Loops-Fly6R7VC.js","assets/index-CYtxNsBv.js","assets/Infinite-HY7t5uA0.js","assets/Components-D8vtEbWu.js","assets/Button-EXUcZhQY.js","assets/Login-DcCUHX18.js"])))=>i.map(i=>d[i]);
  ...
  return createComponent(View, {
    ...
    get children() {
      return [createComponent(View, {
        ...
        keyed: true,
        get children() {
          return createComponent(Hero, mergeProps({
            id: "Hero",
            autofocus: true,
...
const Grid = lazy(() => __vitePreload(() => import("./Grid-ApebK8D-.js"), true ? [] : void 0));
const Loops = lazy(() => __vitePreload(() => import("./Loops-Fly6R7VC.js"), true ? __vite__mapDeps([0,1]) : void 0));
const Infinite = lazy(() => __vitePreload(() => import("./Infinite-HY7t5uA0.js"), true ? __vite__mapDeps([2,1]) : void 0));
const TMDBGrid = lazy(() => __vitePreload(() => import("./TMDBGrid-M7kgCd-U.js"), true ? [] : void 0));
const Portal = lazy(() => __vitePreload(() => import("./Portal-CJxK38h_.js"), true ? [] : void 0));
const TextPage = lazy(() => __vitePreload(() => import("./Text-D3ofS6zM.js"), true ? [] : void 0));
const TextPosterPage = lazy(() => __vitePreload(() => import("./TextPoster-BVCppJ2-.js"), true ? [] : void 0));
const CreatePage = lazy(() => __vitePreload(() => import("./Create-DZYFwoNp.js"), true ? [] : void 0));
const ViewportPage = lazy(() => __vitePreload(() => import("./Viewport-BnGpCtI1.js"), true ? [] : void 0));
const PositioningPage = lazy(() => __vitePreload(() => import("./Positioning-DxrmTXSh.js"), true ? [] : void 0));
const LayoutPage = lazy(() => __vitePreload(() => import("./Layout-B_qj4G9d.js"), true ? [] : void 0));
const FocusBasicsPage = lazy(() => __vitePreload(() => import("./FocusBasics-DAvnF3vf.js"), true ? [] : void 0));
const KeyHandlingPage = lazy(() => __vitePreload(() => import("./KeyHandling-CYuLhzb3.js"), true ? [] : void 0));
const TransitionsPage = lazy(() => __vitePreload(() => import("./Transitions-CLK_D-lo.js"), true ? [] : void 0));
const ComponentsPage = lazy(() => __vitePreload(() => import("./Components-D8vtEbWu.js"), true ? __vite__mapDeps([3,4]) : void 0));
const FocusHandlingPage = lazy(() => __vitePreload(() => import("./FocusHandling-Be0EC92O.js"), true ? [] : void 0));
const GradientsPage = lazy(() => __vitePreload(() => import("./Gradients-Vle2mkG6.js"), true ? [] : void 0));
const FlexPage = lazy(() => __vitePreload(() => import("./Flex-CSBvgU6t.js"), true ? [] : void 0));
const FlexGrowPage = lazy(() => __vitePreload(() => import("./FlexGrow-CHZXvVd9.js"), true ? [] : void 0));
const FlexSizePage = lazy(() => __vitePreload(() => import("./FlexSize-DFjrcn3W.js"), true ? [] : void 0));
const FlexColumnSizePage = lazy(() => __vitePreload(() => import("./FlexColumnSize-C1sMuoPi.js"), true ? [] : void 0));
const FlexColumnPage = lazy(() => __vitePreload(() => import("./FlexColumn-BpdxZEKN.js"), true ? [] : void 0));
const ButtonsMaterialPage = lazy(() => __vitePreload(() => import("./ButtonsMaterial-BeRquvKK.js"), true ? [] : void 0));
const SuperFlexPage = lazy(() => __vitePreload(() => import("./SuperFlex-DkgzjkrI.js"), true ? [] : void 0));
const Entity = lazy(() => __vitePreload(() => import("./Entity-QYio-UFJ.js"), true ? [] : void 0));
const People = lazy(() => __vitePreload(() => import("./People-j_nqRtwa.js"), true ? [] : void 0));
const LoginPage = lazy(() => __vitePreload(() => import("./Login-DcCUHX18.js"), true ? __vite__mapDeps([5,4]) : void 0));
const FireboltPage = lazy(() => __vitePreload(() => import("./Firebolt-jPNa9GwB.js"), true ? [] : void 0));
