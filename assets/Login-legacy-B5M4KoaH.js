...
(function () {
  ...
  System.register(['./index-legacy-B6GZdLbY.js', './Button-legacy-tvlCA-Jl.js'], function (exports, module) {
    'use strict';
    ...
    return {
      ...
      execute: function execute() {
        var getformatTitleText = (props, title) => {
        ...
        var Input = props => {
          ...
          var formatTitleText = createMemo(() => getformatTitleText(props, title()));
          var formatInputText = key => {
            if (key === void 0 || key === "") {
              return;
            }
            var inputText = title();
        ...
        var Key = props => {
          var tone = createMemo(() => getTone$1(props));
          var multiplier = createMemo(() => getMultiplier$1(props));
          var baseWidth = createMemo(() => getBaseWidth$1(props));
          var keySpacing = createMemo(() => getKeySpacing$1(props));
        ...
        var KeyboardSimple = props => {
          ...
          var tone = createMemo(() => getTone(props));
          var gap = createMemo(() => getGap(props));
          var totalWidth = createMemo(() => getTotalWidth(props));
          var keyHeight = createMemo(() => getKeyHeight(props));
          var keyboardRefList = /* @__PURE__ */new Map();
          var setOnEnter = (key, rowIdx, colIdx) => {
          ...
          return createComponent(View, mergeProps(props, {
            forwardFocus: 0,
            get style() {
              return [props.style, styles$2.Container.tones[tone()], styles$2.Container.base];
            },
            get width() {
              return totalWidth();
            },
        ...
        var Keyboard = props => {
          return createComponent(KeyboardSimple, mergeProps(props, {
            get style() {
              ...
              return [props.style,
              //
              styles$2.Container.tones[(_props$tone15 = props.tone) !== null && _props$tone15 !== void 0 ? _props$tone15 : styles$2.tone], styles$2.Container.base];
            }
          }));
        };
        var TextPage = exports("default", () => {
          var Title = {
            fontSize: 42,
            fontWeight: "bold"
          };
...
//# sourceMappingURL=Login-legacy-B5M4KoaH.js.map
