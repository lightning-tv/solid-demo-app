...
(function () {
  ...
  function _superPropGet(t, e, o, r) { var p = _get2(_getPrototypeOf(1 & r ? t.prototype : t), e, o); return 2 & r && "function" == typeof p ? function (t) { return p.apply(o, t); } : p; }
    ...
    return {
      execute: function execute() {
        ...
        var CoreNode = /*#__PURE__*/function (_EventEmitter4) {
          ...
          return _createClass(CoreNode, [{
            ...
            value: function update(delta, parentClippingRect) {
              ...
              if (this.updateType ^ UpdateType.All && this.updateType & UpdateType.RenderTexture) {
                for (var i = 0, length = this.children.length; i < length; i++) {
                  var _this$children$i;
                  (_this$children$i = this.children[i]) === null || _this$children$i === void 0 || _this$children$i.setUpdateType(UpdateType.All);
                }
              }
              ...
              if (this.updateType & UpdateType.Children && this.children.length > 0 && this.rtt === false) {
                for (var _i = 0, _length = this.children.length; _i < _length; _i++) {
            ...
            set: function set(value) {
              ...
              this.setUpdateType(UpdateType.All);
              for (var _i2 = 0, _length2 = this.children.length; _i2 < _length2; _i2++) {
                this.children[_i2].setUpdateType(UpdateType.All);
              }
        ...
        function resolveFontToUse(familyMapsByPriority, family, weightIn, style, stretch) {
          ...
          var _iterator5 = _createForOfIteratorHelper(familyMapsByPriority),
            _step5;
          try {
            for (_iterator5.s(); !(_step5 = _iterator5.n()).done;) {
              var fontFamiles = _step5.value;
              ...
              var _iterator6 = _createForOfIteratorHelper(fontFaces),
                _step6;
              try {
                for (_iterator6.s(); !(_step6 = _iterator6.n()).done;) {
                  var fontFace = _step6.value;
        ...
        var getResolvedEffect = function getResolvedEffect(effects, effectContructors) {
          ...
          for (; i < effectsLength; i++) {
            ...
            for (; j < uniformsLength; j++) {
              var _key12 = uniformKeys[j];
              var uniform = uniforms[_key12];
              var result = {
                value: defaultPropValues[_key12],
              ...
              var validatedValue = result.hasValidator && uniform.validator(defaultPropValues[_key12], defaultPropValues) || defaultPropValues[_key12];
              if (defaultPropValues[_key12] !== validatedValue) {
              ...
              resolvedEffect.props[_key12] = result;
            }
          ...
          return _createClass(DynamicShader, [{
            ...
            value: function bindUniformMethods(props) {
              ...
              for (var i = 0; i < effectsL; i++) {
                ...
                var _loop = function _loop() {
                    ...
                    var location = _this19.getUniformLocation(uniformInfo[key].name);
            ...
            value: function bindProps(props) {
              ...
              for (; i < effectsL; i++) {
                ...
                var j = 0;
                for (; j < propsLength; j++) {
                  var _key13 = propKeys[j];
                  var prop = _effect3.props[_key13];
                  if (prop.updateOnBind === true) {
                    var _this$renderer$shMana;
                    var uniform = (_this$renderer$shMana = this.renderer.shManager.getRegisteredEffects()[_effect3.type]) === null || _this$renderer$shMana === void 0 ? void 0 : _this$renderer$shMana.uniforms[_key13];
                    uniform === null || uniform === void 0 || uniform.updateProgramValue(_effect3.props[_key13], props);
                  }
            ...
            value: function canBatchShaderProps(propsA, propsB) {
              ...
              for (; i < propsEffectsLen; i++) {
                ...
                for (var _key14 in effectA.props) {
                  if (effectB.props && !effectB.props[_key14] || effectA.props[_key14].value !== effectB.props[_key14].value) {
                    return false;
                  }
                }
              }
        ...
        var SdfShader = /*#__PURE__*/function (_WebGlCoreShader6) {
          ...
          return _createClass(SdfShader, [{
            ...
            value: function bindProps(props) {
              ...
              for (var _key15 in resolvedProps) {
                if (_key15 === 'transform') {
                  this.glw.uniformMatrix3fv(this.getUniformLocation('u_transform'), resolvedProps[_key15]);
                } else if (_key15 === 'scrollY') {
                  this.glw.uniform1f(this.getUniformLocation('u_scrollY'), resolvedProps[_key15]);
                } else if (_key15 === 'color') {
                  ...
                  this.glw.uniform1f(this.getUniformLocation('u_size'), resolvedProps[_key15]);
                } else if (_key15 === 'distanceRange') {
                  this.glw.uniform1f(this.getUniformLocation('u_distanceRange'), resolvedProps[_key15]);
                } else if (_key15 === 'debug') {
                  this.glw.uniform1i(this.getUniformLocation('u_debug'), resolvedProps[_key15] ? 1 : 0);
                }
              }
            }
          }], [{
        ...
        var TextureMemoryManager = /*#__PURE__*/function () {
          ...
          return _createClass(TextureMemoryManager, [{
            ...
            value: function cleanup() {
              ...
              var _iterator7 = _createForOfIteratorHelper(textures),
                _step7;
              try {
        ...
        function santizeCustomDataMap(d) {
          ...
          for (var i = 0; i < keys.length; i++) {
            ...
            if (valueType === 'string' && value.length > 2048) {
              console.warn("Custom Data value for ".concat(_key29, " is too long, it will be truncated to 2048 characters"));
              // same here, see above comment, this can only be a string at this point
              // eslint-disable-next-line @typescript-eslint/ban-ts-comment
              // @ts-ignore-next-line
              // eslint-disable-next-line @typescript-eslint/no-unsafe-assignment, @typescript-eslint/no-unsafe-call
              d[_key29] = value.substring(0, 2048);
            }
            if (!validTypes[valueType]) {
              console.warn("Custom Data value for ".concat(_key29, " is not a boolean, string, or number, it will be ignored"));
              delete d[_key29];
            }
          }
          return d;
        ...
        var Stage = /*#__PURE__*/function () {
          ...
          return _createClass(Stage, [{
            ...
            value: function flushFrameEvents() {
              var _iterator8 = _createForOfIteratorHelper(this.frameEventQueue),
                _step8;
              try {
            ...
            value: function resolveTextRenderer(trProps) {
              ...
              if (!rendererId) {
                ...
                for (var _i3 = 0, _Object$entries = Object.entries(this.textRenderers); _i3 < _Object$entries.length; _i3++) {
            ...
            value: function resolveNodeDefaults(props) {
              var _props$color8, _ref7, _ref8, _props$colorTl, _ref9, _ref10, _props$colorTr, _ref11, _ref12, _props$colorBl, _ref13, _ref14, _props$colorBr, _props$data, _props$x, _props$y, _props$width10, _props$height4, _props$alpha, _props$autosize, _props$clipping, _props$colorTop, _props$colorBottom, _props$colorLeft, _props$colorRight, _props$zIndex, _props$zIndexLocked, _props$parent3, _props$texture, _props$textureOptions, _props$shader, _props$src2, _props$scale, _ref15, _props$scaleX, _ref16, _props$scaleY, _props$mount, _ref17, _props$mountX, _ref18, _props$mountY, _props$pivot2, _ref19, _props$pivotX, _ref20, _props$pivotY, _props$rotation, _props$rtt, _props$preventCleanup;
              var color = (_props$color8 = props.color) !== null && _props$color8 !== void 0 ? _props$color8 : 0xffffffff;
              var colorTl = (_ref7 = (_ref8 = (_props$colorTl = props.colorTl) !== null && _props$colorTl !== void 0 ? _props$colorTl : props.colorTop) !== null && _ref8 !== void 0 ? _ref8 : props.colorLeft) !== null && _ref7 !== void 0 ? _ref7 : color;
              var colorTr = (_ref9 = (_ref10 = (_props$colorTr = props.colorTr) !== null && _props$colorTr !== void 0 ? _props$colorTr : props.colorTop) !== null && _ref10 !== void 0 ? _ref10 : props.colorRight) !== null && _ref9 !== void 0 ? _ref9 : color;
        ...
        var TrFontFace = /*#__PURE__*/function (_EventEmitter7) {
          function TrFontFace(options) {
            ...
            _this44 = _callSuper(this, TrFontFace);
            _defineProperty(_this44, "fontFamily", void 0);
            _defineProperty(_this44, "descriptors", void 0);
            _defineProperty(_this44, "loaded", false);
            _defineProperty(_this44, "metrics", null);
            ...
            _this44.fontFamily = fontFamily;
            _this44.descriptors = _objectSpread({
              style: 'normal',
              weight: 'normal',
              stretch: 'normal'
            }, descriptors);
        ...
        var WebTrFontFace = /*#__PURE__*/function (_TrFontFace2) {
          function WebTrFontFace(options) {
            ...
            _this45 = _callSuper(this, WebTrFontFace, [options]);
            _defineProperty(_this45, "fontFace", void 0);
            _defineProperty(_this45, "fontUrl", void 0);
            var fontFamily = options.fontFamily,
            ...
            var determinedDescriptors = _this45.descriptors;
            ...
            _this45.fontFace = fontFace;
            _this45.fontUrl = fontUrl;
            return _this45;
          }
        ...
        var WebGlCoreRenderOp = /*#__PURE__*/function (_CoreRenderOp) {
          function WebGlCoreRenderOp(glw, options, buffers, shader, shaderProps, alpha, clippingRect, dimensions, bufferIdx, zIndex, renderToTexture, parentHasRenderTexture, framebufferDimensions) {
            ...
            _this46 = _callSuper(this, WebGlCoreRenderOp);
            _defineProperty(_this46, "glw", void 0);
            _defineProperty(_this46, "options", void 0);
            _defineProperty(_this46, "buffers", void 0);
            _defineProperty(_this46, "shader", void 0);
            _defineProperty(_this46, "shaderProps", void 0);
            _defineProperty(_this46, "alpha", void 0);
            _defineProperty(_this46, "clippingRect", void 0);
            _defineProperty(_this46, "dimensions", void 0);
            _defineProperty(_this46, "bufferIdx", void 0);
            _defineProperty(_this46, "zIndex", void 0);
            _defineProperty(_this46, "renderToTexture", void 0);
            _defineProperty(_this46, "parentHasRenderTexture", void 0);
            _defineProperty(_this46, "framebufferDimensions", void 0);
            _defineProperty(_this46, "length", 0);
            _defineProperty(_this46, "numQuads", 0);
            _defineProperty(_this46, "textures", []);
            _defineProperty(_this46, "maxTextures", void 0);
            _this46.glw = glw;
            _this46.options = options;
            _this46.buffers = buffers;
            _this46.shader = shader;
            _this46.shaderProps = shaderProps;
            _this46.alpha = alpha;
            _this46.clippingRect = clippingRect;
            _this46.dimensions = dimensions;
            _this46.bufferIdx = bufferIdx;
            _this46.zIndex = zIndex;
            _this46.renderToTexture = renderToTexture;
            _this46.parentHasRenderTexture = parentHasRenderTexture;
            _this46.framebufferDimensions = framebufferDimensions;
            _this46.maxTextures = shader.supportsIndexedTextures ? glw.getParameter(glw.MAX_VERTEX_TEXTURE_IMAGE_UNITS) : 1;
            return _this46;
          }
        ...
        var WebGlCoreCtxTexture = /*#__PURE__*/function (_CoreContextTexture2) {
          function WebGlCoreCtxTexture(glw, memManager, textureSource) {
            ...
            _this47 = _callSuper(this, WebGlCoreCtxTexture, [memManager, textureSource]);
            _defineProperty(_this47, "glw", void 0);
            _defineProperty(_this47, "_nativeCtxTexture", null);
            _defineProperty(_this47, "_state", 'freed');
            _defineProperty(_this47, "_w", 0);
            _defineProperty(_this47, "_h", 0);
            _this47.glw = glw;
            return _this47;
          }
          ...
          return _createClass(WebGlCoreCtxTexture, [{
            ...
            value: function load() {
              ...
              this.onLoadRequest().then(function (_ref21) {
                var width = _ref21.width,
                  height = _ref21.height;
                // If the texture has been freed while loading, return early.
                if (_this48._state === 'freed') {
                  return;
                }
                _this48._state = 'loaded';
                _this48._w = width;
                _this48._h = height;
                // Update the texture source's width and height so that it can be used
                // for rendering.
                _this48.textureSource.setState('loaded', {
                  width: width,
                  height: height
                });
              }).catch(function (err) {
                ...
                _this48._state = 'failed';
                _this48.textureSource.setState('failed', err);
                console.error(err);
              });
            }
            /**
        ...
        var WebGlCoreCtxRenderTexture = /*#__PURE__*/function (_WebGlCoreCtxTexture3) {
          function WebGlCoreCtxRenderTexture(glw, memManager, textureSource) {
            ...
            _this50 = _callSuper(this, WebGlCoreCtxRenderTexture, [glw, memManager, textureSource]);
            // Create Framebuffer object
            _defineProperty(_this50, "framebuffer", void 0);
            var framebuffer = glw.createFramebuffer();
            assertTruthy(framebuffer, 'Unable to create framebuffer');
            _this50.framebuffer = framebuffer;
            return _this50;
          }
        ...
        var WebGlCoreRenderer = /*#__PURE__*/function (_CoreRenderer2) {
          function WebGlCoreRenderer(options) {
            ...
            _this51 = _callSuper(this, WebGlCoreRenderer, [options]);
            //// WebGL Native Context and Data
            _defineProperty(_this51, "glw", void 0);
            _defineProperty(_this51, "system", void 0);
            //// Persistent data
            _defineProperty(_this51, "quadBuffer", void 0);
            _defineProperty(_this51, "fQuadBuffer", void 0);
            _defineProperty(_this51, "uiQuadBuffer", void 0);
            _defineProperty(_this51, "renderOps", []);
            //// Render Op / Buffer Filling State
            _defineProperty(_this51, "curBufferIdx", 0);
            _defineProperty(_this51, "curRenderOp", null);
            _defineProperty(_this51, "rttNodes", []);
            _defineProperty(_this51, "activeRttNode", null);
            //// Default Shader
            _defineProperty(_this51, "defShaderCtrl", void 0);
            _defineProperty(_this51, "defaultShader", void 0);
            _defineProperty(_this51, "quadBufferCollection", void 0);
            /**
             * White pixel texture used by default when no texture is specified.
             */
            _defineProperty(_this51, "defaultTexture", void 0);
            _defineProperty(_this51, "quadBufferUsage", 0);
            /**
             * Whether the renderer is currently rendering to a texture.
             */
            _defineProperty(_this51, "renderToTextureActive", false);
            _this51.quadBuffer = new ArrayBuffer(_this51.stage.options.quadBufferSize);
            _this51.fQuadBuffer = new Float32Array(_this51.quadBuffer);
            _this51.uiQuadBuffer = new Uint32Array(_this51.quadBuffer);
            _this51.mode = 'webgl';
            var canvas = options.canvas,
              clearColor = options.clearColor,
              bufferMemory = options.bufferMemory;
            _this51.defaultTexture = new ColorTexture(_this51.txManager);
            // Mark the default texture as ALWAYS renderable
            // This prevents it from ever being cleaned up.
            // Fixes https://github.com/lightning-js/renderer/issues/262
            _this51.defaultTexture.setRenderableOwner(_this51, true);
            // When the default texture is loaded, request a render in case the
            // RAF is paused. Fixes: https://github.com/lightning-js/renderer/issues/123
            _this51.defaultTexture.once('loaded', function () {
              _this51.stage.requestRender();
            });
            var gl = createWebGLContext(canvas, options.contextSpy);
            var glw = _this51.glw = new WebGlContextWrapper(gl);
            ...
            _this51.system = {
              parameters: getWebGlParameters(_this51.glw),
              extensions: getWebGlExtensions(_this51.glw)
            };
            _this51.shManager.renderer = _this51;
            _this51.defShaderCtrl = _this51.shManager.loadShader('DefaultShader');
            _this51.defaultShader = _this51.defShaderCtrl.shader;
            var quadBuffer = glw.createBuffer();
            assertTruthy(quadBuffer);
            var stride = 6 * Float32Array.BYTES_PER_ELEMENT;
            _this51.quadBufferCollection = new BufferCollection([{
              buffer: quadBuffer,
              attributes: {
                a_position: {
                  name: 'a_position',
          ...
          return _createClass(WebGlCoreRenderer, [{
            ...
            value: function addQuad(params) {
              ...
              if (texture instanceof SubTexture) {
                ...
                var _ref22 = texture.parentTexture.dimensions || {
                    width: 0,
                    height: 0
                  },
                  _ref22$width = _ref22.width,
                  parentW = _ref22$width === void 0 ? 0 : _ref22$width,
                  _ref22$height = _ref22.height,
                  parentH = _ref22$height === void 0 ? 0 : _ref22$height;
              ...
              if (flipX) {
                var _ref23 = [texCoordX2, texCoordX1];
                texCoordX1 = _ref23[0];
                texCoordX2 = _ref23[1];
              }
              if (flipY) {
                var _ref24 = [texCoordY2, texCoordY1];
                texCoordY1 = _ref24[0];
                texCoordY2 = _ref24[1];
              }
        ...
        var SdfFontShaper = /*#__PURE__*/function (_FontShaper) {
          function SdfFontShaper(data, glyphMap) {
            ...
            _this52 = _callSuper(this, SdfFontShaper);
            _defineProperty(_this52, "data", void 0);
            _defineProperty(_this52, "glyphMap", void 0);
            _defineProperty(_this52, "kernings", void 0);
            _this52.data = data;
            _this52.glyphMap = glyphMap;
            var kernings = _this52.kernings = {};
            data.kernings.forEach(function (kerning) {
              var second = kerning.second;
              var firsts = kernings[second] = kernings[second] || {};
              firsts[kerning.first] = kerning.amount;
            });
            _this52.kernings = kernings;
            return _this52;
          }
        ...
        var SdfTrFontFace = /*#__PURE__*/function (_TrFontFace3) {
          function SdfTrFontFace(type, options) {
            ...
            _this53 = _callSuper(this, SdfTrFontFace, [options]);
            _defineProperty(_this53, "type", void 0);
            _defineProperty(_this53, "texture", void 0);
            /**
             * Height of the tallest character in the font including the whitespace above it
             * in SDF/vertex units.
             */
            _defineProperty(_this53, "maxCharHeight", 0);
            _defineProperty(_this53, "data", void 0);
            _defineProperty(_this53, "shaper", void 0);
            _defineProperty(_this53, "glyphMap", new Map());
            ...
            // Load image
            _this53.texture = stage.txManager.loadTexture('ImageTexture', {
              src: atlasUrl,
            ...
            _this53.texture.on('loaded', function () {
              _this53.checkLoaded();
              // Make sure we mark the stage for a re-render (in case the font's texture was freed and reloaded)
              stage.requestRender();
            });
            // Pre-load it
            _this53.texture.ctxTexture.load();
            // Set this.data to the fetched data from dataUrl
            fetch(atlasDataUrl).then(/*#__PURE__*/function () {
              var _ref25 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee13(response) {
                var maxCharHeight, _this53$data, _this53$data$lightnin, ascender, descender, lineGap, unitsPerEm;
                return _regeneratorRuntime().wrap(function _callee13$(_context14) {
                  while (1) switch (_context14.prev = _context14.next) {
                    ...
                    case 2:
                      _this53.data = _context14.sent;
                      assertTruthy(_this53.data);
                      // Add all the glyphs to the glyph map
                      // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
                      maxCharHeight = 0;
                      _this53.data.chars.forEach(function (glyph) {
                        _this53.glyphMap.set(glyph.id, glyph);
                      ...
                      // eslint-disable-next-line @typescript-eslint/no-unnecessary-type-assertion
                      _this53.maxCharHeight = maxCharHeight;
                      // We know `data` is defined here, because we just set it
                      // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
                      _this53.shaper = new SdfFontShaper(_this53.data, _this53.glyphMap);
                      ...
                      if (!((_this53$data = _this53.data) !== null && _this53$data !== void 0 && _this53$data.lightningMetrics)) {
                        _context14.next = 14;
                        break;
                      }
                      _this53$data$lightnin = _this53.data.lightningMetrics, ascender = _this53$data$lightnin.ascender, descender = _this53$data$lightnin.descender, lineGap = _this53$data$lightnin.lineGap, unitsPerEm = _this53$data$lightnin.unitsPerEm;
                      _this53.metrics = {
                      ...
                      break;
                    case 14:
                      throw new Error("Font metrics not found in ".concat(_this53.type, " font ").concat(_this53.fontFamily, ". ") + 'Make sure you are using the latest version of the Lightning ' + '3 `msdf-generator` tool to generate your SDF fonts.');
                    case 15:
                      _this53.checkLoaded();
                    case 16:
                    case "end":
        ...
        function loadFonts(fonts) {
          ...
          var _iterator10 = _createForOfIteratorHelper(fonts),
            _step10;
          try {
            for (_iterator10.s(); !(_step10 = _iterator10.n()).done;) {
              var font = _step10.value;
              if ('type' in font) {
        ...
        function log(msg, node) {
          if (isDev) {
            for (var _len15 = arguments.length, args = new Array(_len15 > 2 ? _len15 - 2 : 0), _key30 = 2; _key30 < _len15; _key30++) {
        ...
        function flattenStyles(obj) {
          ...
          if (isArray(obj)) {
            ...
            for (var _key32 in obj) {
              // be careful of 0 values
              if (result[_key32] === undefined) {
                result[_key32] = obj[_key32];
              }
            }
          }
          return result;
        ...
        var States = /*#__PURE__*/function (_Array) {
          function States(callback) {
            ...
            if (isArray(initialState)) {
              _this54 = _callSuper(this, States, _toConsumableArray(initialState));
              _defineProperty(_assertThisInitialized(_this54), "onChange", void 0);
            } else if (isString(initialState)) {
              _this54 = _callSuper(this, States, [initialState]);
              _defineProperty(_assertThisInitialized(_this54), "onChange", void 0);
            } else {
              _this54 = _callSuper(this, States, _toConsumableArray(Object.entries(initialState).filter(function (_ref26) {
            ...
            _this54.onChange = callback;
            return _possibleConstructorReturn(_this54, _assertThisInitialized(_this54));
          }
        ...
        function calculateFlex(node) {
          ...
          if (justify === 'flexStart') {
            ...
            for (var _i7 = numChildren - 1; _i7 >= 0; _i7--) {
              var _c3 = children[_i7];
            ...
            var _start4 = _toPad;
            for (var _i10 = 0; _i10 < children.length; _i10++) {
              var _c6 = children[_i10];
        ...
        var propagateKeyDown = function propagateKeyDown(e, mappedEvent, isHold) {
          ...
          for (var _i12 = 0, _focusPath$ = focusPath$1; _i12 < _focusPath$.length; _i12++) {
            var elm = _focusPath$[_i12];
        ...
        var handleKeyEvents = function handleKeyEvents(delay, keypress, keyup) {
          if (keypress) {
            var _key33 = keypress.key || keypress.keyCode;
            var mappedKeyHoldEvent = keyHoldMapEntries[_key33];
            var mappedKeyEvent = keyMapEntries[_key33];
            if (!mappedKeyHoldEvent) {
              propagateKeyDown(keypress, mappedKeyEvent, false);
            } else {
              if (keyHoldTimeouts[_key33]) {
                clearTimeout(keyHoldTimeouts[_key33]);
              }
              keyHoldTimeouts[_key33] = window.setTimeout(function () {
                return keyHoldCallback(keypress, mappedKeyHoldEvent);
              }, delay);
            }
          }
          if (keyup) {
            var _key34 = keyup.key || keyup.keyCode;
            var _mappedKeyEvent = keyMapEntries[_key34];
            if (keyHoldTimeouts[_key34]) {
              clearTimeout(keyHoldTimeouts[_key34]);
              delete keyHoldTimeouts[_key34];
        ...
        var useFocusManager$1 = function useFocusManager$1() {
          var _ref30 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
            userKeyMap = _ref30.userKeyMap,
            keyHoldOptions = _ref30.keyHoldOptions,
            _ref30$ownerContext = _ref30.ownerContext,
            ownerContext = _ref30$ownerContext === void 0 ? function (cb) {
              cb();
            } : _ref30$ownerContext;
          if (userKeyMap) {
          ...
          return {
            cleanup: function cleanup() {
              ...
              for (var _i13 = 0, _Object$entries3 = Object.entries(keyHoldTimeouts); _i13 < _Object$entries3.length; _i13++) {
        ...
        function convertEffectsToShader(styleEffects) {
          var effects = [];
          var index = 0;
          for (var _i14 = 0, _Object$entries4 = Object.entries(styleEffects); _i14 < _Object$entries4.length; _i14++) {
        ...
        var ElementNode = /*#__PURE__*/function (_Object) {
          function ElementNode(name) {
            ...
            _this55 = _callSuper(this, ElementNode);
            _this55._type = name === 'text' ? NodeType.TextNode : NodeType.Element;
            _this55.rendered = false;
            _this55.lng = {};
            _this55.children = [];
            return _this55;
          }
          ...
          return _createClass(ElementNode, [{
              ...
              if (this.transition && this.rendered && Config.animationsEnabled && (this.transition === true || this.transition[name])) {
                ...
                if (isFunc(this.onAnimationStarted)) {
                  animationController.once('animating', function (controller) {
                    var _this56$onAnimationSt;
                    (_this56$onAnimationSt = _this56.onAnimationStarted) === null || _this56$onAnimationSt === void 0 || _this56$onAnimationSt.call(_this56, controller, name, value);
                  });
                }
                if (isFunc(this.onAnimationFinished)) {
                  animationController.once('stopped', function (controller) {
                    var _this56$onAnimationFi;
                    (_this56$onAnimationFi = _this56.onAnimationFinished) === null || _this56$onAnimationFi === void 0 || _this56$onAnimationFi.call(_this56, controller, name, value);
                  });
                }
            ...
            value: function setFocus() {
              ...
              if (this.rendered) {
                ...
                queueMicrotask(function () {
                  return setActiveElement$1(_this57);
                });
              } else {
            ...
            value: function _layoutOnLoad() {
              ...
              this.lng.on('loaded', function () {
                ...
                layoutQueue.add(_this58.parent);
                flushLayout();
              });
            }
          }, {
            ...
            set: function set(values) {
              ...
              for (var _key35 in this._style) {
                // be careful of 0 values
                if (this[_key35] === undefined) {
                  this[_key35] = this._style[_key35];
                }
              }
            }
          }, {
            ...
            value: function _stateChanged() {
              ...
              if (this._undoStyles || this.style && keyExists(this.style, states)) {
                ...
                this._undoStyles.forEach(function (styleKey) {
                  stylesToUndo[styleKey] = _this59.style[styleKey];
                });
                var newStyles = states.reduce(function (acc, state) {
                  var styles = _this59.style[state];
                  if (styles) {
            ...
            value: function render(topNode) {
              ...
              if (node.isTextNode()) {
                ...
                if (Config.fontSettings) {
                  for (var _key36 in Config.fontSettings) {
                    if (textProps[_key36] === undefined) {
                      textProps[_key36] = Config.fontSettings[_key36];
                    }
                  }
                }
              ...
              node.onEvents && node.onEvents.forEach(function (_ref32) {
        ...
        var _loop6 = function _loop6() {
          var key = _LightningRendererNum[_i15];
        ...
        for (var _i15 = 0, _LightningRendererNum = LightningRendererNumberProps; _i15 < _LightningRendererNum.length; _i15++) {
          _loop6();
        }
        var _loop7 = function _loop7() {
          var key = _LightningRendererNon[_i16];
          Object.defineProperty(ElementNode.prototype, key, {
            get: function get() {
              return this.lng[key];
            },
        ...
        for (var _i16 = 0, _LightningRendererNon = LightningRendererNonAnimatingProps; _i16 < _LightningRendererNon.length; _i16++) {
          _loop7();
        }
        // Add Border Helpers
        ...
        function createResource(pSource, pFetcher, pOptions) {
          ...
          var contexts = new Set(),
            _ref35 = (options.storage || createSignal)(options.initialValue),
          ...
          function completeLoad(v, err) {
            runUpdates(function () {
              ...
              setError(err);
              var _iterator12 = _createForOfIteratorHelper(contexts.keys()),
                _step12;
              try {
        ...
        function createSelector(source) {
          ...
          var node = createComputation(function (p) {
            var v = source();
            var _iterator13 = _createForOfIteratorHelper(subs.entries()),
              _step13;
            try {
              for (_iterator13.s(); !(_step13 = _iterator13.n()).done;) {
                var _step13$value = _slicedToArray(_step13.value, 2),
                  _key37 = _step13$value[0],
                  val = _step13$value[1];
                if (fn(_key37, v) !== fn(_key37, p)) {
                  var _iterator14 = _createForOfIteratorHelper(val.values()),
                    _step14;
                  try {
        ...
        function mergeProps$1() {
          for (var _len16 = arguments.length, sources = new Array(_len16), _key38 = 0; _key38 < _len16; _key38++) {
            sources[_key38] = arguments[_key38];
          }
          var proxy = false;
            ...
            return new Proxy({
              get: function get(property) {
                for (var _i17 = sources.length - 1; _i17 >= 0; _i17--) {
                  var v = resolveSource(sources[_i17])[property];
                  if (v !== undefined) return v;
                }
              },
              has: function has(property) {
                for (var _i18 = sources.length - 1; _i18 >= 0; _i18--) {
                  if (property in resolveSource(sources[_i18])) return true;
                }
                return false;
              },
              keys: function keys() {
                var keys = [];
                for (var _i19 = 0; _i19 < sources.length; _i19++) keys.push.apply(keys, _toConsumableArray(Object.keys(resolveSource(sources[_i19]))));
          ...
          for (var _i20 = sources.length - 1; _i20 >= 0; _i20--) {
            var source = sources[_i20];
            if (!source) continue;
            var sourceKeys = Object.getOwnPropertyNames(source);
            var _loop8 = function _loop8() {
              var key = sourceKeys[_i21];
            ...
            for (var _i21 = sourceKeys.length - 1; _i21 >= 0; _i21--) {
              if (_loop8()) continue;
            }
          }
          var target = {};
          var definedKeys = Object.keys(defined);
          for (var _i22 = definedKeys.length - 1; _i22 >= 0; _i22--) {
            var _key39 = definedKeys[_i22],
              desc = defined[_key39];
            if (desc && desc.get) Object.defineProperty(target, _key39, desc);else target[_key39] = desc ? desc.value : undefined;
          }
          return target;
        }
        function splitProps(props) {
          for (var _len17 = arguments.length, keys = new Array(_len17 > 1 ? _len17 - 1 : 0), _key40 = 1; _key40 < _len17; _key40++) {
            keys[_key40 - 1] = arguments[_key40];
          }
          ...
          var _iterator15 = _createForOfIteratorHelper(Object.getOwnPropertyNames(props)),
            _step15;
          try {
        ...
        function createRenderer$1(_ref37) {
          var createElement = _ref37.createElement,
            createTextNode = _ref37.createTextNode,
            isTextNode = _ref37.isTextNode,
            replaceText = _ref37.replaceText,
            insertNode = _ref37.insertNode,
            removeNode = _ref37.removeNode,
            setProperty = _ref37.setProperty,
            getParentNode = _ref37.getParentNode,
            getFirstChild = _ref37.getFirstChild,
            getNextSibling = _ref37.getNextSibling;
                ...
                if (index != null) {
                  if (bStart < index && index < bEnd) {
                    var _i23 = aStart,
                      sequence = 1,
                      t = void 0;
                    while (++_i23 < aEnd && _i23 < bEnd) {
                      if ((t = map.get(a[_i23])) == null || t !== index + sequence) break;
                      sequence++;
                    }
        ...
        function measureText(text, shaperProps, shaper) {
          ...
          var width = 0;
          var _iterator17 = _createForOfIteratorHelper(glyphs),
            _step17;
          try {
            for (_iterator17.s(); !(_step17 = _iterator17.n()).done;) {
              var glyph = _step17.value;
              if (glyph.mapped) {
        ...
        lineCache, rwSdf, trFontFace, forceFullLayoutCalc, scrollable, overflowSuffix, maxLines) {
          ...
          if (textAlign === 'center') {
            ...
            for (var _i24 = 0; _i24 < bufferLineInfos.length; _i24++) {
              var _line = bufferLineInfos[_i24];
        ...
        var SdfTextRenderer = /*#__PURE__*/function (_TextRenderer2) {
          function SdfTextRenderer(stage) {
            ...
            _this61 = _callSuper(this, SdfTextRenderer, [stage]);
            /**
             * Map of font family names to a set of font faces.
             */
            _defineProperty(_this61, "ssdfFontFamilies", {});
            _defineProperty(_this61, "msdfFontFamilies", {});
            _defineProperty(_this61, "fontFamilyArray", [_this61.ssdfFontFamilies, _this61.msdfFontFamilies]);
            _defineProperty(_this61, "sdfShader", void 0);
            _defineProperty(_this61, "rendererBounds", void 0);
            _defineProperty(_this61, "type", 'sdf');
            _this61.sdfShader = _this61.stage.shManager.loadShader('SdfShader').shader;
            _this61.rendererBounds = {
              x1: 0,
              y1: 0,
              x2: _this61.stage.options.appWidth,
              y2: _this61.stage.options.appHeight
            };
            return _this61;
          }
          //#region Overrides
          ...
          return _createClass(SdfTextRenderer, [{
            ...
            value: function getPropertySetters() {
              ...
              return {
                fontFamily: function fontFamily(state, value) {
                  state.props.fontFamily = value;
                  _this62.releaseFontFace(state);
                  _this62.invalidateLayoutCache(state);
                },
                fontWeight: function fontWeight(state, value) {
                  state.props.fontWeight = value;
                  _this62.releaseFontFace(state);
                ...
                x: function x(state, value) {
                  ...
                  if (state.elementBounds.valid) {
                    _this62.setElementBoundsX(state);
                    ...
                    if (!state.renderWindow.valid && boundsOverlap(state.elementBounds, _this62.rendererBounds)) {
                ...
                y: function y(state, value) {
                  state.props.y = value;
                  if (state.elementBounds.valid) {
                    _this62.setElementBoundsY(state);
            ...
            value: function updateState(state) {
              ...
              if (!trFontFace.loaded) {
                trFontFace.once('loaded', function () {
                  _this63.scheduleUpdateState(state);
                });
                return;
              }
        ...
        var Inspector = /*#__PURE__*/function () {
          ...
          return _createClass(Inspector, [{
            ...
            value: function createDiv(id, properties) {
              ...
              for (var _key41 in properties) {
                this.updateNodeProperty(div,
                // really typescript? really?
                _key41, properties[_key41]);
              }
              return div;
            }
          }, {
            ...
            value: function createProxy(node, div) {
              ...
              return new Proxy(node, {
                set: function set(target, property, value) {
                  _this64.updateNodeProperty(div, property, value);
                  return Reflect.set(target, property, value);
                },
                get: function get(target, property, receiver) {
                  if (property === 'destroy') {
                    _this64.destroyNode(target.id);
                  }
                  if (property === 'animate') {
                    return function (props, settings) {
                      ...
                      return new Proxy(anim, {
                        get: function get(target, property, receiver) {
                          if (property === 'start') {
                            _this64.animateNode(div, props, settings);
                          }
            ...
            value) {
              ...
              if (stylePropertyMap[property]) {
                ...
                if (_typeof(mappedStyleResponse) === 'object') {
              ...
              if (property === 'data') {
                for (var _key42 in value) {
                  // eslint-disable-next-line @typescript-eslint/no-unsafe-member-access
                  var keyValue = value[_key42];
                  if (keyValue === undefined) {
                    div.removeAttribute("data-".concat(_key42));
                  } else {
                    div.setAttribute("data-".concat(_key42), String(keyValue));
                  }
                }
                return;
              }
        ...
        function eventHandler(e) {
          if (sharedConfig.registry && sharedConfig.events) {
            if (sharedConfig.events.find(function (_ref38) {
          ...
          var oriTarget = e.target;
          var oriCurrentTarget = e.currentTarget;
          var retarget = function retarget(value) {
          ...
          var walkUpTree = function walkUpTree() {
        ...
        function createBeforeLeave() {
          ...
          function confirm(to, options) {
            ...
            var _iterator18 = _createForOfIteratorHelper(listeners),
              _step18;
            try {
        ...
        function createMatcher(path, partial, matchFilters) {
          ...
          return function (location) {
            ...
            for (var i = 0; i < len; i++) {
              ...
              var _key43 = dynamic ? segment.slice(1) : segment.toLowerCase();
              if (dynamic && matchSegment(locSegment, matchFilter(_key43))) {
                match.params[_key43] = locSegment;
              } else if (dynamic || !matchSegment(locSegment, _key43)) {
                return null;
              }
        ...
        var useMatch = function useMatch(path, matchFilters) {
          ...
          return createMemo(function () {
            var _iterator19 = _createForOfIteratorHelper(matchers()),
              _step19;
            try {
              for (_iterator19.s(); !(_step19 = _iterator19.n()).done;) {
                var matcher = _step19.value;
        ...
        var useParams = exports("G", function () {
        ...
        function createRoutes(routeDef) {
          ...
          return asArray(routeDef.path).reduce(function (acc, originalPath) {
            var _iterator20 = _createForOfIteratorHelper(expandOptionals(originalPath)),
              _step20;
            try {
              for (_iterator20.s(); !(_step20 = _iterator20.n()).done;) {
                var expandedPath = _step20.value;
        ...
        function intercept(_ref40, get, set) {
        ...
        var debounce = function debounce(callback, wait) {
          ...
          var debounced = function debounced() {
            for (var _len18 = arguments.length, args = new Array(_len18), _key44 = 0; _key44 < _len18; _key44++) {
        ...
        var throttle = function throttle(callback, wait) {
          ...
          var throttled = function throttled() {
            for (var _len19 = arguments.length, args = new Array(_len19), _key45 = 0; _key45 < _len19; _key45++) {
        ...
        var Announcer = {
          ...
          speak: function speak(text) {
            var _ref44 = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
              _ref44$append = _ref44.append,
              append = _ref44$append === void 0 ? false : _ref44$append,
              _ref44$notification = _ref44.notification,
              notification = _ref44$notification === void 0 ? false : _ref44$notification;
            if (Announcer.onFocusChange && Announcer.enabled) {
          ...
          setupTimers: function setupTimers() {
            var _ref45 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
              _ref45$focusDebounce = _ref45.focusDebounce,
              focusDebounce = _ref45$focusDebounce === void 0 ? 400 : _ref45$focusDebounce,
              _ref45$focusChangeTim = _ref45.focusChangeTimeout,
              focusChangeTimeout = _ref45$focusChangeTim === void 0 ? fiveMinutes : _ref45$focusChangeTim;
        ...
        function accessWith(valueOrFn) {
          for (var _len20 = arguments.length, args = new Array(_len20 > 1 ? _len20 - 1 : 0), _key46 = 1; _key46 < _len20; _key46++) {
        ...
        function createStaticStore(init) {
          ...
          var _loop12 = function _loop12(_key47) {
        ...
        function getChildrenByPosition(node, x, y) {
          ...
          while (queue.length > 0) {
            ...
            var _iterator23 = _createForOfIteratorHelper(queue),
              _step23;
            try {
              for (_iterator23.s(); !(_step23 = _iterator23.n()).done;) {
                var currentNode = _step23.value;
                if (isElementNode(currentNode) && currentNode.alpha !== 0 && !currentNode.skipFocus && testCollision(x, y, currentNode.lng.absX || 0 * precision, currentNode.lng.absY || 0 * precision, (currentNode.width || 0) * precision, (currentNode.height || 0) * precision)) {
            ...
            var highestZIndexNode = null;
            if (size === 1) {
              highestZIndexNode = currentLevelNodes[0];
            } else {
              var maxZIndex = -1;
              var _iterator24 = _createForOfIteratorHelper(currentLevelNodes),
                _step24;
              try {
                for (_iterator24.s(); !(_step24 = _iterator24.n()).done;) {
                  var _node2$zIndex;
                  var node2 = _step24.value;
                  var zIndex = (_node2$zIndex = node2.zIndex) !== null && _node2$zIndex !== void 0 ? _node2$zIndex : -1;
                  if (zIndex > maxZIndex) {
                    maxZIndex = zIndex;
                    highestZIndexNode = node2;
          ...
          createEffect(function () {
            if (scheduled()) {
              var result = getChildrenByPosition(myApp, pos.x, pos.y).filter(function (el) {
                return el.focus || el.onFocus || el.onEnter;
              });
              if (result.length) {
                var _activeElm, _activeElm2;
                ...
                var activeElmParent = (_activeElm = activeElm) === null || _activeElm === void 0 ? void 0 : _activeElm.parent;
                if (activeElm && (activeElmParent === null || activeElmParent === void 0 ? void 0 : activeElmParent.selected) !== void 0) {
                  activeElmParent.selected = activeElmParent.children.indexOf(activeElm);
                }
                (_activeElm2 = activeElm) === null || _activeElm2 === void 0 || _activeElm2.setFocus();
              }
            }
          });
        }
        ...
        function makeComponentStyles(_ref46) {
          var themeKeys = _ref46.themeKeys,
            base = _ref46.base,
            themeStyles = _ref46.themeStyles,
            _ref46$modes = _ref46.modes,
            modes = _ref46$modes === void 0 ? {} : _ref46$modes,
            _ref46$tones = _ref46.tones,
            tones = _ref46$tones === void 0 ? {} : _ref46$tones,
            _ref46$modeKeys = _ref46.modeKeys,
            modeKeys = _ref46$modeKeys === void 0 ? defaultModeKeys : _ref46$modeKeys,
            _ref46$toneKeys = _ref46.toneKeys,
            toneKeys = _ref46$toneKeys === void 0 ? defaultToneKeys : _ref46$toneKeys;
          ...
          var mapThemeKeysToSolid = function mapThemeKeysToSolid(stylesToMap) {
            return objectFromEntries(Object.entries(themeKeys).filter(function (_ref47) {
          ...
          var convertComponentConfig = function convertComponentConfig(themeStyles) {
            ...
            Object.entries(themeStyles).map(function (_ref51) {
              var _ref52 = _slicedToArray(_ref51, 2),
                variantName = _ref52[0],
                styles = _ref52[1];
        ...
        function withScrolling(isRow) {
          ...
          return function (selected, componentRef, selectedElement, lastSelected) {
            var _ref57, _componentRef$_target, _componentRef$offset, _selectedElement$axis, _selectedElement$dime;
            ...
            var rootPosition = (_ref57 = (_componentRef$_target = componentRef._targetPosition) !== null && _componentRef$_target !== void 0 ? _componentRef$_target : componentRef[axis]) !== null && _ref57 !== void 0 ? _ref57 : 0;
            ...
            var movement = lastSelected === undefined ? 'none' : selected > lastSelected ? 'incremental' : 'decremental';
        ...
        function chainFunctions() {
          for (var _len21 = arguments.length, args = new Array(_len21), _key49 = 0; _key49 < _len21; _key49++) {
          ...
          return function () {
            var result;
            for (var _len22 = arguments.length, innerArgs = new Array(_len22), _key50 = 0; _key50 < _len22; _key50++) {
              innerArgs[_key50] = arguments[_key50];
            }
            var _iterator26 = _createForOfIteratorHelper(onlyFunctions),
              _step26;
            try {
              for (_iterator26.s(); !(_step26 = _iterator26.n()).done;) {
                var func = _step26.value;
        ...
        var Container$6 = makeComponentStyles(container$d);
        var Icon$1 = makeComponentStyles(icon$1);
        var Text$4 = makeComponentStyles(text$5);
        var styles$8 = exports("q", {
        ...
        function getRecommendations(_ref58) {
          var type = _ref58.type,
            id = _ref58.id;
          return api.get("/".concat(type, "/").concat(id, "/recommendations")).then(function (_ref59) {
            var results = _ref59.results;
            if (results.length) {
              return convertItemsToTiles(results.slice(0, 7));
            }
            return api.get("/trending/".concat(type, "/week?page=1")).then(function (_ref60) {
              var results = _ref60.results;
              return convertItemsToTiles(results.slice(0, 7));
            });
          });
        }
        function getCredits(_ref61) {
          var type = _ref61.type,
            id = _ref61.id;
          return api.get("/".concat(type, "/").concat(id, "/credits")).then(function (_ref62) {
            var cast = _ref62.cast;
            return convertItemsToTiles(cast.slice(0, 7));
          });
        }
        function getInfo(_ref63) {
        ...
        var Grid = lazy(function () {
          return __vitePreload(function () {
            return module.import('./Grid-legacy-JC-VMyaX.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var Portal = lazy(function () {
          return __vitePreload(function () {
            return module.import('./Portal-legacy-zD-CT31c.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var TextPage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./Text-legacy-DoAG36en.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var CreatePage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./Create-legacy-CLCMtIZT.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var ViewportPage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./Viewport-legacy-LHaiCh0l.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var ButtonsPage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./Buttons-legacy-CPG5TDlt.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var PositioningPage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./Positioning-legacy-Cupeaznx.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var TransitionsPage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./Transitions-legacy-BkvhI6SS.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var ComponentsPage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./Components-legacy-xzwnQSva.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var FocusHandlingPage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./FocusHandling-legacy-C6hkf4-t.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var GradientsPage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./Gradients-legacy-WNvegUNO.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var FlexPage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./Flex-legacy-DOU4KtuK.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var FlexSizePage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./FlexSize-legacy-CeTD-ZNg.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var FlexColumnSizePage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./FlexColumnSize-legacy-CwYHDVXR.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var FlexColumnPage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./FlexColumn-legacy-DglMEzI2.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var ButtonsMaterialPage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./ButtonsMaterial-legacy-BcMaOrhe.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var SuperFlexPage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./SuperFlex-legacy-B2hs2jxk.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var Entity = lazy(function () {
          return __vitePreload(function () {
            return module.import('./Entity-legacy-DTmvoiXi.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var People = lazy(function () {
          return __vitePreload(function () {
            return module.import('./People-legacy-B-0CyDJ8.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var LoginPage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./Login-legacy-Q2MvGTYJ.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
