...
const Player = lazy(() => __vitePreload(() => import("./Player-CD_a4tck.js"), true ? [] : void 0));
const Grid = lazy(() => __vitePreload(() => import("./Grid-CXLoa0wN.js"), true ? [] : void 0));
const Loops = lazy(() => __vitePreload(() => import("./Loops-DYvoYhUS.js"), true ? [] : void 0));
const Infinite = lazy(() => __vitePreload(() => import("./Infinite-42K6ih5q.js"), true ? [] : void 0));
const TMDBGrid = lazy(() => __vitePreload(() => import("./TMDBGrid-CdTHaBFI.js"), true ? [] : void 0));
const Portal = lazy(() => __vitePreload(() => import("./Portal-euB6jNyd.js"), true ? [] : void 0));
const MatrixPage = lazy(() => __vitePreload(() => import("./Matrix-BOS0gC8q.js"), true ? [] : void 0));
const TextPage = lazy(() => __vitePreload(() => import("./Text-Quw3JFU8.js"), true ? [] : void 0));
const TextPosterPage = lazy(() => __vitePreload(() => import("./TextPoster-D5Xyb74m.js"), true ? [] : void 0));
const CreatePage = lazy(() => __vitePreload(() => import("./Create-DLqryNwf.js"), true ? [] : void 0));
const ViewportPage = lazy(() => __vitePreload(() => import("./Viewport-CG7H_ojN.js"), true ? [] : void 0));
const PositioningPage = lazy(() => __vitePreload(() => import("./Positioning-AW5ZB8HU.js"), true ? [] : void 0));
const LayoutPage = lazy(() => __vitePreload(() => import("./Layout-B7nGq4Lp.js"), true ? [] : void 0));
const FocusBasicsPage = lazy(() => __vitePreload(() => import("./FocusBasics-qh6A4ob4.js"), true ? [] : void 0));
const KeyHandlingPage = lazy(() => __vitePreload(() => import("./KeyHandling-B7X2T8fC.js"), true ? [] : void 0));
const TransitionsPage = lazy(() => __vitePreload(() => import("./Transitions-D9vpoU4g.js"), true ? [] : void 0));
const ComponentsPage = lazy(() => __vitePreload(() => import("./Components-CMnDIcXi.js"), true ? [] : void 0));
const FocusHandlingPage = lazy(() => __vitePreload(() => import("./FocusHandling-DNiaewv8.js"), true ? [] : void 0));
const GradientsPage = lazy(() => __vitePreload(() => import("./Gradients-BE17J2ia.js"), true ? [] : void 0));
const FlexPage = lazy(() => __vitePreload(() => import("./Flex-Cnz7Xtvn.js"), true ? [] : void 0));
const FlexGrowPage = lazy(() => __vitePreload(() => import("./FlexGrow-ltmaHDdL.js"), true ? [] : void 0));
const FlexMenuPage = lazy(() => __vitePreload(() => import("./FlexMenu-PKj1TOZr.js"), true ? [] : void 0));
const FlexSizePage = lazy(() => __vitePreload(() => import("./FlexSize-C5b2RhIf.js"), true ? [] : void 0));
const FlexColumnSizePage = lazy(() => __vitePreload(() => import("./FlexColumnSize-B0OaogU_.js"), true ? [] : void 0));
const FlexColumnPage = lazy(() => __vitePreload(() => import("./FlexColumn-HyD_sphV.js"), true ? [] : void 0));
const ButtonsMaterialPage = lazy(() => __vitePreload(() => import("./ButtonsMaterial-w-zwBhkR.js"), true ? [] : void 0));
const SuperFlexPage = lazy(() => __vitePreload(() => import("./SuperFlex-DZs7Oo6F.js"), true ? [] : void 0));
const Entity = lazy(() => __vitePreload(() => import("./Entity-BwKAb2do.js"), true ? [] : void 0));
const People = lazy(() => __vitePreload(() => import("./People-D47TzQtP.js"), true ? [] : void 0));
const FireboltPage = lazy(() => __vitePreload(() => import("./Firebolt-9yOWg_U6.js"), true ? [] : void 0));
const LoginPage = lazy(() => __vitePreload(() => import("./Login-BSc67s-j.js"), true ? [] : void 0));
const VirtualPage = lazy(() => __vitePreload(() => import("./Virtual-B13OdrPr.js"), true ? [] : void 0));
const TagsPage = lazy(() => __vitePreload(() => import("./Tags-DgUhcl1Y.js"), true ? [] : void 0));
        ...
        return [createComponent(Route, {
          ...
          get children() {
            return [createComponent(Route, {
              ...
              path: "nested",
              get component() {
                return lazy(() => __vitePreload(() => import("./Nested-9u0079ev.js"), true ? [] : void 0));
              }
            }), createComponent(Route, {
              path: "textposter",
              ...
              path: "keepalive",
              get component() {
                return lazy(() => __vitePreload(() => import("./KeepAlive-5in24V6H.js"), true ? [] : void 0));
              }
            }), createComponent(Route, {
              path: "suspense",
              get component() {
                return lazy(() => __vitePreload(() => import("./suspense-CEP5g0Di.js"), true ? [] : void 0));
              }
            }), createComponent(Route, {
              path: "superflex",
