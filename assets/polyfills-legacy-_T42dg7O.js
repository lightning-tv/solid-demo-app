(function () {
  ...
  */
  ...
  $$1e({ global: true, constructor: true, wrap: true, forced: !NATIVE_SYMBOL$5, sham: !NATIVE_SYMBOL$5 }, {
    Symbol: $Symbol
  });
  ...
  $$1e({ target: SYMBOL, stat: true, forced: !NATIVE_SYMBOL$5 }, {
    useSetter: function () { USE_SETTER = true; },
    useSimple: function () { USE_SETTER = false; }
  });

  $$1e({ target: 'Object', stat: true, forced: !NATIVE_SYMBOL$5, sham: !DESCRIPTORS$s }, {
    // `Object.create` method
    // https://tc39.es/ecma262/#sec-object.create
    create: $create,
    // `Object.defineProperty` method
  ...
  $$1e({ target: 'Object', stat: true, forced: !NATIVE_SYMBOL$5 }, {
    // `Object.getOwnPropertyNames` method
    // https://tc39.es/ecma262/#sec-object.getownpropertynames
  ...
  $$1d({ target: 'Symbol', stat: true, forced: !NATIVE_SYMBOL_REGISTRY$1 }, {
    'for': function (key) {
  ...
  $$1c({ target: 'Symbol', stat: true, forced: !NATIVE_SYMBOL_REGISTRY }, {
  ...
  if ($stringify) {
    ...
    $$1b({ target: 'JSON', stat: true, arity: 3, forced: WRONG_SYMBOLS_CONVERSION || ILL_FORMED_UNICODE }, {
      // eslint-disable-next-line no-unused-vars -- required for `.length`
  ...
  $$1a({ target: 'Object', stat: true, forced: FORCED$e }, {
  ...
  if (DESCRIPTORS$r && isCallable$h(NativeSymbol) && (!('description' in SymbolPrototype) ||
    ...
    $$19({ global: true, constructor: true, forced: true }, {
  ...
  var exportGlobalErrorCauseWrapper = function (ERROR_NAME, wrapper) {
    ...
    $$18({ global: true, constructor: true, arity: 1, forced: FORCED$d }, O);
  };
  ...
  var exportWebAssemblyErrorCauseWrapper = function (ERROR_NAME, wrapper) {
    if (WebAssembly && WebAssembly[ERROR_NAME]) {
      ...
      $$18({ target: WEB_ASSEMBLY, stat: true, constructor: true, arity: 1, forced: FORCED$d }, O);
    }
  };
  ...
  $$17({ target: 'Array', proto: true, arity: 1, forced: FORCED$c }, {
    // eslint-disable-next-line no-unused-vars -- required for `.length`
  ...
  // `Array.prototype.find` method
  // https://tc39.es/ecma262/#sec-array.prototype.find
  $$14({ target: 'Array', proto: true, forced: SKIPS_HOLES$1 }, {
