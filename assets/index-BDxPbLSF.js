const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Buttons-BtdsL_ha.js","assets/Button-D26ptxUp.js","assets/Entity-Bs7NTkaR.js","assets/Login-CAk4Ex43.js"])))=>i.map(i=>d[i]);
...
function createRouterContext(integration, branches, getContext, options = {}) {
  ...
  const params2 = SUPPORTS_PROXY ? createMemoObject(paramsHandler) : createMemoWithoutProxy(paramsHandler, collectDynamicParams(branches()));
  const baseRoute = {
    pattern: basePath2,
    path: () => basePath2,
    outlet: () => null,
...
const Grid = lazy(() => __vitePreload(() => import("./Grid-Ddd07UjF.js"), true ? [] : void 0));
const Portal = lazy(() => __vitePreload(() => import("./Portal-Bmwe2KND.js"), true ? [] : void 0));
const TextPage = lazy(() => __vitePreload(() => import("./Text-C6qOxLRh.js"), true ? [] : void 0));
const CreatePage = lazy(() => __vitePreload(() => import("./Create-DOF9vkdX.js"), true ? [] : void 0));
const ViewportPage = lazy(() => __vitePreload(() => import("./Viewport-Blc4qx2c.js"), true ? [] : void 0));
const ButtonsPage = lazy(() => __vitePreload(() => import("./Buttons-BtdsL_ha.js"), true ? __vite__mapDeps([0,1]) : void 0));
const FlexPage = lazy(() => __vitePreload(() => import("./Flex-D8JxZgkV.js"), true ? [] : void 0));
const FlexSizePage = lazy(() => __vitePreload(() => import("./FlexSize-XDsUexGc.js"), true ? [] : void 0));
const FlexColumnSizePage = lazy(() => __vitePreload(() => import("./FlexColumnSize-DAOQitg-.js"), true ? [] : void 0));
const FlexColumnPage = lazy(() => __vitePreload(() => import("./FlexColumn-C-_Tab8u.js"), true ? [] : void 0));
const ButtonsMaterialPage = lazy(() => __vitePreload(() => import("./ButtonsMaterial-CKYj4P_n.js"), true ? [] : void 0));
const SuperFlexPage = lazy(() => __vitePreload(() => import("./SuperFlex-CQSSPXVo.js"), true ? [] : void 0));
const Entity = lazy(() => __vitePreload(() => import("./Entity-Bs7NTkaR.js"), true ? __vite__mapDeps([2,1]) : void 0));
const People = lazy(() => __vitePreload(() => import("./People-CqDCHj-e.js"), true ? [] : void 0));
const LoginPage = lazy(() => __vitePreload(() => import("./Login-CAk4Ex43.js"), true ? __vite__mapDeps([3,1]) : void 0));
...
(() => {
  try {
    ...
    let ImageDataPolyfill = function() {
      ...
      const width = args[0], height = args[1], canvas = document.createElement("canvas"), ctx = canvas.getContext("2d"), imageData = ctx.createImageData(width, height);
