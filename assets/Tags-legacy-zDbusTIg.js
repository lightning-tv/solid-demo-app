...
(function () {
  ...
  System.register(['./index-legacy-Gh2J-Jdf.js'], function (exports, module) {
    ...
    var createSignal, createElement, setProp, rootNode, insert, spread, mergeProps, setGlobalBackground, createComponent, View, Text, onCleanup;
    return {
      ...
      execute: function execute() {
        function createTag(children) {
          var _createSignal = createSignal(null),
            ...
            texture = _createSignal2[0],
            setTexture = _createSignal2[1];
          var Tag = function () {
        ...
        var TagsPage = exports("default", function () {
          setGlobalBackground(0x111111FF);
