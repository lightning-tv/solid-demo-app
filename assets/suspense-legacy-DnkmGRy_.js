...
(function () {
  ...
  System.register(['./index-legacy-DI1vmr81.js'], function (exports, module) {
    'use strict';

    var setGlobalBackground, createResource, createElement, setProp, insert, createComponent, createTextNode, insertNode, use, createSignal, onMount, onCleanup, createEffect, Suspense$1, memo, children;
    return {
      ...
      execute: function execute() {
        ...
        function Suspense(props) {
          var children$1;
          var suspense = Suspense$1({
            get children() {
              return [children$1 = children(function () {
          ...
          return [memo(function () {
            var _suspense;
            return (_suspense = suspense()) !== null && _suspense !== void 0 ? _suspense : props.fallback;
          }), function () {
            var _el$ = createElement("view");
            setProp(_el$, "hidden", true);
            insert(_el$, function () {
              return suspense() ? null : children$1;
            });
            return _el$;
          }()];
        }
        ...
        function SuspensePage() {
          ...
          var lastCount = 0;
          var _createResource = createResource(/*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
              return _regeneratorRuntime().wrap(function _callee$(_context) {
                while (1) switch (_context.prev = _context.next) {
                  ...
                  case 2:
                    return _context.abrupt("return", ++lastCount);
                  case 3:
                  case "end":
            ...
            insert(_el$2, createComponent(Suspense, {
              ...
              get children() {
                var _el$3 = createElement("view"),
                  ...
                  _el$5 = createTextNode("Hello World"),
                  _el$6 = createTextNode(" (Press Enter to refetch)");
                ...
                setProp(_el$3, "onEnter", function () {
                  refetch();
                });
