(function () {
	...
	var toString$n = uncurryThis$T({}.toString);
	...
	var ordinaryToPrimitive$2 = function (input, pref) {
	  var fn, val;
	  if (pref === 'string' && isCallable$r(fn = input.toString) && !isObject$t(val = call$C(fn, input))) return val;
	  if (isCallable$r(fn = input.valueOf) && !isObject$t(val = call$C(fn, input))) return val;
	  if (pref !== 'string' && isCallable$r(fn = input.toString) && !isObject$t(val = call$C(fn, input))) return val;
	...
	var toString$m = uncurryThis$P(1.0.toString);
	...
	var ie8DomDefine = !DESCRIPTORS$y && !fails$M(function () {
	  // eslint-disable-next-line es/no-object-defineproperty -- required for testing
	...
	objectGetOwnPropertyDescriptor.f = DESCRIPTORS$x ? $getOwnPropertyDescriptor$2 : function getOwnPropertyDescriptor(O, P) {
	...
	var v8PrototypeDefineBug = DESCRIPTORS$w && fails$L(function () {
	  // eslint-disable-next-line es/no-object-defineproperty -- required for testing
	...
	var createNonEnumerableProperty$e = DESCRIPTORS$u ? function (object, key, value) {
	...
	var TypeError$7 = globalThis$H.TypeError;
	...
	var CONFIGURABLE_LENGTH = DESCRIPTORS$s && !fails$K(function () {
	...
	var makeBuiltIn$2 = makeBuiltIn$3.exports = function (value, name, options) {
	  ...
	  if (!hasOwn$p(value, 'name') || (CONFIGURABLE_FUNCTION_NAME$2 && value.name !== name)) {
	    if (DESCRIPTORS$s) defineProperty$9(value, 'name', { value: name, configurable: true });
	  ...
	  try {
	    if (options && hasOwn$p(options, 'constructor') && options.constructor) {
	      if (DESCRIPTORS$s) defineProperty$9(value, 'prototype', { writable: false });
	...
	var isForced$4 = function (feature, detection) {
	  ...
	  return value === POLYFILL ? true
	    : value === NATIVE ? false
	    : isCallable$m(detection) ? fails$J(detection)
	    : !!detection;
	};
	...
	*/
	...
	objectDefineProperties.f = DESCRIPTORS$r && !V8_PROTOTYPE_DEFINE_BUG ? Object.defineProperties : function defineProperties(O, Properties) {
	  anObject$w(O);
	...
	var bind$d = uncurryThis$I(uncurryThis$I.bind);
	...
	var exec$7 = uncurryThis$H(constructorRegExp.exec);
	...
	var $Symbol = globalThis$E.Symbol;
	var SymbolPrototype$1 = $Symbol && $Symbol[PROTOTYPE$1];
	var RangeError$4 = globalThis$E.RangeError;
	var TypeError$6 = globalThis$E.TypeError;
	var QObject = globalThis$E.QObject;
	var nativeGetOwnPropertyDescriptor$1 = getOwnPropertyDescriptorModule$4.f;
	var nativeDefineProperty$1 = definePropertyModule$3.f;
	var nativeGetOwnPropertyNames = getOwnPropertyNamesExternal.f;
	var nativePropertyIsEnumerable = propertyIsEnumerableModule$1.f;
	var push$c = uncurryThis$F([].push);
	...
	var setSymbolDescriptor = DESCRIPTORS$q && fails$H(function () {
	...
	var $defineProperties = function defineProperties(O, Properties) {
	  ...
	  $forEach$1(keys, function (key) {
	    if (!DESCRIPTORS$q || call$y($propertyIsEnumerable$1, properties, key)) $defineProperty(O, key, properties[key]);
	  });
	  return O;
	};
	...
	if (!NATIVE_SYMBOL$5) {
	  $Symbol = function Symbol() {
	    ...
	    var setter = function (value) {
	      var $this = this === undefined ? globalThis$E : this;
	    ...
	    if (DESCRIPTORS$q && USE_SETTER) setSymbolDescriptor(ObjectPrototype$4, tag, { configurable: true, set: setter });
	...
	$$15({ global: true, constructor: true, wrap: true, forced: !NATIVE_SYMBOL$5, sham: !NATIVE_SYMBOL$5 }, {
	  Symbol: $Symbol
	});
	...
	$$15({ target: SYMBOL, stat: true, forced: !NATIVE_SYMBOL$5 }, {
	  useSetter: function () { USE_SETTER = true; },
	  useSimple: function () { USE_SETTER = false; }
	});

	$$15({ target: 'Object', stat: true, forced: !NATIVE_SYMBOL$5, sham: !DESCRIPTORS$q }, {
	  // `Object.create` method
	  // https://tc39.es/ecma262/#sec-object.create
	  create: $create,
	  // `Object.defineProperty` method
	...
	$$15({ target: 'Object', stat: true, forced: !NATIVE_SYMBOL$5 }, {
	  // `Object.getOwnPropertyNames` method
	  // https://tc39.es/ecma262/#sec-object.getownpropertynames
	...
	$$14({ target: 'Symbol', stat: true, forced: !NATIVE_SYMBOL_REGISTRY$1 }, {
	  'for': function (key) {
	...
	$$13({ target: 'Symbol', stat: true, forced: !NATIVE_SYMBOL_REGISTRY }, {
	...
	var functionApply = typeof Reflect == 'object' && Reflect.apply || (NATIVE_BIND$1 ? call$x.bind(apply$5) : function () {
	  return call$x.apply(apply$5, arguments);
	});
	...
	var FORCED$9 = !NATIVE_SYMBOL$2 || fails$F(function () { getOwnPropertySymbolsModule$1.f(1); });

	// `Object.getOwnPropertySymbols` method
	// https://tc39.es/ecma262/#sec-object.getownpropertysymbols
	$$11({ target: 'Object', stat: true, forced: FORCED$9 }, {
	...
	if (DESCRIPTORS$p && isCallable$h(NativeSymbol) && (!('description' in SymbolPrototype) ||
	  // Safari 12 bug
	...
	var functionUncurryThisAccessor = function (object, key, method) {
	  try {
	    // eslint-disable-next-line es/no-object-getownpropertydescriptor -- safe
	    return uncurryThis$B(aCallable$j(Object.getOwnPropertyDescriptor(object, key)[method]));
	  } catch (error) { /* empty */ }
	};
	...
	var exportGlobalErrorCauseWrapper = function (ERROR_NAME, wrapper) {
	  ...
	  $$$({ global: true, constructor: true, arity: 1, forced: FORCED$8 }, O);
	};
	...
	var exportWebAssemblyErrorCauseWrapper = function (ERROR_NAME, wrapper) {
	  if (WebAssembly && WebAssembly[ERROR_NAME]) {
	    ...
	    $$$({ target: WEB_ASSEMBLY, stat: true, constructor: true, arity: 1, forced: FORCED$8 }, O);
	  }
	};
	...
	var createProperty$8 = function (object, key, value) {
	  if (DESCRIPTORS$n) definePropertyModule$2.f(object, key, createPropertyDescriptor$4(0, value));
	...
	$$_({ target: 'Array', proto: true, arity: 1, forced: FORCED$7 }, {
	  // eslint-disable-next-line no-unused-vars -- required for `.length`
	...
	// `Array.prototype.indexOf` method
	// https://tc39.es/ecma262/#sec-array.prototype.indexof
	$$V({ target: 'Array', proto: true, forced: FORCED$6 }, {
	...
	var NEW_ITERATOR_PROTOTYPE = !isObject$i(IteratorPrototype$4) || fails$y(function () {
	  var test = {};
	...
	$$S({ target: 'Array', proto: true, arity: 1, forced: FORCED$5 }, {
	  // eslint-disable-next-line no-unused-vars -- required for `.length`
	...
	var environment = (function () {
	  ...
	  if (classof$c(globalThis$B.process) === 'process') return 'NODE';
	...
	var push$a = uncurryThis$y(test.push);
	...
	var ArrayBuffer$5 = globalThis$A.ArrayBuffer;
	var TypeError$5 = globalThis$A.TypeError;
	...
	var slice$5 = ArrayBufferPrototype$4 && uncurryThis$x(ArrayBufferPrototype$4.slice);
	...
	if (DESCRIPTORS$k && !('detached' in ArrayBufferPrototype$3)) {
	...
	var $ArrayBuffer$1 = globalThis$w.ArrayBuffer;
	...
	var slice$4 = uncurryThis$w(ArrayBufferPrototype$2.slice);
	...
	var getInt8 = uncurryThis$w(DataViewPrototype$1.getInt8);
	...
	var collection$3 = function (CONSTRUCTOR_NAME, wrapper, common) {
	  ...
	  var REPLACE = isForced$2(
	    CONSTRUCTOR_NAME,
	    !isCallable$c(NativeConstructor) || !(IS_WEAK || NativePrototype.forEach && !fails$r(function () {
	...
	var objectAssign = !$assign || fails$q(function () {
	  ...
	  if (DESCRIPTORS$h && $assign({ b: 1 }, $assign(defineProperty$1({}, 'a', {
	    enumerable: true,
	    get: function () {
	  ...
	  while (argumentsLength > index) {
	    ...
	    while (length > j) {
	      key = keys[j++];
	      if (!DESCRIPTORS$h || call$q(propertyIsEnumerable, S, key)) T[key] = S[key];
	    }
	  } return T;
	} : $assign;
	...
	var IE_BUG = DESCRIPTORS$g && fails$p(function () {
	  // eslint-disable-next-line es/no-object-create -- safe
	...
	var set$2 = globalThis$s.setImmediate;
	...
	if (!set$2 || !clear) {
	  ...
	  // IE8 has postMessage, but it's sync & typeof its postMessage is 'object'
	    ...
	    isCallable$b(globalThis$s.postMessage) &&
	...
	var safeGetBuiltIn$2 = function (name) {
	  if (!DESCRIPTORS$e) return globalThis$r[name];
	  var descriptor = getOwnPropertyDescriptor$3(globalThis$r, name);
	...
	var NATIVE_PROMISE_REJECTION_EVENT$1 = isCallable$a(globalThis$o.PromiseRejectionEvent);
	...
	var onUnhandled = function (state) {
	  call$p(task, globalThis$n, function () {
	...
	var SyntaxError$2 = globalThis$i.SyntaxError;
	var exec$5 = uncurryThis$r(RegExpPrototype$4.exec);
	  ...
	  return [
	    ...
	    function (string, replaceValue) {
	      ...
	      for (var i = 0; i < results.length; i++) {
	        ...
	        var position = max(min$2(toIntegerOrInfinity$5(result.index), S.length), 0);
	        var captures = [];
	        var replacement;
	...
	var Int8Array$1 = globalThis$c.Int8Array;
