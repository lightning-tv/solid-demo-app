...
(function () {
  ...
  `);
    ...
    `;
        ...
        var Grid = lazy(() => __vitePreload(() => module.import('./Grid-legacy-DNGIYthx.js'), false ? __VITE_PRELOAD__ : void 0));
        var Portal = lazy(() => __vitePreload(() => module.import('./Portal-legacy-B5JPkiwa.js'), false ? __VITE_PRELOAD__ : void 0));
        var TextPage = lazy(() => __vitePreload(() => module.import('./Text-legacy-Nzr6_wzV.js'), false ? __VITE_PRELOAD__ : void 0));
        var CreatePage = lazy(() => __vitePreload(() => module.import('./Create-legacy-CTLICfZ0.js'), false ? __VITE_PRELOAD__ : void 0));
        var ViewportPage = lazy(() => __vitePreload(() => module.import('./Viewport-legacy-DwueH-dB.js'), false ? __VITE_PRELOAD__ : void 0));
        var ButtonsPage = lazy(() => __vitePreload(() => module.import('./Buttons-legacy-C39cj2Mz.js'), false ? __VITE_PRELOAD__ : void 0));
        var FlexPage = lazy(() => __vitePreload(() => module.import('./Flex-legacy-DtcmB7XA.js'), false ? __VITE_PRELOAD__ : void 0));
        var FlexSizePage = lazy(() => __vitePreload(() => module.import('./FlexSize-legacy-AQt2lKl7.js'), false ? __VITE_PRELOAD__ : void 0));
        var FlexColumnSizePage = lazy(() => __vitePreload(() => module.import('./FlexColumnSize-legacy-DbP4jsw9.js'), false ? __VITE_PRELOAD__ : void 0));
        var FlexColumnPage = lazy(() => __vitePreload(() => module.import('./FlexColumn-legacy-CpbGYHhu.js'), false ? __VITE_PRELOAD__ : void 0));
        var ButtonsMaterialPage = lazy(() => __vitePreload(() => module.import('./ButtonsMaterial-legacy-C2cbZki_.js'), false ? __VITE_PRELOAD__ : void 0));
        var SuperFlexPage = lazy(() => __vitePreload(() => module.import('./SuperFlex-legacy-ChJbUwYo.js'), false ? __VITE_PRELOAD__ : void 0));
        var Entity = lazy(() => __vitePreload(() => module.import('./Entity-legacy-e-xqrSs7.js'), false ? __VITE_PRELOAD__ : void 0));
        var People = lazy(() => __vitePreload(() => module.import('./People-legacy-tzFHUIIi.js'), false ? __VITE_PRELOAD__ : void 0));
        var LoginPage = lazy(() => __vitePreload(() => module.import('./Login-legacy-CHyp9e8Z.js'), false ? __VITE_PRELOAD__ : void 0));
        Config.debug = false;
...
//# sourceMappingURL=index-legacy-B4NAVpV8.js.map
