import { c as createSignal, s as setGlobalBackground, f as createEffect, h as createComponent, V as View, T as Text, R as Row } from "./index-CMF002ea.js";
  ...
  if (typeof callback2 !== "function") {
    ...
    if (promises.length) {
      promises.reduce((prevPromise, currentPromise) => {
        return prevPromise.then(() => currentPromise).then((responses) => {
