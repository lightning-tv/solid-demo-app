import { a as createSignal, s as setGlobalBackground, g as createEffect, c as createComponent, V as View, T as Text, R as Row } from "./index-DQC749ds.js";
...
function event(module, event2, value) {
    const listener2 = Object.entries(eventMap).find(([k, v]) => v.toLowerCase() === module.toLowerCase() + "." + event2.toLowerCase());
    if (listener2) {
...
function dotGrab$1(obj = {}, key) {
    ...
    for (let i = 0; i < keys2.length; i++) {
        ref = (Object.entries(ref).find(([k, v]) => k.toLowerCase() === keys2[i].toLowerCase()) || [ null, {} ])[1];
    }
    return ref;
}
...
function mock(module, method, params, value, contextParameterCount, def) {
    ...
    if (type2 === "getter") {
        ...
        return value2;
    } else if (type2 === "subscriber") ; else if (type2 === "setter") {
        mocks[key] = value;
...
const _Accessibility = {
    ...
    closedCaptionsSettings: function(params) {
        return MockProps.mock("Accessibility", "closedCaptionsSettings", params, void 0, 0, {
            enabled: true,
            styles: {
                fontFamily: "monospaced_sanserif",
                fontSize: 1,
    ...
    highContrastUI: function(params) {
        return MockProps.mock("Accessibility", "highContrastUI", params, void 0, 0, true);
    },
    voiceGuidance: {
        enabled: true,
    ...
    voiceGuidanceSettings: function(params) {
        return MockProps.mock("Accessibility", "voiceGuidanceSettings", params, void 0, 0, {
            enabled: true,
            navigationHints: true,
            rate: 1
        });
    ...
    audioDescriptionSettings: function(params) {
        return MockProps.mock("Accessibility", "audioDescriptionSettings", params, void 0, 0, {
            enabled: true
        });
    }
};
...
const _Account = {
    ...
    uid: function(params) {
        return MockProps.mock("Account", "uid", params, void 0, 0, "ee6723b8-7ab3-462c-8d93-dbf61227998e");
    }
};
...
const _HDMIInput = {
    ...
    lowLatencyMode: function(params) {
        return MockProps.mock("HDMIInput", "lowLatencyMode", params, void 0, 0, true);
    },
    autoLowLatencyModeCapable: function(params) {
        return MockProps.mock("HDMIInput", "autoLowLatencyModeCapable", params, void 0, 1, true);
    },
    edidVersion: function(params) {
        return MockProps.mock("HDMIInput", "edidVersion", params, void 0, 1, "2.0");
    }
};
...
const _Device = {
    ...
    distributor: function(params) {
        return MockProps.mock("Device", "distributor", params, void 0, 0, "Company");
    },
    platform: function(params) {
        return MockProps.mock("Device", "platform", params, void 0, 0, "WPE");
    },
    uid: function(params) {
        return MockProps.mock("Device", "uid", params, void 0, 0, "ee6723b8-7ab3-462c-8d93-dbf61227998e");
    },
    ...
    screenResolution: function(params) {
        return MockProps.mock("Device", "screenResolution", params, void 0, 0, [ 1920, 1080 ]);
    },
    videoResolution: function(params) {
        return MockProps.mock("Device", "videoResolution", params, void 0, 0, [ 1920, 1080 ]);
    },
...
const _Localization = {
    locality: function(params) {
        return MockProps.mock("Localization", "locality", params, void 0, 0, "Philadelphia");
    },
    postalCode: function(params) {
        return MockProps.mock("Localization", "postalCode", params, void 0, 0, "19103");
    },
    countryCode: function(params) {
        return MockProps.mock("Localization", "countryCode", params, void 0, 0, "US");
    },
    language: function(params) {
        return MockProps.mock("Localization", "language", params, void 0, 0, "en");
    },
    preferredAudioLanguages: function(params) {
        return MockProps.mock("Localization", "preferredAudioLanguages", params, void 0, 0, [ "spa", "eng" ]);
    },
    locale: function(params) {
        return MockProps.mock("Localization", "locale", params, void 0, 0, "en-US");
    },
...
const _SecondScreen = {
    ...
    friendlyName: function(params) {
        return MockProps.mock("SecondScreen", "friendlyName", params, void 0, 0, "Living Room");
    }
};
...
function transform(result, transforms) {
    ...
    const {methods: methods} = transforms;
...
class Transport {
    ...
    _sendAndGetId(module, method, params, transforms) {
        const {promise: promise, json: json, id: id2} = this._processRequest(module, method, params, transforms);
    ...
    if (typeof callback2 !== "function") {
        ...
        events.forEach(event3 => {
            ...
            if (Object.values(listeners.get(key)).length === 0) {
                ...
                const {id: id2, promise: promise} = Transport.listen(module, "on" + event3[0].toUpperCase() + event3.substring(1), args);
                keys[id2] = key;
        ...
        if (promises.length) {
            promises.reduce((prevPromise, currentPromise) => prevPromise.then(() => currentPromise).then(responses => {
                resolve(templistenerId);
            }).catch(error => {
                if (event2 === "*") {
                    resolve(templistenerId);
                } else {
                    doClear(templistenerId, event2, context);
                    reject(error);
                }
            }), Promise.resolve());
        } else {
