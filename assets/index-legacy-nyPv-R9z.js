...
(function () {
  ...
  System.register([], function (exports, module) {
      ...
      execute: function execute() {
        ...
        class Texture extends EventEmitter {
          constructor(txManager) {
            ...
            _defineProperty(this, "type", TextureType.generic);
          ...
          load() {
            if (this.state === 'fetching' || this.state === 'loading' || this.state === 'loaded' || this.state === 'failed') {
              return;
            }
        ...
        class CoreNode extends EventEmitter {
          constructor(stage, props) {
            ...
            _defineProperty(this, "childUpdateType", UpdateType.None);
          ...
          loadRenderTexture() {
            ...
            this.texture.once('loaded', () => {
              ...
              (_this$stage$renderer2 = this.stage.renderer) === null || _this$stage$renderer2 === void 0 || _this$stage$renderer2.renderToTexture(this); // Only this RTT node
              this.setUpdateType(UpdateType.IsRenderable);
            });
          }
          cleanupRenderTexture() {
            var _this$stage$renderer3;
            this.unloadTexture();
            this.clearRTTInheritance();
            (_this$stage$renderer3 = this.stage.renderer) === null || _this$stage$renderer3 === void 0 || _this$stage$renderer3.removeRTTNode(this);
              ...
              return _regeneratorRuntime().wrap(function _callee2$(_context2) {
                while (1) switch (_context2.prev = _context2.next) {
                  case 0:
                    ...
                    if (_this2.color === 0xffffffff) {
                      pixelData[0] = 255;
                      pixelData[1] = 255;
                      pixelData[2] = 255;
                      pixelData[3] = 255;
                    } else {
                      pixelData[0] = _this2.color >> 16 & 0xff; // Red
                      pixelData[1] = _this2.color >> 8 & 0xff; // Green
                      pixelData[2] = _this2.color & 0xff; // Blue
                      pixelData[3] = _this2.color >>> 24 & 0xff; // Alpha
                    }
        ...
        var loadCompressedTexture = /*#__PURE__*/function () {
          var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(url) {
        ...
        var loadPVRData = /*#__PURE__*/function () {
          var _ref4 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee5(buffer) {
        ...
        class ImageTexture extends Texture {
          ...
          createImageBitmap(blob, premultiplyAlpha, sx, sy, sw, sh) {
            ...
            return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee7() {
              var hasAlphaChannel, imageBitmapSupported, bitmap, _bitmap;
              return _regeneratorRuntime().wrap(function _callee7$(_context7) {
                while (1) switch (_context7.prev = _context7.next) {
                  case 0:
                    ...
                    if (!(imageBitmapSupported.full === true && sx !== null && sy !== null && sw !== null && sh !== null)) {
                      _context7.next = 9;
                      break;
                    }
                    _context7.next = 5;
                  ...
                  case 9:
                    if (!(imageBitmapSupported.options === true)) {
                      _context7.next = 16;
                      break;
                    }
                    _context7.next = 12;
                ...
                while (1) switch (_context11.prev = _context11.next) {
                  case 0:
                    return _context11.abrupt("return", new Promise((resolve, reject) => {
                      if (_this7.parentTexture.state === 'loaded') {
                        resolve({
                          data: _this7.props
                        });
                      }
                      _this7.parentTexture.once('loaded', (target, data) => {
                        resolve({
                          data: _this7.props
                        });
                      });
                      _this7.parentTexture.once('failed', (target, error) => {
                        reject(error);
                      });
                      _this7.parentTexture.once('freed', () => {
        ...
        class CoreTextureManager extends EventEmitter {
          constructor(stage, numImageWorkers) {
            ...
            this.stage = stage;
            this.validateCreateImageBitmap().then(result => {
              this.hasCreateImageBitmap = result.basic || result.options || result.full;
            ...
            return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee13() {
              ...
              return _regeneratorRuntime().wrap(function _callee13$(_context13) {
                while (1) switch (_context13.prev = _context13.next) {
                  ...
                  case 12:
                    bitmapWithOptions = _context13.sent;
                  ...
                  case 22:
                    bitmapWithFullOptions = _context13.sent;
                  ...
                  case 29:
                    return _context13.abrupt("return", support);
                  case 30:
                  case "end":
                    return _context13.stop();
                }
              }, _callee13, null, [[8, 17], [19, 27]]);
            }))();
          }
          ...
          processSome(maxProcessingTime) {
            ...
            var _loop = function _loop() {
              // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
              var texture = _this9.priorityQueue.shift();
              texture.getTextureData().then(() => {
        ...
        class WebGlCoreShader extends CoreShader {
          constructor(options) {
            ...
            if (!vertexShader || !fragmentShader) {
              throw new Error(`Unable to create the following shader(s): ${[!vertexShader && 'VERTEX_SHADER', !fragmentShader && 'FRAGMENT_SHADER'].filter(Boolean).join(' and ')}`);
            }
          ...
          bindUniformMethods(props) {
            ...
            for (var i = 0; i < effectsL; i++) {
              ...
              var _loop3 = function _loop3() {
                  ...
                  var location = _this10.getUniformLocation(uniformInfo[key].name);
    ...
    `;
        ...
        `;
          ...
          static resolveMethodDuplicate(key, effectMethod, methodCollection) {
  ...
  `);
          ...
          constructor(type, shader, props, stage) {
            ...
            var _loop4 = function _loop4() {
              ...
              Object.defineProperty(definedProps, name, {
                get: () => {
                  return _this11.resolvedProps[name];
                },
                set: value => {
                  _this11.resolvedProps[name] = value;
                  stage.requestRender();
                }
              });
            };
            ...
            var _loop5 = function _loop5(i) {
              ...
              var _loop6 = function _loop6() {
                ...
                Object.defineProperty(definedEffectProps, propName, {
                  get: () => {
                    return _this12.resolvedProps.effects[i].props[propName].value;
                  },
                  set: value => {
                    var target = _this12.resolvedProps.effects[i].props[propName];
                    target.value = value;
        ...
        class Stage {
           ...
           */
          flushFrameEvents() {
            var _iterator9 = _createForOfIteratorHelper(this.frameEventQueue),
              _step9;
            try {
          ...
          resolveNodeDefaults(props) {
            var _props$color8, _ref7, _ref8, _props$colorTl, _ref9, _ref10, _props$colorTr, _ref11, _ref12, _props$colorBl, _ref13, _ref14, _props$colorBr, _props$x, _props$y, _props$width10, _props$height4, _props$alpha, _props$autosize, _props$clipping, _props$colorTop, _props$colorBottom, _props$colorLeft, _props$colorRight, _props$zIndex, _props$zIndexLocked, _props$parent3, _props$texture, _props$textureOptions, _props$shader, _props$src2, _props$scale, _ref15, _props$scaleX, _ref16, _props$scaleY, _props$mount, _ref17, _props$mountX, _ref18, _props$mountY, _props$pivot2, _ref19, _props$pivotX, _ref20, _props$pivotY, _props$rotation, _props$rtt, _props$preventCleanup, _props$strictBounds;
        ...
        class RendererMain extends EventEmitter {
          ...
          constructor(settings, target) {
            var _settings$textureMemo, _settings$textureMemo2, _settings$textureMemo3, _settings$textureMemo4, _settings$textureMemo5, _settings$clearColor, _settings$enableConte, _settings$forceWebGL, _settings$inspector, _settings$quadBufferS, _settings$strictBound;
            super();
            _defineProperty(this, "root", void 0);
        ...
        class WebGlCoreCtxTexture extends CoreContextTexture {
          ...
          load() {
            ...
            this.onLoadRequest().then(_ref21 => {
            ...
            return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee14() {
              ...
              return _regeneratorRuntime().wrap(function _callee14$(_context14) {
                while (1) switch (_context14.prev = _context14.next) {
                  case 0:
                    glw = _this13.glw;
                    textureData = _this13.textureSource.textureData; // Set to a 1x1 transparent texture
                    glw.texImage2D(0, glw.RGBA, 1, 1, 0, glw.RGBA, glw.UNSIGNED_BYTE, null);
                    _this13.setTextureMemUse(TRANSPARENT_TEXTURE_DATA.byteLength);
                    // If the texture has been freed while loading, return early.
                    if (_this13._nativeCtxTexture) {
                      _context14.next = 7;
                      break;
                    }
                    assertTruthy(_this13.state === 'freed');
                  ...
                  case 7:
                    ...
                    isHTMLImageElement(tdata)) {
                      width = tdata.width;
                      height = tdata.height;
                      glw.bindTexture(_this13._nativeCtxTexture);
                      glw.pixelStorei(glw.UNPACK_PREMULTIPLY_ALPHA_WEBGL, !!textureData.premultiplyAlpha);
                      glw.texImage2D(0, format, format, glw.UNSIGNED_BYTE, tdata);
                      _this13.setTextureMemUse(height * width * formatBytes * memoryPadding);
                    } else if (tdata === null) {
                      width = 0;
                      height = 0;
                      ...
                      _this13.setTextureMemUse(view.byteLength);
                      ...
                      _this13.setTextureMemUse(width * height * formatBytes);
                    } else {
            ...
            return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee15() {
              ...
              return _regeneratorRuntime().wrap(function _callee15$(_context15) {
                while (1) switch (_context15.prev = _context15.next) {
                  case 0:
                    props = _this14.textureSource.textureData;
        ...
        class WebGlCoreCtxRenderTexture extends WebGlCoreCtxTexture {
          ...
          onLoadRequest() {
            ...
            return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee16() {
              var glw, nativeTexture, _this15$textureSource, width, height;
              return _regeneratorRuntime().wrap(function _callee16$(_context16) {
                while (1) switch (_context16.prev = _context16.next) {
                  case 0:
                    glw = _this15.glw;
                    nativeTexture = _this15._nativeCtxTexture = _this15.createNativeCtxTexture();
                    _this15$textureSource = _this15.textureSource, width = _this15$textureSource.width, height = _this15$textureSource.height; // Set the dimensions of the render texture
                    glw.texImage2D(0, glw.RGBA, width, height, 0, glw.RGBA, glw.UNSIGNED_BYTE, null);
                    // Update the texture memory manager
                    _this15.setTextureMemUse(width * height * 4);
                    // Bind the framebuffer
                    glw.bindFramebuffer(_this15.framebuffer);
        ...
        class WebGlCoreRenderer extends CoreRenderer {
          ...
          findMaxChildRTTIndex(node) {
            ...
            var traverseChildren = currentNode => {
              ...
              var _iterator11 = _createForOfIteratorHelper(currentNode.children),
                _step11;
              try {
        ...
        class SdfFontShaper extends FontShaper {
          ...
          shapeText(props, codepoints) {
            ...
            return /*#__PURE__*/_regeneratorRuntime().mark(function _callee17() {
              var codepointResult, lastGlyphId, codepoint, glyph, _this16$kernings$glyp, kerning;
              return _regeneratorRuntime().wrap(function _callee17$(_context17) {
                while (1) switch (_context17.prev = _context17.next) {
                  ...
                  case 1:
                    ...
                    glyph = _this16.glyphMap.get(codepoint);
                    codepoints.next();
                    if (!(glyph !== undefined)) {
                      _context17.next = 12;
                      break;
                     ...
                     */
                    kerning = lastGlyphId !== undefined ? (((_this16$kernings$glyp = _this16.kernings[glyph.id]) === null || _this16$kernings$glyp === void 0 ? void 0 : _this16$kernings$glyp[lastGlyphId]) || 0) + props.letterSpacing : 0;
          ...
          constructor(type, options) {
            ...
            fetch(atlasDataUrl).then(/*#__PURE__*/function () {
              var _ref25 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee18(response) {
                var maxCharHeight, _this17$data, _this17$data$lightnin, ascender, descender, lineGap, unitsPerEm;
                return _regeneratorRuntime().wrap(function _callee18$(_context18) {
                  while (1) switch (_context18.prev = _context18.next) {
                    ...
                    case 2:
                      _this17.data = _context18.sent;
                      assertTruthy(_this17.data);
                      // Add all the glyphs to the glyph map
                      maxCharHeight = 0;
                      _this17.data.chars.forEach(glyph => {
                        _this17.glyphMap.set(glyph.id, glyph);
                        var charHeight = glyph.yoffset + glyph.height;
                        if (charHeight > maxCharHeight) {
                          maxCharHeight = charHeight;
                        }
                      });
                      _this17.maxCharHeight = maxCharHeight;
                      // We know `data` is defined here, because we just set it
                      _this17.shaper = new SdfFontShaper(_this17.data, _this17.glyphMap);
                      ...
                      if (!((_this17$data = _this17.data) !== null && _this17$data !== void 0 && _this17$data.lightningMetrics)) {
                        _context18.next = 14;
                        break;
                      }
                      _this17$data$lightnin = _this17.data.lightningMetrics, ascender = _this17$data$lightnin.ascender, descender = _this17$data$lightnin.descender, lineGap = _this17$data$lightnin.lineGap, unitsPerEm = _this17$data$lightnin.unitsPerEm;
                      _this17.metrics = {
                      ...
                      break;
                    case 14:
                      throw new Error(`Font metrics not found in ${_this17.type} font ${_this17.fontFamily}. ` + 'Make sure you are using the latest version of the Lightning ' + '3 `msdf-generator` tool to generate your SDF fonts.');
                    case 15:
                      _this17.checkLoaded();
                    case 16:
                    case "end":
        ...
        function loadFonts(fonts) {
          ...
          var _iterator12 = _createForOfIteratorHelper(fonts),
            _step12;
          try {
            for (_iterator12.s(); !(_step12 = _iterator12.n()).done;) {
              var font = _step12.value;
              if ('type' in font && (font.type === 'msdf' || font.type === 'ssdf')) {
                if (renderer$1.stage.renderer.mode === 'webgl') {
        ...
        var isFunction = exports("j", obj => typeof obj === 'function');
        ...
        class States extends Array {
          constructor(callback) {
            ...
            if (isArray(initialState)) {
              ...
              super(...Object.entries(initialState).filter(_ref26 => {
    ...
    `;
        ...
        var handleKeyEvents = (delay, keydown, keyup) => {
          if (keydown) {
            var _key18 = keydown.key || keydown.keyCode;
            ...
            if (mappedKeyHoldEvent) {
              if (!keyHoldTimeouts[_key18]) {
                keyHoldTimeouts[_key18] = window.setTimeout(() => {
                  keyHoldTimeouts[_key18] = true;
            ...
            if (keyHoldTimeouts[_key19] === true) {
              delete keyHoldTimeouts[_key19];
            } else if (keyHoldTimeouts[_key19]) {
        ...
        var useFocusManager$1 = function useFocusManager$1() {
          var _ref30 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
            ...
            ownerContext = _ref30$ownerContext === void 0 ? cb => {
              cb();
            } : _ref30$ownerContext;
          if (userKeyMap) {
        ...
        function convertEffectsToShader(node, styleEffects) {
          ...
          for (var type in styleEffects) {
            ...
            effects.push(renderer$1.createEffect(type, styleEffects[type], type));
          }
        ...
        class ElementNode extends Object {
          ...
          set shader(shaderProps) {
            ...
            if (isArray(shaderProps)) {
              shProps = renderer$1.createShader(...shaderProps);
            }
            ...
            if (this.transition && this.rendered && Config.animationsEnabled && (this.transition === true || this.transition[name])) {
              ...
              if (this.onAnimation) {
                ...
                var _loop8 = function _loop8() {
                  ...
                  var handler = _this18.onAnimation[event];
                  animationController.on(event, (controller, props) => {
                    handler.call(_this18, controller, name, value, props);
                  });
                };
            ...
            return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee19() {
              ...
              return _regeneratorRuntime().wrap(function _callee19$(_context19) {
                while (1) switch (_context19.prev = _context19.next) {
                  case 0:
                    animation = _this19._animationQueue.shift();
                  case 1:
                    if (!animation) {
                      _context19.next = 8;
                      break;
                    }
                    _this19._animationRunning = true;
                    _context19.next = 5;
                    return _this19.animate(animation.props, animation.animationSettings).start().waitUntilStopped();
                  case 5:
                    animation = _this19._animationQueue.shift();
                    _context19.next = 1;
                    break;
                  case 8:
                    _this19._animationRunning = false;
                    _this19._animationQueueSettings = undefined;
                  case 10:
                  case "end":
        ...
        function createResource(pSource, pFetcher, pOptions) {
          ...
          function completeLoad(v, err) {
            runUpdates(() => {
              ...
              setError(err);
              var _iterator14 = _createForOfIteratorHelper(contexts.keys()),
                _step14;
              try {
        ...
        function createSelector(source) {
          ...
          var node = createComputation(p => {
            var v = source();
            var _iterator15 = _createForOfIteratorHelper(subs.entries()),
              _step15;
            try {
              for (_iterator15.s(); !(_step15 = _iterator15.n()).done;) {
                var _step15$value = _slicedToArray(_step15.value, 2),
                  _key22 = _step15$value[0],
                  val = _step15$value[1];
                if (fn(_key22, v) !== fn(_key22, p)) {
                  var _iterator16 = _createForOfIteratorHelper(val.values()),
                    _step16;
                  try {
        ...
        function mergeProps$1() {
          for (var _len = arguments.length, sources = new Array(_len), _key23 = 0; _key23 < _len; _key23++) {
          ...
          for (var _i21 = definedKeys.length - 1; _i21 >= 0; _i21--) {
            var _key24 = definedKeys[_i21],
              desc = defined[_key24];
            if (desc && desc.get) Object.defineProperty(target, _key24, desc);else target[_key24] = desc ? desc.value : undefined;
          }
          return target;
        }
        function splitProps(props) {
          for (var _len2 = arguments.length, keys = new Array(_len2 > 1 ? _len2 - 1 : 0), _key25 = 1; _key25 < _len2; _key25++) {
            keys[_key25 - 1] = arguments[_key25];
          }
          ...
          var _iterator17 = _createForOfIteratorHelper(Object.getOwnPropertyNames(props)),
            _step17;
          try {
            for (_iterator17.s(); !(_step17 = _iterator17.n()).done;) {
              var propName = _step17.value;
        ...
        function createRenderer$1(_ref33) {
          var createElement = _ref33.createElement,
            createTextNode = _ref33.createTextNode,
            isTextNode = _ref33.isTextNode,
            replaceText = _ref33.replaceText,
            insertNode = _ref33.insertNode,
            removeNode = _ref33.removeNode,
            setProperty = _ref33.setProperty,
            getParentNode = _ref33.getParentNode,
            getFirstChild = _ref33.getFirstChild,
            getNextSibling = _ref33.getNextSibling;
        ...
        class CanvasCoreTexture extends CoreContextTexture {
          ...
          onLoadRequest() {
            ...
            return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee21() {
              var _this20$textureSource;
              var data, canvas, ctx;
              return _regeneratorRuntime().wrap(function _callee21$(_context21) {
                while (1) switch (_context21.prev = _context21.next) {
                  case 0:
                    assertTruthy((_this20$textureSource = _this20.textureSource) === null || _this20$textureSource === void 0 || (_this20$textureSource = _this20$textureSource.textureData) === null || _this20$textureSource === void 0 ? void 0 : _this20$textureSource.data);
                    data = _this20.textureSource.textureData.data; // TODO: canvas from text renderer should be able to provide the canvas directly
        ...
        function getRadius(quad) {
          if (quad.shader instanceof UnsupportedShader) {
            ...
            if (shType === ROUNDED_RECTANGLE_SHADER_TYPE) {
              ...
              if (effects) {
                var _effect4 = effects.find(effect => {
                  var _effect$props;
          ...
          if (quad.shader instanceof UnsupportedShader) {
            ...
            if (shType === 'DynamicShader') {
              ...
              if (effects && effects.length) {
                var _effect5 = effects.find(effect => {
                  return effect.type === `border${direction}` && effect.props && effect.props.width;
                });
        ...
        function roundRect(x, y, width, height, radius) {
          ...
          if (!context.roundRect) {
            var fixOverlappingCorners = radii => {
        ...
        class CanvasCoreRenderer extends CoreRenderer {
          ...
          addQuad(quad) {
            ...
            var frame;
            var textureType = (_texture = texture) === null || _texture === void 0 ? void 0 : _texture.type;
        ...
        function createBeforeLeave() {
          ...
          function confirm(to, options) {
            ...
            var _iterator20 = _createForOfIteratorHelper(listeners),
              _step20;
            try {
        ...
        function createMatcher(path, partial, matchFilters) {
          ...
          return location => {
            ...
            for (var i = 0; i < len; i++) {
              ...
              var _key26 = dynamic ? segment.slice(1) : segment.toLowerCase();
              if (dynamic && matchSegment(locSegment, matchFilter(_key26))) {
                match.params[_key26] = locSegment;
              } else if (dynamic || !matchSegment(locSegment, _key26)) {
                return null;
              }
        ...
        var useMatch = (path, matchFilters) => {
          ...
          return createMemo(() => {
            var _iterator21 = _createForOfIteratorHelper(matchers()),
              _step21;
            try {
              for (_iterator21.s(); !(_step21 = _iterator21.n()).done;) {
                var matcher = _step21.value;
         ...
         * ```
         */
        var useParams = exports("N", () => useRouter().params);
        function createRoutes(routeDef) {
          ...
          return asArray(routeDef.path).reduce((acc, originalPath) => {
            var _iterator22 = _createForOfIteratorHelper(expandOptionals(originalPath)),
              _step22;
            try {
              for (_iterator22.s(); !(_step22 = _iterator22.n()).done;) {
                var expandedPath = _step22.value;
        ...
        function createBranches(routeDef) {
          ...
          for (var i = 0, len = routeDefs.length; i < len; i++) {
            ...
            if (def && _typeof(def) === "object") {
              ...
              var _iterator23 = _createForOfIteratorHelper(routes),
                _step23;
              try {
                for (_iterator23.s(); !(_step23 = _iterator23.n()).done;) {
                  var route = _step23.value;
                  stack.push(route);
        ...
        function intercept(_ref35, get, set) {
        ...
        function speakSeries(series, lang) {
          ...
          var utterances = [];
          var active = true;
          var seriesChain = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee22() {
            ...
            return _regeneratorRuntime().wrap(function _callee22$(_context22) {
              while (1) switch (_context22.prev = _context22.next) {
                ...
                case 26:
                  ...
                  if (!(_context22.t0 instanceof SpeechSynthesisErrorEvent)) {
                    _context22.next = 43;
                    break;
                  }
                  if (!(_context22.t0.error === "network")) {
                    _context22.next = 36;
                    break;
                  }
                  retriesLeft--;
                ...
                case 34:
                  ...
                  break;
                case 36:
                  if (!(_context22.t0.error === "canceled" || _context22.t0.error === "interrupted")) {
                    _context22.next = 40;
                    break;
                  }
                  retriesLeft = 0;
                  ...
                  break;
                case 40:
                  throw new Error(`SpeechSynthesisErrorEvent: ${_context22.t0.error}`);
                case 41:
                  _context22.next = 44;
                  break;
                case 43:
        ...
        // src/index.ts
        var debounce = exports("k", (callback, wait) => {
          var timeoutId;
          var clear = () => clearTimeout(timeoutId);
          if (getOwner()) onCleanup(clear);
          var debounced = function debounced() {
            for (var _len3 = arguments.length, args = new Array(_len3), _key27 = 0; _key27 < _len3; _key27++) {
        ...
        function LazyUp(props) {
          ...
          var isRow = createMemo(() => {
            var _others$style;
            return others.direction === "row" || ((_others$style = others.style) === null || _others$style === void 0 ? void 0 : _others$style.flexDirection) === "row" || others.flexDirection === "row";
          });
        ...
        function withScrolling(isRow) {
          ...
          return (selected, component, selectedElement, lastSelected) => {
            var _componentRef$_target, _componentRef$offset2, _selectedElement$axis, _selectedElement$dime, _ref41, _selectedElement$scal, _selectedElement$styl, _componentRef$dimensi;
            ...
            var selectedScale = (_ref41 = (_selectedElement$scal = selectedElement.scale) !== null && _selectedElement$scal !== void 0 ? _selectedElement$scal : (_selectedElement$styl = selectedElement.style) === null || _selectedElement$styl === void 0 || (_selectedElement$styl = _selectedElement$styl.focus) === null || _selectedElement$styl === void 0 ? void 0 : _selectedElement$styl.scale) !== null && _ref41 !== void 0 ? _ref41 : 1;
        ...
        function chainFunctions() {
          for (var _len4 = arguments.length, args = new Array(_len4), _key28 = 0; _key28 < _len4; _key28++) {
          ...
          return function () {
            var result;
            for (var _len5 = arguments.length, innerArgs = new Array(_len5), _key29 = 0; _key29 < _len5; _key29++) {
        ...
        var Column = exports("C", props => {
          return createComponent(View, mergeProps(props, {
            ...
            onFocus: chainFunctions(props.onFocus, props.onSelectedChanged && handleOnSelect(props.onSelectedChanged)),
        ...
        function makeComponentStyles(_ref42) {
          var themeKeys = _ref42.themeKeys,
            base = _ref42.base,
            themeStyles = _ref42.themeStyles,
            _ref42$modes = _ref42.modes,
            modes = _ref42$modes === void 0 ? {} : _ref42$modes,
            _ref42$tones = _ref42.tones,
            tones = _ref42$tones === void 0 ? {} : _ref42$tones,
            _ref42$modeKeys = _ref42.modeKeys,
            modeKeys = _ref42$modeKeys === void 0 ? defaultModeKeys : _ref42$modeKeys,
            _ref42$toneKeys = _ref42.toneKeys,
            toneKeys = _ref42$toneKeys === void 0 ? defaultToneKeys : _ref42$toneKeys;
           ...
           */
          var mapThemeKeysToSolid = stylesToMap => objectFromEntries(Object.entries(themeKeys).filter(_ref43 => {
          ...
          var convertComponentConfig = themeStyles => {
            ...
            Object.entries(themeStyles).map(_ref47 => {
              var _ref48 = _slicedToArray(_ref47, 2),
                variantName = _ref48[0],
                styles = _ref48[1];
              ...
              Object.entries(styles).filter(_ref49 => {
        ...
        var ContentBlock = exports("n", props => createComponent(View, mergeProps({
          id: "contentBlock",
        ...
        var Destroy = props => {
          ...
          createEffect(on([props.data.heroRow.items, heroIndex], _ref53 => {
        ...
        var handleResults = response => {
          return response.then(_ref55 => {
            var results = _ref55.results;
        ...
        var fetchGenreMovies = genres => {
          ...
          return genreList.then(_ref56 => {
            var genres2 = _ref56.genres;
            var targetGenreIds = [];
        ...
        function browsePreload(_ref57) {
          var params = _ref57.params;
          return createMemo(() => {
        ...
        function getRecommendations(_ref58) {
          var type = _ref58.type,
            id = _ref58.id;
          return api.get(`/${type}/${id}/recommendations`).then(_ref59 => {
            var results = _ref59.results;
            if (results.length) {
              return ensureItems(convertItemsToTiles(results.slice(0, 7)), 7);
            }
            return api.get(`/trending/${type}/week?page=1`).then(_ref60 => {
        ...
        function getCredits(_ref61) {
          var type = _ref61.type,
            id = _ref61.id;
          return api.get(`/${type}/${id}/credits`).then(_ref62 => {
        ...
        function entityPreload(_ref64) {
          var params = _ref64.params,
            intent = _ref64.intent;
        ...
        var Grid = lazy(() => __vitePreload(() => module.import('./Grid-legacy-uzlXUc1I.js'), false ? __VITE_PRELOAD__ : undefined));
        var TMDBGrid = lazy(() => __vitePreload(() => module.import('./TMDBGrid-legacy-PDWqJqWk.js'), false ? __VITE_PRELOAD__ : undefined));
        var Portal = lazy(() => __vitePreload(() => module.import('./Portal-legacy-Dwb5no4I.js'), false ? __VITE_PRELOAD__ : undefined));
        var TextPage = lazy(() => __vitePreload(() => module.import('./Text-legacy-8WfcE44D.js'), false ? __VITE_PRELOAD__ : undefined));
        var TextPosterPage = lazy(() => __vitePreload(() => module.import('./TextPoster-legacy-C6ctnTEJ.js'), false ? __VITE_PRELOAD__ : undefined));
        var CreatePage = lazy(() => __vitePreload(() => module.import('./Create-legacy-JBzoz0lr.js'), false ? __VITE_PRELOAD__ : undefined));
        var ViewportPage = lazy(() => __vitePreload(() => module.import('./Viewport-legacy-jgQrFgjA.js'), false ? __VITE_PRELOAD__ : undefined));
        var PositioningPage = lazy(() => __vitePreload(() => module.import('./Positioning-legacy-CN4mbHQr.js'), false ? __VITE_PRELOAD__ : undefined));
        var LayoutPage = lazy(() => __vitePreload(() => module.import('./Layout-legacy-DRYmmHrv.js'), false ? __VITE_PRELOAD__ : undefined));
        var FocusBasicsPage = lazy(() => __vitePreload(() => module.import('./FocusBasics-legacy-DUW7Mwb1.js'), false ? __VITE_PRELOAD__ : undefined));
        var KeyHandlingPage = lazy(() => __vitePreload(() => module.import('./KeyHandling-legacy-yijjVesX.js'), false ? __VITE_PRELOAD__ : undefined));
        var TransitionsPage = lazy(() => __vitePreload(() => module.import('./Transitions-legacy-BQ2Ag880.js'), false ? __VITE_PRELOAD__ : undefined));
        var ComponentsPage = lazy(() => __vitePreload(() => module.import('./Components-legacy-Csz6sRY8.js'), false ? __VITE_PRELOAD__ : undefined));
        var FocusHandlingPage = lazy(() => __vitePreload(() => module.import('./FocusHandling-legacy-CcTZ21a0.js'), false ? __VITE_PRELOAD__ : undefined));
        var GradientsPage = lazy(() => __vitePreload(() => module.import('./Gradients-legacy-6-W6CMIe.js'), false ? __VITE_PRELOAD__ : undefined));
        var FlexPage = lazy(() => __vitePreload(() => module.import('./Flex-legacy-Dyrc2TQo.js'), false ? __VITE_PRELOAD__ : undefined));
        var FlexSizePage = lazy(() => __vitePreload(() => module.import('./FlexSize-legacy-Sue-Ifs6.js'), false ? __VITE_PRELOAD__ : undefined));
        var FlexColumnSizePage = lazy(() => __vitePreload(() => module.import('./FlexColumnSize-legacy-CDrl0RN4.js'), false ? __VITE_PRELOAD__ : undefined));
        var FlexColumnPage = lazy(() => __vitePreload(() => module.import('./FlexColumn-legacy-DCSAdd4x.js'), false ? __VITE_PRELOAD__ : undefined));
        var ButtonsMaterialPage = lazy(() => __vitePreload(() => module.import('./ButtonsMaterial-legacy-CBhE31-q.js'), false ? __VITE_PRELOAD__ : undefined));
        var SuperFlexPage = lazy(() => __vitePreload(() => module.import('./SuperFlex-legacy-F_cLJNHe.js'), false ? __VITE_PRELOAD__ : undefined));
        var Entity = lazy(() => __vitePreload(() => module.import('./Entity-legacy-BigRfmui.js'), false ? __VITE_PRELOAD__ : undefined));
        var People = lazy(() => __vitePreload(() => module.import('./People-legacy-CJjSUHwA.js'), false ? __VITE_PRELOAD__ : undefined));
        var LoginPage = lazy(() => __vitePreload(() => module.import('./Login-legacy-Df4OZ2J1.js'), false ? __VITE_PRELOAD__ : undefined));
        var FireboltPage = lazy(() => __vitePreload(() => module.import('./Firebolt-legacy-BgTqZ6jO.js'), false ? __VITE_PRELOAD__ : undefined));
