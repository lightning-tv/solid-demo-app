...
var call$x = Function.prototype.call;

var functionCall = NATIVE_BIND$3 ? call$x.bind(call$x) : function () {
  return call$x.apply(call$x, arguments);
};
...
var call$w = FunctionPrototype$2.call;
var uncurryThisWithBind = NATIVE_BIND$2 && FunctionPrototype$2.bind.bind(call$w, call$w);
...
var toString$e = uncurryThis$I({}.toString);
...
var ordinaryToPrimitive$1 = function (input, pref) {
  var fn, val;
  if (pref === 'string' && isCallable$p(fn = input.toString) && !isObject$i(val = call$v(fn, input))) return val;
  if (isCallable$p(fn = input.valueOf) && !isObject$i(val = call$v(fn, input))) return val;
  if (pref !== 'string' && isCallable$p(fn = input.toString) && !isObject$i(val = call$v(fn, input))) return val;
...
var toString$d = uncurryThis$E(1.0.toString);
...
objectGetOwnPropertyDescriptor.f = DESCRIPTORS$s ? $getOwnPropertyDescriptor$1 : function getOwnPropertyDescriptor(O, P) {
  ...
  if (hasOwn$j(O, P)) return createPropertyDescriptor$6(!call$t(propertyIsEnumerableModule$1.f, O, P), O[P]);
};
...
if (DESCRIPTORS$m && isCallable$i(NativeSymbol) && (!('description' in SymbolPrototype) ||
  ...
  var thisSymbolValue = uncurryThis$z(SymbolPrototype.valueOf);
  var symbolDescriptiveString = uncurryThis$z(SymbolPrototype.toString);
  var regexp = /^Symbol\((.*)\)[^)]+$/;
...
var functionApply = typeof Reflect == 'object' && Reflect.apply || (NATIVE_BIND$1 ? call$s.bind(apply$4) : function () {
  return call$s.apply(apply$4, arguments);
});
...
var functionUncurryThisAccessor = function (object, key, method) {
  try {
    // eslint-disable-next-line es/no-object-getownpropertydescriptor -- safe
    return uncurryThis$y(aCallable$k(Object.getOwnPropertyDescriptor(object, key)[method]));
  } catch (error) { /* empty */ }
};
...
var bind$b = uncurryThis$v(uncurryThis$v.bind);
...
var arraySlice$5 = uncurryThis$s([].slice);
...
var push$9 = uncurryThis$r(test.push);
...
if (!NATIVE_ARRAY_BUFFER$1) {
  ...
  var $setInt8 = uncurryThis$q(DataViewPrototype$2.setInt8);
...
var nativeArrayBufferSlice = uncurryThis$p(ArrayBuffer$6.prototype.slice);
var getUint8 = uncurryThis$p(DataViewPrototype$1.getUint8);
var setUint8 = uncurryThis$p(DataViewPrototype$1.setUint8);
...
var slice$4 = ArrayBufferPrototype$3 && uncurryThis$o(ArrayBufferPrototype$3.slice);
...
var slice$3 = uncurryThis$n(ArrayBufferPrototype$1.slice);
...
var getInt8 = uncurryThis$n(DataViewPrototype.getInt8);
var setInt8 = uncurryThis$n(DataViewPrototype.setInt8);
...
var stringifyWithSymbolsFix = function (it, replacer) {
  ...
  args[1] = function (key, value) {
    ...
    if (isCallable$b($replacer)) value = call$q($replacer, this, $String(key), value);
...
var onUnhandled = function (state) {
  call$p(task, globalThis$h, function () {
...
var getIterator$4 = function (argument, usingIterator) {
  ...
  if (aCallable$e(iteratorMethod)) return anObject$i(call$o(iteratorMethod, argument));
...
$$v({ target: 'Promise', stat: true, forced: PROMISE_STATICS_INCORRECT_ITERATION$2 }, {
...
var exec$6 = uncurryThis$k(RegExpPrototype$2.exec);
...
// `Set.prototype.difference` method
// https://github.com/tc39/proposal-set-methods
$$n({ target: 'Set', proto: true, real: true, forced: !setMethodAcceptSetLike$6('difference') }, {
...
// `Set.prototype.isDisjointFrom` method
// https://github.com/tc39/proposal-set-methods
$$l({ target: 'Set', proto: true, real: true, forced: !setMethodAcceptSetLike$4('isDisjointFrom') }, {
...
// `Set.prototype.isSubsetOf` method
// https://github.com/tc39/proposal-set-methods
$$k({ target: 'Set', proto: true, real: true, forced: !setMethodAcceptSetLike$3('isSubsetOf') }, {
...
// `Set.prototype.isSupersetOf` method
// https://github.com/tc39/proposal-set-methods
$$j({ target: 'Set', proto: true, real: true, forced: !setMethodAcceptSetLike$2('isSupersetOf') }, {
...
if (DESCRIPTORS$b && !hasOwn$6(TypedArrayPrototype$1, TO_STRING_TAG$2)) {
...
var createProperty$3 = function (object, key, value) {
  if (DESCRIPTORS$9) definePropertyModule.f(object, key, createPropertyDescriptor$1(0, value));
