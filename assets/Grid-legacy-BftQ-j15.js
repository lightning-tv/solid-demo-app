...
(function () {
  ...
  System.register(['./index-legacy-ZXlqAq7D.js'], function (exports, module) {
    'use strict';

    var createSignal, createResource, createComputed, batch, theme, createSelector, createEffect, on, onMount, setGlobalBackground, createComponent, View, Column, Index, Text;
    return {
      setters: [function (module) {
        createSignal = module.a;
        createResource = module.b;
        createComputed = module.d;
        batch = module.e;
        theme = module.t;
      ...
      execute: function execute() {
        ...
        var Grid = exports("default", function () {
          ...
          var _createSignal9 = createSignal(0),
            ...
            rowIndex = _createSignal0[0],
            setRowIndex = _createSignal0[1];
          var _createSignal1 = createSignal([]),
            _createSignal10 = _slicedToArray(_createSignal1, 2),
            items = _createSignal10[0],
            setItems = _createSignal10[1];
