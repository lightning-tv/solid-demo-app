...
(function () {
  ...
  System.register(['./index-legacy-DXNjOu-Z.js', './Button-legacy-DVUSxgL5.js'], function (exports, module) {
    'use strict';

    var createSignal, useNavigate, createEffect, on, setGlobalBackground, createComponent, Show, View, ContentBlock, Row, Column, styles, memo, Text, TileRow, assertTruthy, closeVideo, playVideo, setActiveElement, Button;
    return {
