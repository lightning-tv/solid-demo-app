...
(function () {
  ...
  System.register(['./index-legacy-CGpI0N65.js'], function (exports, module) {
    ...
    var api, getImageUrl, convertItemsToTiles, useParams, useNavigate, createResource, onMount, setGlobalBackground, createComponent, Show, View, Text, theme, styles, Column, TileRow, assertTruthy;
    return {
      setters: [function (module) {
        api = module.W;
        getImageUrl = module.X;
        convertItemsToTiles = module.Y;
        useParams = module.Z;
