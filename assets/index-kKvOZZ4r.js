const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Components-4-KEFkKB.js","assets/Button-CijL_nhT.js","assets/Login-DlJu5q__.js"])))=>i.map(i=>d[i]);
...
class Texture extends EventEmitter {
  constructor(txManager) {
    ...
    __publicField(this, "sourceState", "initial");
    // texture (gpu) state
    __publicField(this, "coreCtxState", "initial");
  ...
  updateState() {
    ...
    } else if (sourceState === "loaded" && ctxState === "freed" || ctxState === "loaded" && sourceState === "freed") {
      newState = "loading";
    } else {
      newState = "freed";
    }
...
const _ImageTexture = class _ImageTexture extends Texture {
  ...
  async loadImage(src) {
    ...
    if (this.txManager.hasCreateImageBitmap === true) {
      if (this.txManager.hasWorker === true && this.txManager.imageWorkerManager !== null) {
...
const _SubTexture = class _SubTexture extends Texture {
  constructor(txManager, props) {
    ...
    __publicField(this, "onParentTxLoaded", () => {
      ...
      if (this.parentTexture.ctxTexture !== void 0) {
...
class CoreTextureManager extends EventEmitter {
  constructor(numImageWorkers2) {
    ...
    this.validateCreateImageBitmap().then((result) => {
      ...
      if (this.hasCreateImageBitmap && this.hasWorker && numImageWorkers2 > 0) {
        this.imageWorkerManager = new ImageWorkerManager(numImageWorkers2, result);
      } else {
  ...
  processSome(maxItems = 0) {
    ...
    while (this.priorityQueue.length > 0 && (maxItems === 0 || itemsProcessed < maxItems)) {
    ...
    while (this.uploadTextureQueue.length > 0 && (maxItems === 0 || itemsProcessed < maxItems)) {
      this.uploadTexture(this.uploadTextureQueue.shift());
      itemsProcessed++;
    }
    while (this.downloadTextureSourceQueue.length > 0 && (maxItems === 0 || itemsProcessed < maxItems)) {
...
class Stage {
  ...
  resolveNodeDefaults(props) {
    ...
    return {
      ...
      strictBounds: (_Y = props.strictBounds) != null ? _Y : this.strictBounds
    };
  }
}
class RendererMain extends EventEmitter {
  ...
  constructor(settings, target) {
    ...
    const resolvedSettings = {
      ...
      strictBounds: (_j = settings.strictBounds) != null ? _j : true,
...
const propagateKeyPress = (e, mappedEvent, isHold, propagatedUpKeys = []) => {
  ...
  if (mappedEvent) {
    for (const elm of focusPath$1) {
      ...
      const keyEvent = elm["on".concat(mappedEvent)];
      const keyUpEvent = elm["on".concat(mappedEvent, "Up")];
      const keyDownEvent = elm["on".concat(mappedEvent, "Down")];
    ...
    console.log("Unhandled ".concat(e.type, " for key event: ").concat(e.key || e.keyCode));
  }
  return false;
};
...
const handleKeyEvents = (delay2, propagatedUpKeys, keydown, keyup) => {
  if (keydown) {
    ...
    if (mappedKeyHoldEvent) {
      if (!keyHoldTimeouts[key2]) {
        keyHoldTimeouts[key2] = window.setTimeout(() => keyHoldCallback(keydown, mappedKeyHoldEvent), delay2);
      }
    }
...
const useFocusManager$1 = ({ userKeyMap, propagatedUpKeys = [], keyHoldOptions, ownerContext = (cb) => {
  cb();
} } = {}) => {
  if (userKeyMap) {
  ...
  const runKeyEvent = handleKeyEvents.bind(null, delay2, propagatedUpKeys);
...
class CanvasCoreRenderer extends CoreRenderer {
  ...
  addQuad(quad) {
    ...
    if (textureType !== TextureType.image && textureType !== TextureType.color) {
      return;
    }
    if (texture) {
...
const useFocusManager = (userKeyMap, keyHoldOptions, propagatedUpKeys) => {
  const owner = getOwner();
...
const Grid = lazy(() => __vitePreload(() => import("./Grid-CWdq34Jn.js"), true ? [] : void 0));
const Portal = lazy(() => __vitePreload(() => import("./Portal-BQpkdRzK.js"), true ? [] : void 0));
const TextPage = lazy(() => __vitePreload(() => import("./Text-7rXC6SaE.js"), true ? [] : void 0));
const TextPosterPage = lazy(() => __vitePreload(() => import("./TextPoster-CB09LGzx.js"), true ? [] : void 0));
const CreatePage = lazy(() => __vitePreload(() => import("./Create-CRFZd0de.js"), true ? [] : void 0));
const ViewportPage = lazy(() => __vitePreload(() => import("./Viewport-CZBMbl5u.js"), true ? [] : void 0));
const PositioningPage = lazy(() => __vitePreload(() => import("./Positioning-D8HKx3kg.js"), true ? [] : void 0));
const LayoutPage = lazy(() => __vitePreload(() => import("./Layout-BYdWjttF.js"), true ? [] : void 0));
const FocusBasicsPage = lazy(() => __vitePreload(() => import("./FocusBasics-BLQ2VSgQ.js"), true ? [] : void 0));
const TransitionsPage = lazy(() => __vitePreload(() => import("./Transitions-CtzAiOcC.js"), true ? [] : void 0));
const ComponentsPage = lazy(() => __vitePreload(() => import("./Components-4-KEFkKB.js"), true ? __vite__mapDeps([0,1]) : void 0));
const FocusHandlingPage = lazy(() => __vitePreload(() => import("./FocusHandling-zN0-sk_Q.js"), true ? [] : void 0));
const GradientsPage = lazy(() => __vitePreload(() => import("./Gradients-2kGWav5C.js"), true ? [] : void 0));
const FlexPage = lazy(() => __vitePreload(() => import("./Flex-SKVfdKJ6.js"), true ? [] : void 0));
const FlexSizePage = lazy(() => __vitePreload(() => import("./FlexSize-j8Ud0iu2.js"), true ? [] : void 0));
const FlexColumnSizePage = lazy(() => __vitePreload(() => import("./FlexColumnSize-Cx_Zqey4.js"), true ? [] : void 0));
const FlexColumnPage = lazy(() => __vitePreload(() => import("./FlexColumn-I9LK4q1W.js"), true ? [] : void 0));
const ButtonsMaterialPage = lazy(() => __vitePreload(() => import("./ButtonsMaterial-CHVOz8RJ.js"), true ? [] : void 0));
const SuperFlexPage = lazy(() => __vitePreload(() => import("./SuperFlex-B6eFh1vf.js"), true ? [] : void 0));
const Entity = lazy(() => __vitePreload(() => import("./Entity-TCTcWkWN.js"), true ? [] : void 0));
const People = lazy(() => __vitePreload(() => import("./People-BmomXZKA.js"), true ? [] : void 0));
const LoginPage = lazy(() => __vitePreload(() => import("./Login-DlJu5q__.js"), true ? __vite__mapDeps([2,1]) : void 0));
const FireboltPage = lazy(() => __vitePreload(() => import("./Firebolt-DfU0GlUg.js"), true ? [] : void 0));
