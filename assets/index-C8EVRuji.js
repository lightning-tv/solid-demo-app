const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Buttons-CU8ERTOF.js","assets/Button-CQWFBMJ4.js","assets/Components-BaBfF7fL.js","assets/Entity-CSR5X2iP.js","assets/Login-x_H3joWj.js"])))=>i.map(i=>d[i]);
...
function withScrolling(isRow) {
  ...
  return (selected, componentRef, selectedElement, lastSelected) => {
    ...
    if (screenOffset === void 0) {
      screenOffset = (_a2 = componentRef.offset) != null ? _a2 : (isRow ? lng.absX : lng.absY) - componentRef[axis];
    }
    ...
    const maxOffset = Math.min(screenSize2 - containerSize - screenOffset - 2 * gap, 0);
    ...
    if (selectedElement.centerScroll) {
      ...
      nextPosition = -selectedPosition + (screenSize2 - selectedSizeScaled) / 2 - screenOffset;
    } else if (!nextElement) {
      nextPosition = isIncrementing ? maxOffset : offset;
    } else if (scroll2 === "auto") {
      if (isIncrementing && componentRef.scrollIndex > 0 && componentRef.selected >= componentRef.scrollIndex) {
...
const Column = (props) => {
  return createComponent(View, mergeProps(props, {
    ...
    get style() {
      var _a2;
      return combineStyles(props.style, styles$6.Container.tones[(_a2 = props.tone) != null ? _a2 : styles$6.tone], styles$6.Container.base);
    }
  }));
};
...
const Row = (props) => {
  return createComponent(View, mergeProps(props, {
    ...
    get style() {
      var _a2;
      return combineStyles(props.style, styles$3.Container.tones[(_a2 = props.tone) != null ? _a2 : styles$3.tone], styles$3.Container.base);
    }
  }));
};
...
const Grid = lazy(() => __vitePreload(() => import("./Grid-CpeJsZ5p.js"), true ? [] : void 0));
const Portal = lazy(() => __vitePreload(() => import("./Portal-Dnd3Quxv.js"), true ? [] : void 0));
const TextPage = lazy(() => __vitePreload(() => import("./Text-C4Os7_tb.js"), true ? [] : void 0));
const CreatePage = lazy(() => __vitePreload(() => import("./Create-b_wRCWzR.js"), true ? [] : void 0));
const ViewportPage = lazy(() => __vitePreload(() => import("./Viewport-ydDWcROj.js"), true ? [] : void 0));
const ButtonsPage = lazy(() => __vitePreload(() => import("./Buttons-CU8ERTOF.js"), true ? __vite__mapDeps([0,1]) : void 0));
const PositioningPage = lazy(() => __vitePreload(() => import("./Positioning-Bsx-4N__.js"), true ? [] : void 0));
const TransitionsPage = lazy(() => __vitePreload(() => import("./Transitions-bbJkycbr.js"), true ? [] : void 0));
const ComponentsPage = lazy(() => __vitePreload(() => import("./Components-BaBfF7fL.js"), true ? __vite__mapDeps([2,1]) : void 0));
const FocusHandlingPage = lazy(() => __vitePreload(() => import("./FocusHandling-dKDXLwml.js"), true ? [] : void 0));
const GradientsPage = lazy(() => __vitePreload(() => import("./Gradients-DpMlqBdi.js"), true ? [] : void 0));
const FlexPage = lazy(() => __vitePreload(() => import("./Flex-B_Aj8kfy.js"), true ? [] : void 0));
const FlexSizePage = lazy(() => __vitePreload(() => import("./FlexSize-CJpdNxJ9.js"), true ? [] : void 0));
const FlexColumnSizePage = lazy(() => __vitePreload(() => import("./FlexColumnSize-CJr-rRG2.js"), true ? [] : void 0));
const FlexColumnPage = lazy(() => __vitePreload(() => import("./FlexColumn-Cs1A5Bdq.js"), true ? [] : void 0));
const ButtonsMaterialPage = lazy(() => __vitePreload(() => import("./ButtonsMaterial-NtPYMGqC.js"), true ? [] : void 0));
const SuperFlexPage = lazy(() => __vitePreload(() => import("./SuperFlex-Dplnv5rj.js"), true ? [] : void 0));
const Entity = lazy(() => __vitePreload(() => import("./Entity-CSR5X2iP.js"), true ? __vite__mapDeps([3,1]) : void 0));
const People = lazy(() => __vitePreload(() => import("./People-C9LnfHTs.js"), true ? [] : void 0));
const LoginPage = lazy(() => __vitePreload(() => import("./Login-x_H3joWj.js"), true ? __vite__mapDeps([4,1]) : void 0));
