      ...
      execute: function execute() {
        ...
        var States = /*#__PURE__*/function (_Array) {
          function States(callback) {
            ...
            if (isArray(initialState)) {
              ...
              _this54 = _callSuper(this, States, _toConsumableArray(Object.entries(initialState).filter(function (_ref27) {
        ...
        function createResource(pSource, pFetcher, pOptions) {
          ...
          var contexts = new Set(),
            _ref36 = (options.storage || createSignal)(options.initialValue),
        ...
        function createRenderer$1(_ref38) {
          var createElement = _ref38.createElement,
            createTextNode = _ref38.createTextNode,
            isTextNode = _ref38.isTextNode,
            replaceText = _ref38.replaceText,
            insertNode = _ref38.insertNode,
            removeNode = _ref38.removeNode,
            setProperty = _ref38.setProperty,
            getParentNode = _ref38.getParentNode,
            getFirstChild = _ref38.getFirstChild,
            getNextSibling = _ref38.getNextSibling;
              ...
              if (property === 'data') {
                for (var _key44 in value) {
                  ...
                  if (keyValue === undefined) {
                    div.removeAttribute("data-".concat(_key44));
                  } else {
                    div.setAttribute("data-".concat(_key44), String(keyValue));
                  }
                }
                return;
              }
        ...
        function eventHandler(e) {
          if (sharedConfig.registry && sharedConfig.events) {
            if (sharedConfig.events.find(function (_ref39) {
        ...
        var Announcer = {
          ...
          speak: function speak(text) {
            var _ref45 = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
              ...
              append = _ref45$append === void 0 ? false : _ref45$append,
              _ref45$notification = _ref45.notification,
              notification = _ref45$notification === void 0 ? false : _ref45$notification;
            if (Announcer.onFocusChange && Announcer.enabled) {
          ...
          setupTimers: function setupTimers() {
            var _ref46 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
              ...
              focusDebounce = _ref46$focusDebounce === void 0 ? 400 : _ref46$focusDebounce,
              _ref46$focusChangeTim = _ref46.focusChangeTimeout,
              focusChangeTimeout = _ref46$focusChangeTim === void 0 ? fiveMinutes : _ref46$focusChangeTim;
        ...
        function makeComponentStyles(_ref47) {
          var themeKeys = _ref47.themeKeys,
            base = _ref47.base,
            _ref47$modes = _ref47.modes,
            modes = _ref47$modes === void 0 ? {} : _ref47$modes,
            _ref47$tones = _ref47.tones,
            tones = _ref47$tones === void 0 ? {} : _ref47$tones,
            themeStyles = _ref47.themeStyles,
            _ref47$modeKeys = _ref47.modeKeys,
            modeKeys = _ref47$modeKeys === void 0 ? defaultModeKeys : _ref47$modeKeys,
            _ref47$toneKeys = _ref47.toneKeys,
            toneKeys = _ref47$toneKeys === void 0 ? defaultToneKeys : _ref47$toneKeys;
          ...
          var mapThemeKeysToSolid = function mapThemeKeysToSolid(stylesToMap) {
            return objectFromEntries(Object.entries(themeKeys).filter(function (_ref48) {
          ...
          var convertComponentConfig = function convertComponentConfig(themeStyles) {
            ...
            Object.entries(themeStyles).map(function (_ref52) {
              var _ref53 = _slicedToArray(_ref52, 2),
                variantName = _ref53[0],
                styles = _ref53[1];
              ...
              Object.entries(styles).filter(function (_ref54) {
                var _ref55 = _slicedToArray(_ref54, 2),
                  styleName = _ref55[0],
                  _ = _ref55[1];
                return modeKeys.includes(styleName);
              }).forEach(function (_ref56) {
        ...
        function withScrolling(isRow) {
          ...
          return function (componentRef, selectedElement) {
            var _ref58, _componentRef$_target, _componentRef$offset, _selectedElement$axis, _selectedElement$dime;
            ...
            var rootPosition = (_ref58 = (_componentRef$_target = componentRef._targetPosition) !== null && _componentRef$_target !== void 0 ? _componentRef$_target : componentRef[axis]) !== null && _ref58 !== void 0 ? _ref58 : 0;
        ...
        var Grid = lazy(function () {
          return __vitePreload(function () {
            return module.import('./Grid-legacy-D4mXLJRt.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var Portal = lazy(function () {
          return __vitePreload(function () {
            return module.import('./Portal-legacy-DfAFqStj.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var TextPage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./Text-legacy-CzHAzlUo.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var CreatePage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./Create-legacy-D_K1B0ln.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var ViewportPage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./Viewport-legacy-C_d3pQ-0.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var ButtonsPage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./Buttons-legacy-BIQde9QU.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var FlexPage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./Flex-legacy-BBYpO2Ak.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var FlexSizePage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./FlexSize-legacy-7mT6TmjS.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var FlexColumnSizePage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./FlexColumnSize-legacy-BEELYUxJ.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var FlexColumnPage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./FlexColumn-legacy-Ce1MHEU-.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var ButtonsMaterialPage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./ButtonsMaterial-legacy-CY0u9Ady.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var SuperFlexPage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./SuperFlex-legacy-CPGsxjMy.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var Entity = lazy(function () {
          return __vitePreload(function () {
            return module.import('./Entity-legacy-B-q6Vhnf.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var People = lazy(function () {
          return __vitePreload(function () {
            return module.import('./People-legacy-CQbkAZh-.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var LoginPage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./Login-legacy-C0VCwjTm.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        Config.debug = false;
...
//# sourceMappingURL=index-legacy-CYfQwJE6.js.map
