const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Loops-C3I-j2fK.js","assets/index-NniGaK3W.js","assets/Infinite-Bz4H4Foe.js"])))=>i.map(i=>d[i]);
...
function calculateFlex(node) {
  ...
  const crossAlignChild = containerCrossSize ? (c, crossStart = 0) => {
    ...
    if (!alignSelf) {
      ...
      c[crossProp] = crossStart + (containerCrossSize - (c[crossDimension] || 0)) / 2 + (c[crossMarginOne] || 0);
    } else if (alignSelf === "flexEnd") {
      c[crossProp] = crossStart + containerCrossSize - (c[crossDimension] || 0) - (c[crossMarginTwo] || 0);
    }
  } : (c) => c;
  ...
  if (justify === "flexStart") {
    ...
    if (node.flexWrap === "wrap") {
      ...
      node["preFlex".concat(crossDimension)] = containerCrossSize;
...
const { memo, createComponent, createElement, spread, setProp, mergeProps } = solidRenderer;
const taskQueue = [];
...
function getRadius(quad) {
  ...
  if (quad.shader instanceof UnsupportedShader) {
    ...
    if (shType === ROUNDED_RECTANGLE_SHADER_TYPE) {
      ...
      if (effects) {
        const effect = effects.find((effect2) => {
          var _a3;
          return effect2.type === "radius" && ((_a3 = effect2 == null ? void 0 : effect2.props) == null ? void 0 : _a3.radius);
        });
  ...
  if (quad.shader instanceof UnsupportedShader) {
    ...
    if (shType === "DynamicShader") {
      ...
      if (effects && effects.length) {
        const effect = effects.find((effect2) => {
          return effect2.type === "border".concat(direction) && effect2.props && effect2.props.width;
        });
...
const Grid = lazy(() => __vitePreload(() => import("./Grid-_SDujFOu.js"), true ? [] : void 0));
const Loops = lazy(() => __vitePreload(() => import("./Loops-C3I-j2fK.js"), true ? __vite__mapDeps([0,1]) : void 0));
const Infinite = lazy(() => __vitePreload(() => import("./Infinite-Bz4H4Foe.js"), true ? __vite__mapDeps([2,1]) : void 0));
const TMDBGrid = lazy(() => __vitePreload(() => import("./TMDBGrid-D6HinT2e.js"), true ? [] : void 0));
const Portal = lazy(() => __vitePreload(() => import("./Portal-exBbzAAD.js"), true ? [] : void 0));
const TextPage = lazy(() => __vitePreload(() => import("./Text-VC1drPLV.js"), true ? [] : void 0));
const TextPosterPage = lazy(() => __vitePreload(() => import("./TextPoster-D3nSR7Kx.js"), true ? [] : void 0));
const CreatePage = lazy(() => __vitePreload(() => import("./Create-Cb-d5got.js"), true ? [] : void 0));
const ViewportPage = lazy(() => __vitePreload(() => import("./Viewport-wu_19Zjq.js"), true ? [] : void 0));
const PositioningPage = lazy(() => __vitePreload(() => import("./Positioning-CnI49GbN.js"), true ? [] : void 0));
const LayoutPage = lazy(() => __vitePreload(() => import("./Layout-CYzdKSKL.js"), true ? [] : void 0));
const FocusBasicsPage = lazy(() => __vitePreload(() => import("./FocusBasics-BRGOyi0b.js"), true ? [] : void 0));
const KeyHandlingPage = lazy(() => __vitePreload(() => import("./KeyHandling-g0iBqqnQ.js"), true ? [] : void 0));
const TransitionsPage = lazy(() => __vitePreload(() => import("./Transitions-DB5ey21G.js"), true ? [] : void 0));
const ComponentsPage = lazy(() => __vitePreload(() => import("./Components-aHnLE0oW.js"), true ? [] : void 0));
const FocusHandlingPage = lazy(() => __vitePreload(() => import("./FocusHandling-gN5xujul.js"), true ? [] : void 0));
const GradientsPage = lazy(() => __vitePreload(() => import("./Gradients-w4NXPhql.js"), true ? [] : void 0));
const FlexPage = lazy(() => __vitePreload(() => import("./Flex-V2rreKnF.js"), true ? [] : void 0));
const FlexGrowPage = lazy(() => __vitePreload(() => import("./FlexGrow-BIavIbwk.js"), true ? [] : void 0));
const FlexMenuPage = lazy(() => __vitePreload(() => import("./FlexMenu-TuyWJRr3.js"), true ? [] : void 0));
const FlexSizePage = lazy(() => __vitePreload(() => import("./FlexSize-B3__x3U8.js"), true ? [] : void 0));
const FlexColumnSizePage = lazy(() => __vitePreload(() => import("./FlexColumnSize-DjdmDwjW.js"), true ? [] : void 0));
const FlexColumnPage = lazy(() => __vitePreload(() => import("./FlexColumn-WV396eC6.js"), true ? [] : void 0));
const ButtonsMaterialPage = lazy(() => __vitePreload(() => import("./ButtonsMaterial-CnXsv4mW.js"), true ? [] : void 0));
const SuperFlexPage = lazy(() => __vitePreload(() => import("./SuperFlex-BeGgn-eX.js"), true ? [] : void 0));
const Entity = lazy(() => __vitePreload(() => import("./Entity-vrjQwggf.js"), true ? [] : void 0));
const People = lazy(() => __vitePreload(() => import("./People-BiY8YoCD.js"), true ? [] : void 0));
const FireboltPage = lazy(() => __vitePreload(() => import("./Firebolt-BPoKSHm0.js"), true ? [] : void 0));
