    ...
    return {
      ...
      execute: function execute() {
        function getCredits(_ref) {
          var id = _ref.id;
          return api.get(`/person/${id}/combined_credits`).then(function (_ref2) {
            var cast = _ref2.cast;
        ...
        function getInfo(_ref3) {
          var id = _ref3.id;
          return api.get(`/person/${id}`).then(function (data) {
...
//# sourceMappingURL=People-legacy-BVpgP1zJ.js.map
