    ...
    return {
      execute: function execute() {
        ...
        function createMatcher(path, partial, matchFilters) {
          ...
          return function (location) {
            ...
            for (var i = 0; i < len; i++) {
              ...
              var _key42 = dynamic ? segment.slice(1) : segment;
        ...
        function createRouterContext(integration, branches, getContext) {
          ...
          var collectDynamicParams = function collectDynamicParams(branches) {
            ...
            branches.forEach(function (branch) {
              branch.routes.forEach(function (route) {
                if (route.pattern) {
                  var _matches = route.pattern.match(/:(\w+)/g);
                  if (_matches) {
                    _matches.forEach(function (param) {
                      var p = param.slice(1); // Remove the `:`
          ...
          var SUPPORTS_PROXY = false; //typeof Proxy === "function";
          var paramsHandler = function paramsHandler() {
            var m = matches();
            var params = {};
          ...
          var params = SUPPORTS_PROXY ? createMemoObject(paramsHandler) : createMemoWithoutProxy(paramsHandler, collectDynamicParams(branches()));
          var baseRoute = {
            pattern: basePath,
            path: function path() {
              return basePath;
        ...
        function accessWith(valueOrFn) {
          for (var _len21 = arguments.length, args = new Array(_len21 > 1 ? _len21 - 1 : 0), _key45 = 1; _key45 < _len21; _key45++) {
        ...
        function createStaticStore(init) {
          ...
          var _loop11 = function _loop11(_key46) {
            Object.defineProperty(store, _key46, {
              get: function get() {
                return getValue(_key46);
              },
              enumerable: true
            });
          };
          for (var _key46 in init) {
            _loop11(_key46);
          }
        ...
        function chainFunctions() {
          for (var _len22 = arguments.length, args = new Array(_len22), _key48 = 0; _key48 < _len22; _key48++) {
          ...
          return function () {
            var result;
            for (var _len23 = arguments.length, innerArgs = new Array(_len23), _key49 = 0; _key49 < _len23; _key49++) {
        ...
        var Grid = lazy(function () {
          return __vitePreload(function () {
            return module.import('./Grid-legacy-CWCvZZJ1.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var Portal = lazy(function () {
          return __vitePreload(function () {
            return module.import('./Portal-legacy-DvUz0KGO.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var TextPage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./Text-legacy-DSvwjA4q.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var CreatePage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./Create-legacy-ClZ-WBTR.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var ViewportPage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./Viewport-legacy-V0uKbnHB.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var ButtonsPage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./Buttons-legacy-JYXogJti.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var FlexPage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./Flex-legacy-BaBlOPE4.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var FlexSizePage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./FlexSize-legacy-BBAT3aei.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var FlexColumnSizePage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./FlexColumnSize-legacy-4Qc_BWKt.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var FlexColumnPage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./FlexColumn-legacy-CtP5mOfO.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var ButtonsMaterialPage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./ButtonsMaterial-legacy-ComCnE0W.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var SuperFlexPage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./SuperFlex-legacy-m1i1f5Hw.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var Entity = lazy(function () {
          return __vitePreload(function () {
            return module.import('./Entity-legacy-pRwyBRdl.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var People = lazy(function () {
          return __vitePreload(function () {
            return module.import('./People-legacy-C6yQofRL.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var LoginPage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./Login-legacy-2plAwoF7.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
