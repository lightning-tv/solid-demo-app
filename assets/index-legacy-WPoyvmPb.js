    ...
    return {
      execute: function execute() {
        ...
        function chainFunctions() {
          for (var _len21 = arguments.length, args = new Array(_len21), _key48 = 0; _key48 < _len21; _key48++) {
          ...
          return function () {
            var result;
            for (var _len22 = arguments.length, innerArgs = new Array(_len22), _key49 = 0; _key49 < _len22; _key49++) {
              innerArgs[_key49] = arguments[_key49];
            }
            var _iterator22 = _createForOfIteratorHelper(onlyFunctions),
              _step22;
            try {
        ...
        function createInfiniteScroll(fetcher) {
          var _createSignal47 = createSignal([]),
            ...
            pages = _createSignal48[0],
            setPages = _createSignal48[1];
          var _createSignal49 = createSignal(1),
            _createSignal50 = _slicedToArray(_createSignal49, 2),
            page = _createSignal50[0],
            setPage = _createSignal50[1];
          var _createSignal51 = createSignal(false),
            _createSignal52 = _slicedToArray(_createSignal51, 2),
            end = _createSignal52[0],
            setEnd = _createSignal52[1];
        ...
        var Browse = function Browse() {
          ...
          var _createSignal53 = createSignal(0),
            ...
            columnY = _createSignal54[0],
            setcolumnY = _createSignal54[1];
          var _createSignal55 = createSignal({}),
            _createSignal56 = _slicedToArray(_createSignal55, 2),
            heroContent = _createSignal56[0],
            setHeroContent = _createSignal56[1];
          var navigate = useNavigate();
        ...
        var Grid = lazy(function () {
          return __vitePreload(function () {
            return module.import('./Grid-legacy-CwYyLY1m.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var Portal = lazy(function () {
          return __vitePreload(function () {
            return module.import('./Portal-legacy-Zcl6hjlM.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var TextPage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./Text-legacy-DG_SEGXG.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var CreatePage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./Create-legacy-CAhaytfa.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var ViewportPage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./Viewport-legacy-CQHxPzSA.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var ButtonsPage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./Buttons-legacy-CrmbL47F.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var FlexPage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./Flex-legacy-D4AJ2NlM.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var FlexSizePage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./FlexSize-legacy-DupI5QMc.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var FlexColumnSizePage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./FlexColumnSize-legacy-C6AzqinS.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var FlexColumnPage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./FlexColumn-legacy-Deo951Rw.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var ButtonsMaterialPage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./ButtonsMaterial-legacy-BG-Uu41Z.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var SuperFlexPage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./SuperFlex-legacy-CQEDHzd-.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var Entity = lazy(function () {
          return __vitePreload(function () {
            return module.import('./Entity-legacy-DBfDE1Ni.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var People = lazy(function () {
          return __vitePreload(function () {
            return module.import('./People-legacy-DUUGsSPp.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var LoginPage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./Login-legacy-DGaP4daJ.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
...
//# sourceMappingURL=index-legacy-WPoyvmPb.js.map
