...
const Player = lazy(() => __vitePreload(() => import("./Player-Blc_CIlP.js"), true ? [] : void 0));
const Grid = lazy(() => __vitePreload(() => import("./Grid-Dtr7gwy_.js"), true ? [] : void 0));
const Loops = lazy(() => __vitePreload(() => import("./Loops-BzXqpass.js"), true ? [] : void 0));
const Infinite = lazy(() => __vitePreload(() => import("./Infinite-30_VMb8L.js"), true ? [] : void 0));
const TMDBGrid = lazy(() => __vitePreload(() => import("./TMDBGrid-DqT1Gh0m.js"), true ? [] : void 0));
const Portal = lazy(() => __vitePreload(() => import("./Portal-COZB5Pi7.js"), true ? [] : void 0));
const MatrixPage = lazy(() => __vitePreload(() => import("./Matrix-BsAI6ATP.js"), true ? [] : void 0));
const TextPage = lazy(() => __vitePreload(() => import("./Text-0ee-1ZRu.js"), true ? [] : void 0));
const TextPosterPage = lazy(() => __vitePreload(() => import("./TextPoster-DjwWRQBQ.js"), true ? [] : void 0));
const CreatePage = lazy(() => __vitePreload(() => import("./Create-i2_JRlQz.js"), true ? [] : void 0));
const ViewportPage = lazy(() => __vitePreload(() => import("./Viewport-CU1vFze0.js"), true ? [] : void 0));
const PositioningPage = lazy(() => __vitePreload(() => import("./Positioning-BBGLg92-.js"), true ? [] : void 0));
const LayoutPage = lazy(() => __vitePreload(() => import("./Layout-CIsq5h56.js"), true ? [] : void 0));
const FocusBasicsPage = lazy(() => __vitePreload(() => import("./FocusBasics-DZOZPLq-.js"), true ? [] : void 0));
const KeyHandlingPage = lazy(() => __vitePreload(() => import("./KeyHandling-DGG3mco3.js"), true ? [] : void 0));
const TransitionsPage = lazy(() => __vitePreload(() => import("./Transitions-Am6DZiUP.js"), true ? [] : void 0));
const ComponentsPage = lazy(() => __vitePreload(() => import("./Components-CfG4vhk3.js"), true ? [] : void 0));
const FocusHandlingPage = lazy(() => __vitePreload(() => import("./FocusHandling-pez-pxiB.js"), true ? [] : void 0));
const GradientsPage = lazy(() => __vitePreload(() => import("./Gradients-CUP0_SNf.js"), true ? [] : void 0));
const FlexPage = lazy(() => __vitePreload(() => import("./Flex-DU5Qx9vk.js"), true ? [] : void 0));
const FlexGrowPage = lazy(() => __vitePreload(() => import("./FlexGrow-CfMr3RXG.js"), true ? [] : void 0));
const FlexMenuPage = lazy(() => __vitePreload(() => import("./FlexMenu-DM2vxjaY.js"), true ? [] : void 0));
const FlexSizePage = lazy(() => __vitePreload(() => import("./FlexSize-gy81E8lS.js"), true ? [] : void 0));
const FlexColumnSizePage = lazy(() => __vitePreload(() => import("./FlexColumnSize-Dw43_kAF.js"), true ? [] : void 0));
const FlexColumnPage = lazy(() => __vitePreload(() => import("./FlexColumn-CvieeprR.js"), true ? [] : void 0));
const ButtonsMaterialPage = lazy(() => __vitePreload(() => import("./ButtonsMaterial-DxIULw-S.js"), true ? [] : void 0));
const SuperFlexPage = lazy(() => __vitePreload(() => import("./SuperFlex-CghZwqn1.js"), true ? [] : void 0));
const Entity = lazy(() => __vitePreload(() => import("./Entity-DZak8vYb.js"), true ? [] : void 0));
const People = lazy(() => __vitePreload(() => import("./People-CPsVL9Ss.js"), true ? [] : void 0));
const FireboltPage = lazy(() => __vitePreload(() => import("./Firebolt-BioCA2dL.js"), true ? [] : void 0));
const LoginPage = lazy(() => __vitePreload(() => import("./Login-D2_O55qA.js"), true ? [] : void 0));
const VirtualPage = lazy(() => __vitePreload(() => import("./Virtual-DOHu21vB.js"), true ? [] : void 0));
const TagsPage = lazy(() => __vitePreload(() => import("./Tags-eX2SfQRN.js"), true ? [] : void 0));
        ...
        return [createComponent(Route, {
          ...
          get children() {
            return [createComponent(Route, {
              ...
              path: "nested",
              get component() {
                return lazy(() => __vitePreload(() => import("./Nested-CqphMsHW.js"), true ? [] : void 0));
              }
            }), createComponent(Route, {
              path: "textposter",
              ...
              path: "keepalive",
              get component() {
                return lazy(() => __vitePreload(() => import("./KeepAlive-B0LHSSjF.js"), true ? [] : void 0));
              }
            }), createComponent(Route, {
              path: "suspense",
              get component() {
                return lazy(() => __vitePreload(() => import("./suspense-Bxfyn5sQ.js"), true ? [] : void 0));
              }
            }), createComponent(Route, {
              path: "superflex",
