const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Loops-5LszcTRf.js","assets/index-EYRbd8fF.js","assets/Infinite-CSCzN9nW.js","assets/Components-CqeFcLtI.js","assets/Button-Bqq-wbNh.js","assets/Login-DnumLG8A.js"])))=>i.map(i=>d[i]);
...
class CoreTextureManager extends EventEmitter {
  constructor(stage, numImageWorkers2) {
    super();
    /**
...
class TextureMemoryManager {
  ...
  cleanup() {
    ...
    while (this.memUsed >= memTarget && this.orphanedTextures.length > 0 && // if it a non-critical cleanup, we will only cleanup for 10ms
...
class Stage {
  ...
  constructor(options) {
    ...
    this.txManager = new CoreTextureManager(this, numImageWorkers2);
...
class RendererMain extends EventEmitter {
  ...
  constructor(settings, target) {
    ...
    const resolvedSettings = {
      ...
      clearColor: (_f = settings.clearColor) != null ? _f : 0,
      fpsUpdateInterval: settings.fpsUpdateInterval || 0,
      numImageWorkers: settings.numImageWorkers !== void 0 ? settings.numImageWorkers : 2,
      enableContextSpy: (_g = settings.enableContextSpy) != null ? _g : false,
      forceWebGL2: (_h = settings.forceWebGL2) != null ? _h : false,
      inspector: (_i = settings.inspector) != null ? _i : false,
      renderEngine: settings.renderEngine,
      quadBufferSize: (_j = settings.quadBufferSize) != null ? _j : 4 * 1024 * 1024,
      fontEngines: settings.fontEngines,
      strictBounds: (_k = settings.strictBounds) != null ? _k : true,
...
const Grid = lazy(() => __vitePreload(() => import("./Grid-DvVt3gP-.js"), true ? [] : void 0));
const Loops = lazy(() => __vitePreload(() => import("./Loops-5LszcTRf.js"), true ? __vite__mapDeps([0,1]) : void 0));
const Infinite = lazy(() => __vitePreload(() => import("./Infinite-CSCzN9nW.js"), true ? __vite__mapDeps([2,1]) : void 0));
const TMDBGrid = lazy(() => __vitePreload(() => import("./TMDBGrid-B8i2SL43.js"), true ? [] : void 0));
const Portal = lazy(() => __vitePreload(() => import("./Portal-BVOHpz4_.js"), true ? [] : void 0));
const TextPage = lazy(() => __vitePreload(() => import("./Text-DayIaXMk.js"), true ? [] : void 0));
const TextPosterPage = lazy(() => __vitePreload(() => import("./TextPoster-CChq0mge.js"), true ? [] : void 0));
const CreatePage = lazy(() => __vitePreload(() => import("./Create-CUPvXvQu.js"), true ? [] : void 0));
const ViewportPage = lazy(() => __vitePreload(() => import("./Viewport-Dt_r6BXy.js"), true ? [] : void 0));
const PositioningPage = lazy(() => __vitePreload(() => import("./Positioning-tbm93uLi.js"), true ? [] : void 0));
const LayoutPage = lazy(() => __vitePreload(() => import("./Layout-FrPk__yk.js"), true ? [] : void 0));
const FocusBasicsPage = lazy(() => __vitePreload(() => import("./FocusBasics-DRIfBtLL.js"), true ? [] : void 0));
const KeyHandlingPage = lazy(() => __vitePreload(() => import("./KeyHandling-Dieew42I.js"), true ? [] : void 0));
const TransitionsPage = lazy(() => __vitePreload(() => import("./Transitions-DgUYKuY0.js"), true ? [] : void 0));
const ComponentsPage = lazy(() => __vitePreload(() => import("./Components-CqeFcLtI.js"), true ? __vite__mapDeps([3,4]) : void 0));
const FocusHandlingPage = lazy(() => __vitePreload(() => import("./FocusHandling-Bjyx4D14.js"), true ? [] : void 0));
const GradientsPage = lazy(() => __vitePreload(() => import("./Gradients-DhFX5IAL.js"), true ? [] : void 0));
const FlexPage = lazy(() => __vitePreload(() => import("./Flex-Buv7J84-.js"), true ? [] : void 0));
const FlexGrowPage = lazy(() => __vitePreload(() => import("./FlexGrow-BmBU7vJ1.js"), true ? [] : void 0));
const FlexSizePage = lazy(() => __vitePreload(() => import("./FlexSize-CyqICqiG.js"), true ? [] : void 0));
const FlexColumnSizePage = lazy(() => __vitePreload(() => import("./FlexColumnSize-Cp9xnL8U.js"), true ? [] : void 0));
const FlexColumnPage = lazy(() => __vitePreload(() => import("./FlexColumn-Hu3BIzVY.js"), true ? [] : void 0));
const ButtonsMaterialPage = lazy(() => __vitePreload(() => import("./ButtonsMaterial-B3c9S52O.js"), true ? [] : void 0));
const SuperFlexPage = lazy(() => __vitePreload(() => import("./SuperFlex-76po01ZM.js"), true ? [] : void 0));
const Entity = lazy(() => __vitePreload(() => import("./Entity-CmrXhGPe.js"), true ? [] : void 0));
const People = lazy(() => __vitePreload(() => import("./People-BAh8-WtQ.js"), true ? [] : void 0));
const LoginPage = lazy(() => __vitePreload(() => import("./Login-DnumLG8A.js"), true ? __vite__mapDeps([5,4]) : void 0));
const FireboltPage = lazy(() => __vitePreload(() => import("./Firebolt-Dx3YLwSE.js"), true ? [] : void 0));
