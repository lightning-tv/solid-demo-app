(function () {
	...
	*/
	...
	// `Array.prototype.includes` method
	// https://tc39.es/ecma262/#sec-array.prototype.includes
	$$11({ target: 'Array', proto: true, forced: BROKEN_ON_SPARSE }, {
	...
	// `Array.prototype.indexOf` method
	// https://tc39.es/ecma262/#sec-array.prototype.indexof
	$$10({ target: 'Array', proto: true, forced: FORCED$b }, {
	...
	// https://tc39.es/ecma262/#sec-array.prototype.map
	// with adding support of @@species
	$$_({ target: 'Array', proto: true, forced: !HAS_SPECIES_SUPPORT$2 }, {
	...
	$$Z({ target: 'Array', proto: true, arity: 1, forced: FORCED$a }, {
	  // eslint-disable-next-line no-unused-vars -- required for `.length`
	...
	$$U({ target: 'Array', proto: true, arity: 1, forced: FORCED$7 }, {
	  // eslint-disable-next-line no-unused-vars -- required for `.length`
	...
	if ($transfer$1) $$T({ target: 'ArrayBuffer', proto: true }, {
	...
	if ($transfer) $$S({ target: 'ArrayBuffer', proto: true }, {
	...
	$$P({ global: true, constructor: true, wrap: true, forced: FORCED$6 }, {
	...
	$$M({ target: 'Object', stat: true, forced: FAILS_ON_PRIMITIVES$3, sham: !FREEZING$1 }, {
	...
	// `Object.getOwnPropertyDescriptor` method
	// https://tc39.es/ecma262/#sec-object.getownpropertydescriptor
	$$K({ target: 'Object', stat: true, forced: FORCED$5, sham: !DESCRIPTORS$g }, {
	...
	// https://tc39.es/ecma262/#sec-object.getownpropertydescriptors
	$$I({ target: 'Object', stat: true, sham: !DESCRIPTORS$f }, {
