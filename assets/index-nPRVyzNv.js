const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Components-C-yNzW85.js","assets/Button-Dzn4zw2O.js","assets/Login-COLBgjom.js"])))=>i.map(i=>d[i]);
...
class ImageWorkerManager {
  ...
  createWorkers(numWorkers2 = 1, createImageBitmapSupport) {
    ...
    workerCode = workerCode.replace("var supportsOptionsCreateImageBitmap = false;", "var supportsOptionsCreateImageBitmap = ".concat(supportsOptions, ";"));
    workerCode = workerCode.replace("var supportsFullCreateImageBitmap = false;", "var supportsFullCreateImageBitmap = ".concat(supportsFull, ";"));
...
class Inspector {
    ...
    if (stylePropertyMap[property]) {
      ...
      if (typeof mappedStyleResponse === "object") {
        ...
        if (property === "x") {
          ...
          if (mount) {
            value2 = "".concat(parseInt(value2) - width * mount, "px");
          }
        } else if (property === "y") {
          const mount = props.mountY;
          const height = props.height;
          if (mount) {
            value2 = "".concat(parseInt(value2) - height * mount, "px");
          }
        }
  ...
  animateNode(div, props, settings) {
    ...
    function animate() {
      setTimeout(() => {
        div.style.top = "".concat(y - height * mountY, "px");
        div.style.left = "".concat(x - width * mountX, "px");
...
const Grid = lazy(() => __vitePreload(() => import("./Grid-SpKuAxLU.js"), true ? [] : void 0));
const Portal = lazy(() => __vitePreload(() => import("./Portal-Dz-t62og.js"), true ? [] : void 0));
const TextPage = lazy(() => __vitePreload(() => import("./Text-C47iviHq.js"), true ? [] : void 0));
const TextPosterPage = lazy(() => __vitePreload(() => import("./TextPoster-BFG6O8xU.js"), true ? [] : void 0));
const CreatePage = lazy(() => __vitePreload(() => import("./Create-Bt7rkEkB.js"), true ? [] : void 0));
const ViewportPage = lazy(() => __vitePreload(() => import("./Viewport-9cCJovmL.js"), true ? [] : void 0));
const PositioningPage = lazy(() => __vitePreload(() => import("./Positioning-JuVAV333.js"), true ? [] : void 0));
const LayoutPage = lazy(() => __vitePreload(() => import("./Layout-ygm10zpz.js"), true ? [] : void 0));
const FocusBasicsPage = lazy(() => __vitePreload(() => import("./FocusBasics-DP8tKX5z.js"), true ? [] : void 0));
const TransitionsPage = lazy(() => __vitePreload(() => import("./Transitions-bvkpoKqA.js"), true ? [] : void 0));
const ComponentsPage = lazy(() => __vitePreload(() => import("./Components-C-yNzW85.js"), true ? __vite__mapDeps([0,1]) : void 0));
const FocusHandlingPage = lazy(() => __vitePreload(() => import("./FocusHandling-BN2cfxjN.js"), true ? [] : void 0));
const GradientsPage = lazy(() => __vitePreload(() => import("./Gradients-D0-WkVi5.js"), true ? [] : void 0));
const FlexPage = lazy(() => __vitePreload(() => import("./Flex-FxrRvJAm.js"), true ? [] : void 0));
const FlexSizePage = lazy(() => __vitePreload(() => import("./FlexSize-CEuZv2CK.js"), true ? [] : void 0));
const FlexColumnSizePage = lazy(() => __vitePreload(() => import("./FlexColumnSize-ZJY0D_MO.js"), true ? [] : void 0));
const FlexColumnPage = lazy(() => __vitePreload(() => import("./FlexColumn-D4awHUm-.js"), true ? [] : void 0));
const ButtonsMaterialPage = lazy(() => __vitePreload(() => import("./ButtonsMaterial-CmLKpqKk.js"), true ? [] : void 0));
const SuperFlexPage = lazy(() => __vitePreload(() => import("./SuperFlex-CQXVeroP.js"), true ? [] : void 0));
const Entity = lazy(() => __vitePreload(() => import("./Entity-TYuH3htT.js"), true ? [] : void 0));
const People = lazy(() => __vitePreload(() => import("./People-DdN5pEkx.js"), true ? [] : void 0));
const LoginPage = lazy(() => __vitePreload(() => import("./Login-COLBgjom.js"), true ? __vite__mapDeps([2,1]) : void 0));
