...
(function () {
  ...
  System.register(['./index-legacy-XKDQ4YyH.js', './Button-legacy-CXQPiejS.js'], function (exports, module) {
    'use strict';
    ...
    return {
      ...
      execute: function execute() {
        ...
        function getRecommendations(_ref) {
          var type = _ref.type,
            id = _ref.id;
          return api.get(`/${type}/${id}/recommendations`).then(function (_ref2) {
            var results = _ref2.results;
            if (results.length) {
              return convertItemsToTiles(results.slice(0, 7));
            }
            return api.get(`/trending/${type}/week?page=1`).then(function (_ref3) {
        ...
        function getCredits(_ref4) {
          var type = _ref4.type,
            id = _ref4.id;
          return api.get(`/${type}/${id}/credits`).then(function (_ref5) {
            var cast = _ref5.cast;
        ...
        function getInfo(_ref6) {
          ...
          return api.get(`/${type}/${id}`).then(function (data) {
...
//# sourceMappingURL=Entity-legacy-CQYeqaI0.js.map
