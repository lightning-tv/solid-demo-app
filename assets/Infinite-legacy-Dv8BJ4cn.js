...
(function () {
  ...
  System.register(['./index-legacy-IK2q1gn4.js', './index-legacy-rVLbJTER.js'], function (exports, module) {
    'use strict';

    var createSignal, createEffect, setGlobalBackground, createComponent, View, Text, Show, Poster, mergeProps, List;
    return {
      ...
      execute: function execute() {
        var Loops = exports("default", function (props) {
          var _createSignal = createSignal([]),
            ...
            allItems = _createSignal2[0],
            setAllItems = _createSignal2[1];
          var _createSignal3 = createSignal([]),
            _createSignal4 = _slicedToArray(_createSignal3, 2),
            displayedItems = _createSignal4[0],
            setDisplayedItems = _createSignal4[1];
          var _createSignal5 = createSignal(1),
            _createSignal6 = _slicedToArray(_createSignal5, 2),
            resetCounter = _createSignal6[0],
            setResetCounter = _createSignal6[1];
          var displaySize = 5;
          var bufferSize = 2;
          var currentIndex = 0,
            solidLogo;
...
//# sourceMappingURL=Infinite-legacy-Dv8BJ4cn.js.map
