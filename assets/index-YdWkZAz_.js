const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Buttons-Dog6Fbat.js","assets/Button-DWFab5tV.js","assets/Components-DFPH__Dy.js","assets/Entity-B8_oPDEr.js","assets/Login-Cqx1FyZ4.js"])))=>i.map(i=>d[i]);
...
class CoreNode extends EventEmitter {
  ...
  createRenderBounds() {
    ...
    if (this.clipping === false) {
      if (this.parent !== null) {
        this.strictBound = (_a = this.parent.strictBound) != null ? _a : createBound(0, 0, this.stage.root.width, this.stage.root.height);
        this.preloadBound = (_b = this.parent.preloadBound) != null ? _b : this.createPreloadBounds(this.strictBound);
        return;
      } else {
...
class Stage {
  ...
  constructor(options) {
    ...
    this.options = options;
    const { canvas, clearColor, appWidth, appHeight, boundsMargin, enableContextSpy, numImageWorkers: numImageWorkers2, textureMemory, renderEngine, fontEngines } = options;
...
const { Artwork: { defaultTone: defaultTone$i, ...themeStyles$h } = { themeStyles: {} } } = theme == null ? void 0 : theme.componentConfig;
const container$i = {
  themeKeys: {
...
const { Badge: { defaultTone: defaultTone$h, ...themeStyles$g } = { themeStyles: {} } } = theme.componentConfig;
const container$h = {
  themeKeys: {
...
const Container$6 = makeComponentStyles(container$h);
...
const { Button: { defaultTone: defaultTone$g, ...buttonThemeStyles } = { buttonThemeStyles: {} } } = theme == null ? void 0 : theme.componentConfig;
...
const Container$5 = makeComponentStyles(container$g);
...
const { Checkbox: { defaultTone: defaultTone$f, ...themeStyles$e } = { themeStyles: {} } } = theme == null ? void 0 : theme.componentConfig;
const container$f = {
  themeKeys: {
    color: "backgroundColor",
    borderRadius: "radius",
...
const { Icon: { defaultTone: defaultTone$e, ...themeStyles$d } = { themeStyles: {} } } = theme == null ? void 0 : theme.componentConfig;
const container$e = {
  themeKeys: {
    color: "color"
  },
...
const { Column: { defaultTone: defaultTone$d, ...themeStyles$c } = { themeStyles: {} } } = theme == null ? void 0 : theme.componentConfig;
const container$d = {
  themeKeys: {
    gap: "itemSpacing",
...
const Container$4 = makeComponentStyles(container$d);
const styles$6 = {
...
const { FocusRing: { defaultTone: defaultTone$c, ...themeStyles$b } = { themeStyles: {} } } = theme == null ? void 0 : theme.componentConfig;
const container$c = {
  themeKeys: {
    borderRadius: "radius"
  },
...
const { Row: { defaultTone: defaultTone$9, ...themeStyles$8 } = { themeStyles: {} } } = theme == null ? void 0 : theme.componentConfig;
const container$9 = {
  themeKeys: {
    gap: "itemSpacing",
    scrollIndex: "scrollIndex",
  ...
  return createComponent(View, mergeProps(props, {
    ...
    get style() {
      ...
      return [
        props.style,
        //
        styles$3.Container.tones[(_a = props.tone) != null ? _a : styles$3.tone],
        styles$3.Container.base
      ];
    }
  }));
};
const { Keyboard: { defaultTone: defaultTone$8, ...themeStyles$7 } = {} } = theme == null ? void 0 : theme.componentConfig;
...
const Grid = lazy(() => __vitePreload(() => import("./Grid-NoJTAUuS.js"), true ? [] : void 0));
const Portal = lazy(() => __vitePreload(() => import("./Portal-BggFlxSd.js"), true ? [] : void 0));
const TextPage = lazy(() => __vitePreload(() => import("./Text-5RvCShNp.js"), true ? [] : void 0));
const CreatePage = lazy(() => __vitePreload(() => import("./Create-CE0sc5ii.js"), true ? [] : void 0));
const ViewportPage = lazy(() => __vitePreload(() => import("./Viewport-Cn8xjVHC.js"), true ? [] : void 0));
const ButtonsPage = lazy(() => __vitePreload(() => import("./Buttons-Dog6Fbat.js"), true ? __vite__mapDeps([0,1]) : void 0));
const PositioningPage = lazy(() => __vitePreload(() => import("./Positioning-BgJjcfbP.js"), true ? [] : void 0));
const TransitionsPage = lazy(() => __vitePreload(() => import("./Transitions-C3xWfa5W.js"), true ? [] : void 0));
const ComponentsPage = lazy(() => __vitePreload(() => import("./Components-DFPH__Dy.js"), true ? __vite__mapDeps([2,1]) : void 0));
const FocusHandlingPage = lazy(() => __vitePreload(() => import("./FocusHandling-DadaQ3fd.js"), true ? [] : void 0));
const GradientsPage = lazy(() => __vitePreload(() => import("./Gradients-DQORGIMN.js"), true ? [] : void 0));
const FlexPage = lazy(() => __vitePreload(() => import("./Flex-DWW_Rz_v.js"), true ? [] : void 0));
const FlexSizePage = lazy(() => __vitePreload(() => import("./FlexSize-D7OrHMxy.js"), true ? [] : void 0));
const FlexColumnSizePage = lazy(() => __vitePreload(() => import("./FlexColumnSize-BXcHrYqS.js"), true ? [] : void 0));
const FlexColumnPage = lazy(() => __vitePreload(() => import("./FlexColumn-p601Ezc6.js"), true ? [] : void 0));
const ButtonsMaterialPage = lazy(() => __vitePreload(() => import("./ButtonsMaterial-BC5KX2ET.js"), true ? [] : void 0));
const SuperFlexPage = lazy(() => __vitePreload(() => import("./SuperFlex-D_Sy9L7X.js"), true ? [] : void 0));
const Entity = lazy(() => __vitePreload(() => import("./Entity-B8_oPDEr.js"), true ? __vite__mapDeps([3,1]) : void 0));
const People = lazy(() => __vitePreload(() => import("./People-D3WY41et.js"), true ? [] : void 0));
const LoginPage = lazy(() => __vitePreload(() => import("./Login-Cqx1FyZ4.js"), true ? __vite__mapDeps([4,1]) : void 0));
