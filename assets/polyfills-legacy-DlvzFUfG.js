(function () {
  ...
  var toString$r = uncurryThis$_({}.toString);
  var stringSlice$c = uncurryThis$_(''.slice);
  ...
  var ordinaryToPrimitive$2 = function (input, pref) {
    var fn, val;
    if (pref === 'string' && isCallable$r(fn = input.toString) && !isObject$t(val = call$B(fn, input))) return val;
    if (isCallable$r(fn = input.valueOf) && !isObject$t(val = call$B(fn, input))) return val;
    if (pref !== 'string' && isCallable$r(fn = input.toString) && !isObject$t(val = call$B(fn, input))) return val;
  ...
  var toString$q = uncurryThis$W(1.0.toString);
  ...
  objectGetOwnPropertyDescriptor.f = DESCRIPTORS$B ? $getOwnPropertyDescriptor$2 : function getOwnPropertyDescriptor(O, P) {
    ...
    if (hasOwn$t(O, P)) return createPropertyDescriptor$7(!call$z(propertyIsEnumerableModule$2.f, O, P), O[P]);
  };
  ...
  var functionToString = uncurryThis$V(Function.toString);
  ...
  var replace$a = uncurryThis$U(''.replace);
  ...
  */
  ...
  var exec$8 = uncurryThis$O(constructorRegExp.exec);
  ...
  var $defineProperties = function defineProperties(O, Properties) {
    ...
    $forEach$2(keys, function (key) {
      if (!DESCRIPTORS$u || call$x($propertyIsEnumerable$1, properties, key)) $defineProperty(O, key, properties[key]);
    });
    return O;
  };
  ...
  $$1j({ global: true, constructor: true, wrap: true, forced: !NATIVE_SYMBOL$5, sham: !NATIVE_SYMBOL$5 }, {
    Symbol: $Symbol
  });
  ...
  $$1j({ target: SYMBOL, stat: true, forced: !NATIVE_SYMBOL$5 }, {
    useSetter: function () { USE_SETTER = true; },
    useSimple: function () { USE_SETTER = false; }
  });

  $$1j({ target: 'Object', stat: true, forced: !NATIVE_SYMBOL$5, sham: !DESCRIPTORS$u }, {
    // `Object.create` method
    // https://tc39.es/ecma262/#sec-object.create
    create: $create,
    // `Object.defineProperty` method
  ...
  $$1j({ target: 'Object', stat: true, forced: !NATIVE_SYMBOL$5 }, {
    // `Object.getOwnPropertyNames` method
    // https://tc39.es/ecma262/#sec-object.getownpropertynames
  ...
  $$1i({ target: 'Symbol', stat: true, forced: !NATIVE_SYMBOL_REGISTRY$1 }, {
    'for': function (key) {
  ...
  $$1h({ target: 'Symbol', stat: true, forced: !NATIVE_SYMBOL_REGISTRY }, {
  ...
  var charCodeAt$3 = uncurryThis$K(''.charCodeAt);
  ...
  var stringifyWithSymbolsFix = function (it, replacer) {
    ...
    args[1] = function (key, value) {
      ...
      if (isCallable$i($replacer)) value = call$v($replacer, this, $String$1(key), value);
  ...
  if ($stringify) {
    ...
    $$1g({ target: 'JSON', stat: true, arity: 3, forced: WRONG_SYMBOLS_CONVERSION || ILL_FORMED_UNICODE }, {
      // eslint-disable-next-line no-unused-vars -- required for `.length`
  ...
  $$1f({ target: 'Object', stat: true, forced: FORCED$g }, {
  ...
  if (DESCRIPTORS$t && isCallable$h(NativeSymbol) && (!('description' in SymbolPrototype) ||
    ...
    var stringSlice$a = uncurryThis$J(''.slice);
    ...
    $$1e({ global: true, constructor: true, forced: true }, {
  ...
  var functionUncurryThisAccessor = function (object, key, method) {
    try {
      // eslint-disable-next-line es/no-object-getownpropertydescriptor -- safe
      return uncurryThis$I(aCallable$j(Object.getOwnPropertyDescriptor(object, key)[method]));
    } catch (error) { /* empty */ }
  };
  ...
  var exportGlobalErrorCauseWrapper = function (ERROR_NAME, wrapper) {
    ...
    $$1d({ global: true, constructor: true, arity: 1, forced: FORCED$f }, O);
  };
  ...
  var exportWebAssemblyErrorCauseWrapper = function (ERROR_NAME, wrapper) {
    if (WebAssembly && WebAssembly[ERROR_NAME]) {
      ...
      $$1d({ target: WEB_ASSEMBLY, stat: true, constructor: true, arity: 1, forced: FORCED$f }, O);
    }
  };
  ...
  var createProperty$8 = function (object, key, value) {
    if (DESCRIPTORS$r) definePropertyModule$1.f(object, key, createPropertyDescriptor$3(0, value));
  ...
  $$1c({ target: 'Array', proto: true, arity: 1, forced: FORCED$e }, {
    // eslint-disable-next-line no-unused-vars -- required for `.length`
  ...
  // `Array.prototype.find` method
  // https://tc39.es/ecma262/#sec-array.prototype.find
  $$19({ target: 'Array', proto: true, forced: SKIPS_HOLES$1 }, {
  ...
  var getIterator$4 = function (argument, usingIterator) {
    ...
    if (aCallable$i(iteratorMethod)) return anObject$q(call$t(iteratorMethod, argument));
  ...
  var test = [];
  var nativeSort$1 = uncurryThis$F(test.sort);
  var push$a = uncurryThis$F(test.push);
  ...
  var slice$5 = ArrayBufferPrototype$4 && uncurryThis$E(ArrayBufferPrototype$4.slice);
  ...
  var slice$4 = uncurryThis$D(ArrayBufferPrototype$2.slice);
  ...
  var FAILS_ON_PRIMITIVES$4 = fails$C(function () { $isExtensible(1); });
  ...
  var onFreeze$1 = function (it) {
    if (FREEZING$2 && REQUIRED && isExtensible$1(it) && !hasOwn$f(it, METADATA)) setMetadata(it);
    return it;
  };
  ...
  var collection$3 = function (CONSTRUCTOR_NAME, wrapper, common) {
    ...
    $$V({ global: true, constructor: true, forced: Constructor !== NativeConstructor }, exported);
  ...
  var charCodeAt$2 = uncurryThis$y(''.charCodeAt);
  ...
  $$T({ global: true, constructor: true, wrap: true, forced: FORCED$8 }, {
  ...
  // https://tc39.es/ecma262/#sec-object.defineproperties
  // eslint-disable-next-line es/no-object-defineproperties -- safe
  $$R({ target: 'Object', stat: true, forced: Object.defineProperties !== defineProperties, sham: !DESCRIPTORS$j }, {
    defineProperties: defineProperties
  });
  ...
  // https://tc39.es/ecma262/#sec-object.defineproperty
  // eslint-disable-next-line es/no-object-defineproperty -- safe
  $$Q({ target: 'Object', stat: true, forced: Object.defineProperty !== defineProperty$1, sham: !DESCRIPTORS$i }, {
  ...
  var FAILS_ON_PRIMITIVES$3 = fails$w(function () { $freeze(1); });

  // `Object.freeze` method
  // https://tc39.es/ecma262/#sec-object.freeze
  $$O({ target: 'Object', stat: true, forced: FAILS_ON_PRIMITIVES$3, sham: !FREEZING$1 }, {
  ...
  var FORCED$7 = !DESCRIPTORS$g || fails$v(function () { nativeGetOwnPropertyDescriptor$1(1); });

  // `Object.getOwnPropertyDescriptor` method
  // https://tc39.es/ecma262/#sec-object.getownpropertydescriptor
  $$M({ target: 'Object', stat: true, forced: FORCED$7, sham: !DESCRIPTORS$g }, {
  ...
  var FAILS_ON_PRIMITIVES$2 = fails$u(function () { return !Object.getOwnPropertyNames(1); });

  // `Object.getOwnPropertyNames` method
  // https://tc39.es/ecma262/#sec-object.getownpropertynames
  $$L({ target: 'Object', stat: true, forced: FAILS_ON_PRIMITIVES$2 }, {
  ...
  // https://tc39.es/ecma262/#sec-object.getownpropertydescriptors
  $$K({ target: 'Object', stat: true, sham: !DESCRIPTORS$f }, {
  ...
  var FAILS_ON_PRIMITIVES = fails$s(function () { nativeGetPrototypeOf(1); });

  // `Object.getPrototypeOf` method
  // https://tc39.es/ecma262/#sec-object.getprototypeof
  $$I({ target: 'Object', stat: true, forced: FAILS_ON_PRIMITIVES, sham: !CORRECT_PROTOTYPE_GETTER }, {
  ...
  var FORCED$6 = 1 / $parseFloat$1(whitespaces$1 + '-0') !== -Infinity
    ...
    || (ITERATOR$6 && !fails$r(function () { $parseFloat$1(Object(ITERATOR$6)); }));
  ...
  var $parseInt$2 = globalThis$u.parseInt;
  ...
  var FORCED$5 = $parseInt$2(whitespaces + '08') !== 8 || $parseInt$2(whitespaces + '0x16') !== 22
    // MS Edge 18- broken with boxed symbols
    || (ITERATOR$5 && !fails$q(function () { $parseInt$2(Object(ITERATOR$5)); }));
  ...
  // `parseInt` method
  // https://tc39.es/ecma262/#sec-parseint-string-radix
  $$F({ global: true, forced: parseInt !== $parseInt$1 }, {
    parseInt: $parseInt$1
  });
  ...
  var onUnhandled = function (state) {
    call$o(task, globalThis$o, function () {
  ...
  function get$1(target, propertyKey /* , receiver */) {
    ...
    if (descriptor) return isDataDescriptor(descriptor)
      ? descriptor.value
      : descriptor.get === undefined ? undefined : call$l(descriptor.get, receiver);
    if (isObject$a(prototype = getPrototypeOf$3(target))) return get$1(prototype, propertyKey, receiver);
  }
  ...
  $$t({ target: 'RegExp', proto: true, forced: /./.exec !== exec$4 }, {
    exec: exec$4
  });
  ...
  var stringIndexOf$1 = uncurryThis$m(''.indexOf);
