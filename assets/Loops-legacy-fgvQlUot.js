...
(function () {
  ...
  System.register(['./index-legacy-Cd-N1T1P.js', './index-legacy-2k9SA95u.js'], function (exports, module) {
    ...
    var createSignal, setGlobalBackground, createComponent, View, Text, Column, Row, For, Poster, mergeProps, Index, LazyUp, List;
    return {
      ...
      execute: function execute() {
        var Loops = exports("default", function (props) {
          var _createSignal = createSignal(props.data.rows[0]),
            _createSignal2 = _slicedToArray(_createSignal, 2),
            activeRow = _createSignal2[0],
            setActiveRow = _createSignal2[1];
          var currentIndex = 0,
            solidLogo;
