(function () {
  ...
  var stringSlice$c = uncurryThis$$(''.slice);

  var classofRaw$2 = function (it) {
    return stringSlice$c(toString$r(it), 8, -1);
  };
  ...
  var ordinaryToPrimitive$2 = function (input, pref) {
    var fn, val;
    if (pref === 'string' && isCallable$r(fn = input.toString) && !isObject$t(val = call$D(fn, input))) return val;
    if (isCallable$r(fn = input.valueOf) && !isObject$t(val = call$D(fn, input))) return val;
    if (pref !== 'string' && isCallable$r(fn = input.toString) && !isObject$t(val = call$D(fn, input))) return val;
  ...
  var toString$q = uncurryThis$X(1.0.toString);
  ...
  var wellKnownSymbol$x = function (name) {
    if (!hasOwn$u(WellKnownSymbolsStore$1, name)) {
      WellKnownSymbolsStore$1[name] = NATIVE_SYMBOL$6 && hasOwn$u(Symbol$3, name)
        ? Symbol$3[name]
  ...
  var ie8DomDefine = !DESCRIPTORS$C && !fails$V(function () {
    // eslint-disable-next-line es/no-object-defineproperty -- required for testing
  ...
  objectGetOwnPropertyDescriptor.f = DESCRIPTORS$B ? $getOwnPropertyDescriptor$2 : function getOwnPropertyDescriptor(O, P) {
    ...
    if (hasOwn$t(O, P)) return createPropertyDescriptor$8(!call$B(propertyIsEnumerableModule$2.f, O, P), O[P]);
  };
  ...
  var v8PrototypeDefineBug = DESCRIPTORS$A && fails$U(function () {
    // eslint-disable-next-line es/no-object-defineproperty -- required for testing
  ...
  var createNonEnumerableProperty$e = DESCRIPTORS$y ? function (object, key, value) {
  ...
  var CONFIGURABLE = EXISTS && (!DESCRIPTORS$x || (DESCRIPTORS$x && getDescriptor(FunctionPrototype$1, 'name').configurable));
  ...
  var CONFIGURABLE_LENGTH = DESCRIPTORS$w && !fails$T(function () {
  ...
  var makeBuiltIn$2 = makeBuiltIn$3.exports = function (value, name, options) {
    ...
    if (!hasOwn$q(value, 'name') || (CONFIGURABLE_FUNCTION_NAME$2 && value.name !== name)) {
      if (DESCRIPTORS$w) defineProperty$b(value, 'name', { value: name, configurable: true });
    ...
    try {
      if (options && hasOwn$q(options, 'constructor') && options.constructor) {
        if (DESCRIPTORS$w) defineProperty$b(value, 'prototype', { writable: false });
  ...
  var isForced$5 = function (feature, detection) {
    ...
    return value === POLYFILL ? true
      : value === NATIVE ? false
      : isCallable$m(detection) ? fails$S(detection)
      : !!detection;
  };
  ...
  */
  ...
  var bind$d = uncurryThis$Q(uncurryThis$Q.bind);
  ...
  var setSymbolDescriptor = DESCRIPTORS$u && fails$Q(function () {
  ...
  var $defineProperties = function defineProperties(O, Properties) {
    ...
    $forEach$2(keys, function (key) {
      if (!DESCRIPTORS$u || call$z($propertyIsEnumerable$1, properties, key)) $defineProperty(O, key, properties[key]);
    });
    return O;
  };
  ...
  if (!NATIVE_SYMBOL$5) {
    $Symbol = function Symbol() {
      ...
      var setter = function (value) {
        ...
        if ($this === ObjectPrototype$4) call$z(setter, ObjectPrototypeSymbols, value);
  ...
  $$1l({ global: true, constructor: true, wrap: true, forced: !NATIVE_SYMBOL$5, sham: !NATIVE_SYMBOL$5 }, {
    Symbol: $Symbol
  });
  ...
  $$1l({ target: SYMBOL, stat: true, forced: !NATIVE_SYMBOL$5 }, {
    useSetter: function () { USE_SETTER = true; },
    useSimple: function () { USE_SETTER = false; }
  });

  $$1l({ target: 'Object', stat: true, forced: !NATIVE_SYMBOL$5, sham: !DESCRIPTORS$u }, {
    // `Object.create` method
    // https://tc39.es/ecma262/#sec-object.create
    create: $create,
    // `Object.defineProperty` method
  ...
  $$1l({ target: 'Object', stat: true, forced: !NATIVE_SYMBOL$5 }, {
    // `Object.getOwnPropertyNames` method
    // https://tc39.es/ecma262/#sec-object.getownpropertynames
  ...
  $$1k({ target: 'Symbol', stat: true, forced: !NATIVE_SYMBOL_REGISTRY$1 }, {
    'for': function (key) {
  ...
  $$1j({ target: 'Symbol', stat: true, forced: !NATIVE_SYMBOL_REGISTRY }, {
  ...
  var call$y = FunctionPrototype.call;

  // eslint-disable-next-line es/no-reflect -- safe
  var functionApply = typeof Reflect == 'object' && Reflect.apply || (NATIVE_BIND$1 ? call$y.bind(apply$8) : function () {
    return call$y.apply(apply$8, arguments);
  });
  ...
  var getJsonReplacerFunction = function (replacer) {
    ...
    for (var i = 0; i < rawLength; i++) {
      ...
      else if (typeof element == 'number' || classof$e(element) === 'Number' || classof$e(element) === 'String') push$b(keys, toString$n(element));
    }
  ...
  var charCodeAt$3 = uncurryThis$L(''.charCodeAt);
  ...
  var WRONG_SYMBOLS_CONVERSION = !NATIVE_SYMBOL$3 || fails$P(function () {
  ...
  var stringifyWithSymbolsFix = function (it, replacer) {
    ...
    args[1] = function (key, value) {
      ...
      if (isCallable$i($replacer)) value = call$x($replacer, this, $String$1(key), value);
  ...
  if ($stringify) {
    ...
    $$1i({ target: 'JSON', stat: true, arity: 3, forced: WRONG_SYMBOLS_CONVERSION || ILL_FORMED_UNICODE }, {
      // eslint-disable-next-line no-unused-vars -- required for `.length`
  ...
  var FORCED$g = !NATIVE_SYMBOL$2 || fails$O(function () { getOwnPropertySymbolsModule$1.f(1); });

  // `Object.getOwnPropertySymbols` method
  // https://tc39.es/ecma262/#sec-object.getownpropertysymbols
  $$1h({ target: 'Object', stat: true, forced: FORCED$g }, {
  ...
  if (DESCRIPTORS$t && isCallable$h(NativeSymbol) && (!('description' in SymbolPrototype) ||
    // Safari 12 bug
    ...
    $$1g({ global: true, constructor: true, forced: true }, {
  ...
  var functionUncurryThisAccessor = function (object, key, method) {
    try {
      // eslint-disable-next-line es/no-object-getownpropertydescriptor -- safe
      return uncurryThis$J(aCallable$k(Object.getOwnPropertyDescriptor(object, key)[method]));
    } catch (error) { /* empty */ }
  };
  ...
  var wrapErrorConstructorWithCause$1 = function (FULL_NAME, wrapper, FORCED, IS_AGGREGATE_ERROR) {
    ...
    } else if (DESCRIPTORS$s && STACK_TRACE_LIMIT in OriginalError) {
  ...
  var exportGlobalErrorCauseWrapper = function (ERROR_NAME, wrapper) {
    ...
    $$1f({ global: true, constructor: true, arity: 1, forced: FORCED$f }, O);
  };
  ...
  var exportWebAssemblyErrorCauseWrapper = function (ERROR_NAME, wrapper) {
    if (WebAssembly && WebAssembly[ERROR_NAME]) {
      ...
      $$1f({ target: WEB_ASSEMBLY, stat: true, constructor: true, arity: 1, forced: FORCED$f }, O);
    }
  };
  ...
  var createProperty$7 = function (object, key, value) {
    if (DESCRIPTORS$r) definePropertyModule$2.f(object, key, createPropertyDescriptor$4(0, value));
  ...
  $$1e({ target: 'Array', proto: true, arity: 1, forced: FORCED$e }, {
    // eslint-disable-next-line no-unused-vars -- required for `.length`
  ...
  var getIterator$4 = function (argument, usingIterator) {
    ...
    if (aCallable$j(iteratorMethod)) return anObject$r(call$v(iteratorMethod, argument));
  ...
  var NEW_ITERATOR_PROTOTYPE = !isObject$i(IteratorPrototype$4) || fails$H(function () {
    var test = {};
  ...
  var SILENT_ON_NON_WRITABLE_LENGTH_SET = DESCRIPTORS$p && !function () {
  ...
  var push$a = uncurryThis$G(test.push);
  ...
  var slice$5 = ArrayBufferPrototype$4 && uncurryThis$F(ArrayBufferPrototype$4.slice);
  ...
  if (DESCRIPTORS$o && !('detached' in ArrayBufferPrototype$3)) {
  ...
  var slice$4 = uncurryThis$E(ArrayBufferPrototype$2.slice);
  ...
  var getInt8 = uncurryThis$E(DataViewPrototype$1.getInt8);
  ...
  setToStringTag$8(globalThis$y.JSON, 'JSON', true);
  ...
  var onFreeze = function (it) {
    if (FREEZING$1 && REQUIRED && isExtensible$1(it) && !hasOwn$f(it, METADATA)) setMetadata(it);
    return it;
  };
  ...
  var collection$3 = function (CONSTRUCTOR_NAME, wrapper, common) {
    ...
    var REPLACE = isForced$3(
      CONSTRUCTOR_NAME,
      !isCallable$c(NativeConstructor) || !(IS_WEAK || NativePrototype.forEach && !fails$A(function () {
    ...
    $$W({ global: true, constructor: true, forced: Constructor !== NativeConstructor }, exported);
  ...
  var setSpecies$4 = function (CONSTRUCTOR_NAME) {
    ...
    if (DESCRIPTORS$n && Constructor && !Constructor[SPECIES$3]) {
  ...
  var collectionStrong$2 = {
    getConstructor: function (wrapper, CONSTRUCTOR_NAME, IS_MAP, ADDER) {
      ...
      if (DESCRIPTORS$m) defineBuiltInAccessor$a(Prototype, 'size', {
        configurable: true,
        get: function () {
  ...
  // https://tc39.es/ecma262/#sec-date.prototype-@@toprimitive
  if (!hasOwn$e(DatePrototype, TO_PRIMITIVE)) {
  ...
  var createMethod$3 = function (TYPE) {
    return function ($this) {
      var string = toString$j(requireObjectCoercible$9($this));
  ...
  var NUMBER = 'Number';
  var NativeNumber = globalThis$w[NUMBER];
  path[NUMBER];
  var NumberPrototype = NativeNumber.prototype;
  var TypeError$5 = globalThis$w.TypeError;
  ...
  var calledWithNew = function (dummy) {
    ...
    return isPrototypeOf$4(NumberPrototype, dummy) && fails$z(function () { thisNumberValue(dummy); });
  };
  ...
  $$U({ global: true, constructor: true, wrap: true, forced: FORCED$8 }, {
    Number: NumberWrapper
  });

  // Use `internal/copy-constructor-properties` helper in `core-js@4`
  var copyConstructorProperties$1 = function (target, source) {
    for (var keys = DESCRIPTORS$l ? getOwnPropertyNames$3(source) : (
      // ES3:
      ...
      if (hasOwn$d(source, key = keys[j]) && !hasOwn$d(target, key)) {
        defineProperty$3(target, key, getOwnPropertyDescriptor$4(source, key));
      }
    }
  };
  ...
  var objectAssign = !$assign || fails$y(function () {
    ...
    if (DESCRIPTORS$k && $assign({ b: 1 }, $assign(defineProperty$2({}, 'a', {
      enumerable: true,
      get: function () {
    ...
    while (argumentsLength > index) {
      ...
      while (length > j) {
        key = keys[j++];
        if (!DESCRIPTORS$k || call$r(propertyIsEnumerable, S, key)) T[key] = S[key];
      }
    } return T;
  } : $assign;
  ...
  // https://tc39.es/ecma262/#sec-object.defineproperties
  // eslint-disable-next-line es/no-object-defineproperties -- safe
  $$S({ target: 'Object', stat: true, forced: Object.defineProperties !== defineProperties, sham: !DESCRIPTORS$j }, {
    defineProperties: defineProperties
  });
  ...
  // https://tc39.es/ecma262/#sec-object.defineproperty
  // eslint-disable-next-line es/no-object-defineproperty -- safe
  $$R({ target: 'Object', stat: true, forced: Object.defineProperty !== defineProperty$1, sham: !DESCRIPTORS$i }, {
  ...
  var IE_BUG = DESCRIPTORS$h && fails$x(function () {
    // eslint-disable-next-line es/no-object-create -- safe
  ...
  var FORCED$7 = !DESCRIPTORS$g || fails$w(function () { nativeGetOwnPropertyDescriptor$1(1); });

  // `Object.getOwnPropertyDescriptor` method
  // https://tc39.es/ecma262/#sec-object.getownpropertydescriptor
  $$P({ target: 'Object', stat: true, forced: FORCED$7, sham: !DESCRIPTORS$g }, {
  ...
  var FAILS_ON_PRIMITIVES$2 = fails$v(function () { return !Object.getOwnPropertyNames(1); });
  ...
  var FAILS_ON_PRIMITIVES$1 = fails$u(function () { nativeKeys(1); });
  ...
  var FAILS_ON_PRIMITIVES = fails$t(function () { nativeGetPrototypeOf(1); });

  // `Object.getPrototypeOf` method
  // https://tc39.es/ecma262/#sec-object.getprototypeof
  $$L({ target: 'Object', stat: true, forced: FAILS_ON_PRIMITIVES, sham: !CORRECT_PROTOTYPE_GETTER }, {
  ...
  var toString$i = objectToString;

  // `Object.prototype.toString` method
  // https://tc39.es/ecma262/#sec-object.prototype.tostring
  if (!TO_STRING_TAG_SUPPORT) {
    defineBuiltIn$b(Object.prototype, 'toString', toString$i, { unsafe: true });
  }
  ...
  var FORCED$6 = 1 / $parseFloat$1(whitespaces$1 + '-0') !== -Infinity
    ...
    || (ITERATOR$6 && !fails$s(function () { $parseFloat$1(Object(ITERATOR$6)); }));

  // `parseFloat` method
  // https://tc39.es/ecma262/#sec-parsefloat-string
  var numberParseFloat = FORCED$6 ? function parseFloat(string) {
    var trimmedString = trim$1(toString$h(string));
  ...
  // `parseFloat` method
  // https://tc39.es/ecma262/#sec-parsefloat-string
  $$J({ global: true, forced: parseFloat !== $parseFloat }, {
  ...
  var hex = /^[+-]?0x/i;
  var exec$7 = uncurryThis$v(hex.exec);
  var FORCED$5 = $parseInt$3(whitespaces + '08') !== 8 || $parseInt$3(whitespaces + '0x16') !== 22
    // MS Edge 18- broken with boxed symbols
    || (ITERATOR$5 && !fails$r(function () { $parseInt$3(Object(ITERATOR$5)); }));

  // `parseInt` method
  // https://tc39.es/ecma262/#sec-parseint-string-radix
  var numberParseInt = FORCED$5 ? function parseInt(string, radix) {
    var S = trim(toString$g(string));
  ...
  // `parseInt` method
  // https://tc39.es/ecma262/#sec-parseint-string-radix
  $$I({ global: true, forced: parseInt !== $parseInt$2 }, {
    parseInt: $parseInt$2
  });
  ...
  var speciesConstructor$4 = function (O, defaultConstructor) {
    ...
    var S;
    return C === undefined || isNullOrUndefined$5(S = anObject$o(C)[SPECIES$2]) ? defaultConstructor : aConstructor$2(S);
  };
  ...
  var set$2 = globalThis$t.setImmediate;
  ...
  var isThenable = function (it) {
    var then;
    return isObject$d(it) && isCallable$9(then = it.then) ? then : false;
  };
  ...
  var onUnhandled = function (state) {
    call$q(task, globalThis$o, function () {
  ...
  var NON_GENERIC = !!NativePromiseConstructor && fails$p(function () {
  ...
  $$A({ target: 'Promise', proto: true, real: true, forced: NON_GENERIC }, {
    'finally': function (onFinally) {
      var C = speciesConstructor$2(this, getBuiltIn$4('Promise'));
  ...
  function get$1(target, propertyKey /* , receiver */) {
    ...
    if (isObject$b(prototype = getPrototypeOf$4(target))) return get$1(prototype, propertyKey, receiver);
  }
  ...
  function set$1(target, propertyKey, V /* , receiver */) {
    ...
    var ownDescriptor = getOwnPropertyDescriptorModule$1.f(anObject$l(target), propertyKey);
    var existingDescriptor, prototype, setter;
    if (!ownDescriptor) {
      if (isObject$a(prototype = getPrototypeOf$3(target))) {
  ...
  $$x({ target: 'Reflect', stat: true, forced: MS_EDGE_BUG }, {
    set: set$1
  });
  ...
  setToStringTag$4(globalThis$n.Reflect, 'Reflect', true);
  ...
  var regexpGetFlags = function (R) {
    var flags = R.flags;
    return flags === undefined && !('flags' in RegExpPrototype$5) && !hasOwn$a(R, 'flags') && isPrototypeOf$3(RegExpPrototype$5, R)
  ...
  var exec$6 = uncurryThis$u(RegExpPrototype$4.exec);
    ...
    for (; index <= length; index++) {
      ...
      if (chr === '\\') {
        ...
        case chr === '(':
          ...
          if (exec$6(IS_NCG, stringSlice$8(string, index + 1))) {
            index += 2;
            ncg = true;
          }
          groupid++;
  ...
  $$v({ target: 'Reflect', stat: true, forced: FORCED$4, sham: FORCED$4 }, {
    construct: function construct(Target, args /* , newTarget */) {
      ...
      var instance = create$4(isObject$7(proto) ? proto : ObjectPrototype$2);
  ...
  $$u({ target: 'RegExp', proto: true, forced: /./.exec !== exec$5 }, {
    exec: exec$5
  });
  ...
  var setHelpers = {
    // eslint-disable-next-line es/no-set -- safe
    Set: Set,
    add: uncurryThis$r(SetPrototype$1.add),
    has: uncurryThis$r(SetPrototype$1.has),
    remove: uncurryThis$r(SetPrototype$1['delete']),
  ...
  var forEach$4 = uncurryThis$q(SetPrototype.forEach);
  var keys = uncurryThis$q(SetPrototype.keys);
  ...
  SetRecord.prototype = {
    getIterator: function () {
      return getIteratorDirect$8(anObject$g(call$g(this.keys, this.set)));
    },
  ...
  var slice$3 = uncurryThis$o(''.slice);
  var min$5 = Math.min;
  ...
  $$k({ target: 'String', proto: true, forced: !MDN_POLYFILL_BUG$1 && !CORRECT_IS_REGEXP_LOGIC$1 }, {
    endsWith: function endsWith(searchString /* , endPosition = @length */) {
      var that = toString$b(requireObjectCoercible$7(this));
  ...
  fixRegExpWellKnownSymbolLogic$1('search', function (SEARCH, nativeSearch, maybeCallNative) {
    return [
      ...
      function search(regexp) {
        ...
        return searcher ? call$b(searcher, regexp, O) : new RegExp(regexp)[SEARCH](toString$5(O));
      },
    ...
    return [
      ...
      function split(separator, limit) {
        ...
        return splitter
          ...
          : call$a(internalSplit, toString$4(O), separator, limit);
      },
  ...
  var Int8Array$4 = globalThis$i.Int8Array;
  var Int8ArrayPrototype$1 = Int8Array$4 && Int8Array$4.prototype;
  var Uint8ClampedArray$1 = globalThis$i.Uint8ClampedArray;
  ...
  var TypeError$3 = globalThis$i.TypeError;

  var TO_STRING_TAG$2 = wellKnownSymbol$6('toStringTag');
  var TYPED_ARRAY_TAG$1 = uid('TYPED_ARRAY_TAG');
  var TYPED_ARRAY_CONSTRUCTOR = 'TypedArrayConstructor';
  // Fixing native typed arrays in Opera Presto crashes the browser, see #595
  var NATIVE_ARRAY_BUFFER_VIEWS$2 = NATIVE_ARRAY_BUFFER$1 && !!setPrototypeOf$2 && classof$4(globalThis$i.opera) !== 'Opera';
  ...
  var exportTypedArrayMethod$s = function (KEY, property, forced, options) {
    ...
    if (forced) for (var ARRAY in TypedArrayConstructorsList) {
      var TypedArrayConstructor = globalThis$i[ARRAY];
  ...
  var exportTypedArrayStaticMethod = function (KEY, property, forced) {
    ...
    if (setPrototypeOf$2) {
      if (forced) for (ARRAY in TypedArrayConstructorsList) {
        TypedArrayConstructor = globalThis$i[ARRAY];
  ...
  if (!NATIVE_ARRAY_BUFFER_VIEWS$2 || !isCallable$3(TypedArray$1) || TypedArray$1 === Function.prototype) {
    ...
    if (NATIVE_ARRAY_BUFFER_VIEWS$2) for (NAME in TypedArrayConstructorsList) {
      if (globalThis$i[NAME]) setPrototypeOf$2(globalThis$i[NAME], TypedArray$1);
    }
  }
  ...
  if (!NATIVE_ARRAY_BUFFER_VIEWS$2 || !TypedArrayPrototype$2 || TypedArrayPrototype$2 === ObjectPrototype$1) {
    ...
    if (NATIVE_ARRAY_BUFFER_VIEWS$2) for (NAME in TypedArrayConstructorsList) {
      if (globalThis$i[NAME]) setPrototypeOf$2(globalThis$i[NAME].prototype, TypedArrayPrototype$2);
    }
  }
  ...
  if (DESCRIPTORS$a && !hasOwn$7(TypedArrayPrototype$2, TO_STRING_TAG$2)) {
    ...
    for (NAME in TypedArrayConstructorsList) if (globalThis$i[NAME]) {
      createNonEnumerableProperty$5(globalThis$i[NAME], TYPED_ARRAY_TAG$1, NAME);
    }
  }
  ...
  var Int8Array$3 = globalThis$h.Int8Array;
  ...
  var NativeArrayBuffer = globalThis$g[ARRAY_BUFFER];
  ...
  var u$ArrayCopyWithin = uncurryThis$h($ArrayCopyWithin);
  ...
  var arrayValues = uncurryThis$f(ArrayIterators.values);
  var arrayKeys = uncurryThis$f(ArrayIterators.keys);
  var arrayEntries = uncurryThis$f(ArrayIterators.entries);
  ...
  var IteratorProxy = createIteratorProxy(function () {
    var iterator = this.iterator;
    var result = anObject$4(call$3(this.next, iterator));
  ...
  var JSON$1 = globalThis$7.JSON;
  var Number$1 = globalThis$7.Number;
