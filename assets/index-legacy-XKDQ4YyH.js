    ...
    `;
        ...
        function borderAccessor() {
          ...
          return {
            set: function set(value) {
              ...
              this.effects = this.effects ? _objectSpread(_objectSpread({}, this.effects || {}), _defineProperty({}, `border${direction}`, value)) : _defineProperty({}, `border${direction}`, value);
            },
            get: function get() {
              var _this$effects;
        ...
        var Grid = lazy(function () {
          return __vitePreload(function () {
            return module.import('./Grid-legacy-Cw3I_ciO.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var Portal = lazy(function () {
          return __vitePreload(function () {
            return module.import('./Portal-legacy-4aAc_A47.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var TextPage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./Text-legacy-C3OOnvB8.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var CreatePage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./Create-legacy-aMpVb83Z.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var ViewportPage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./Viewport-legacy-d6yisyG7.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var ButtonsPage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./Buttons-legacy-BypTcccL.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var FlexPage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./Flex-legacy-C-z7uV9J.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var FlexSizePage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./FlexSize-legacy-BK0pici8.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var FlexColumnSizePage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./FlexColumnSize-legacy-Brz2IzLK.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var FlexColumnPage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./FlexColumn-legacy-D0oQeltC.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var ButtonsMaterialPage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./ButtonsMaterial-legacy-CPtpMg_J.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var SuperFlexPage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./SuperFlex-legacy-Dx6cYtAx.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var Entity = lazy(function () {
          return __vitePreload(function () {
            return module.import('./Entity-legacy-CQYeqaI0.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var People = lazy(function () {
          return __vitePreload(function () {
            return module.import('./People-legacy-mJxEWtHx.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var LoginPage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./Login-legacy-BGkSq90S.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
...
//# sourceMappingURL=index-legacy-XKDQ4YyH.js.map
