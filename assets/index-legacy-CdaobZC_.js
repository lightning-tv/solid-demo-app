  ...
  System.register([], function (exports, module) {
              ...
              if (isCss) {
                return new Promise(function (res, rej) {
                  ...
                  link.addEventListener("error", function () {
                    return rej(new Error(`Unable to preload CSS for ${dep}`));
                  });
                });
              }
            }));
        ...
        var CoreNode = /*#__PURE__*/function (_EventEmitter4) {
          ...
          return _createClass(CoreNode, [{
            ...
            value: function updateRenderState() {
              var renderState = this.checkRenderBounds();
          ...
          function WebGlCoreShader(options) {
            ...
            requiredExtensions.forEach(function (extensionName) {
              if (!glw.getExtension(extensionName)) {
                throw new Error(`Shader "${_this17.constructor.name}" requires extension "${extensionName}" for WebGL ${glVersion} but wasn't found`);
              }
            });
            ...
            if (!shaderSources) {
              throw new Error(`Shader "${_this17.constructor.name}" is missing shaderSources.`);
            ...
            _toConsumableArray(options.attributes).forEach(function (attributeName) {
              ...
              if (location < 0) {
                throw new Error(`${_this17.constructor.name}: Vertex shader must have an attribute "${attributeName}"!`);
              }
              var buffer = glw.createBuffer();
              if (!buffer) {
                throw new Error(`${_this17.constructor.name}: Could not create buffer for attribute "${attributeName}"`);
              }
            ...
            options.uniforms.forEach(function (uniform) {
              ...
              if (!location) {
                console.warn(`Shader "${_this17.constructor.name}" could not get uniform location for "${uniform.name}"`);
                return;
              }
    ...
    `,
      ...
      vec4 sampleFromTexture(sampler2D textures[${textureUnits}], int idx, vec2 uv) {
        ${Array.from(Array(textureUnits).keys()).map(function (idx) {
              return `
  ...
  `);
            ...
            if (settings.debugLogging) {
              ...
              setInterval(function () {
                if (lastMemUse !== _this38.memUsed) {
                  ...
                  console.log(`[TextureMemoryManager] Memory used: ${bytesToMb$1(_this38.memUsed)} mb / ${bytesToMb$1(_this38.criticalThreshold)} mb (${(_this38.memUsed / _this38.criticalThreshold * 100).toFixed(1)}%)`);
                }
              }, 1000);
            }
        ...
        function santizeCustomDataMap(d) {
          ...
          for (var i = 0; i < keys.length; i++) {
            ...
            if (valueType === 'string' && value.length > 2048) {
              console.warn(`Custom Data value for ${_key30} is too long, it will be truncated to 2048 characters`);
            ...
            if (!validTypes[valueType]) {
              console.warn(`Custom Data value for ${_key30} is not a boolean, string, or number, it will be ignored`);
              delete d[_key30];
            }
          }
          return d;
                ...
                return _regeneratorRuntime().wrap(function _callee13$(_context14) {
                  while (1) switch (_context14.prev = _context14.next) {
                    ...
                    case 2:
                      ...
                      break;
                    case 14:
                      throw new Error(`Font metrics not found in ${_this53.type} font ${_this53.fontFamily}. ` + 'Make sure you are using the latest version of the Lightning ' + '3 `msdf-generator` tool to generate your SDF fonts.');
                    case 15:
                      _this53.checkLoaded();
                    case 16:
                    case "end":
        ...
        var States = /*#__PURE__*/function (_Array) {
          function States(callback) {
            ...
            if (isArray(initialState)) {
              ...
              _this54 = _callSuper(this, States, _toConsumableArray(Object.entries(initialState).filter(function (_ref28) {
    ...
    `;
        ...
        var ElementNode = /*#__PURE__*/function (_Object) {
          ...
          return _createClass(ElementNode, [{
            ...
            value: function render(topNode) {
              ...
              node.onEvents && node.onEvents.forEach(function (_ref33) {
        ...
        var Inspector = /*#__PURE__*/function () {
          ...
          return _createClass(Inspector, [{
            ...
            value: function createDiv(id, properties) {
              ...
              for (var _key43 in properties) {
                this.updateNodeProperty(div,
                // really typescript? really?
                _key43, properties[_key43]);
              }
              return div;
            }
          }, {
            ...
            value) {
              ...
              if (property === 'data') {
                for (var _key44 in value) {
                  // eslint-disable-next-line @typescript-eslint/no-unsafe-member-access
                  var keyValue = value[_key44];
                  if (keyValue === undefined) {
                    div.removeAttribute(`data-${_key44}`);
                  } else {
                    div.setAttribute(`data-${_key44}`, String(keyValue));
                  }
                }
                return;
              }
        ...
        function createMatcher(path, partial, matchFilters) {
          ...
          return function (location) {
            ...
            for (var i = 0; i < len; i++) {
              ...
              var _key45 = dynamic ? segment.slice(1) : segment;
              if (dynamic && matchSegment(locSegment, matchFilter(_key45))) {
                match.params[_key45] = locSegment;
        ...
        function createMemoObject(fn) {
          ...
          var keys = Object.keys(fn()); // Getting keys without Reflect
          keys.forEach(function (key) {
        ...
        var debounce = function debounce(callback, wait) {
          ...
          var debounced = function debounced() {
            for (var _len20 = arguments.length, args = new Array(_len20), _key46 = 0; _key46 < _len20; _key46++) {
        ...
        var throttle = function throttle(callback, wait) {
          ...
          var throttled = function throttled() {
            for (var _len21 = arguments.length, args = new Array(_len21), _key47 = 0; _key47 < _len21; _key47++) {
        ...
        function accessWith(valueOrFn) {
          for (var _len22 = arguments.length, args = new Array(_len22 > 1 ? _len22 - 1 : 0), _key48 = 1; _key48 < _len22; _key48++) {
            args[_key48 - 1] = arguments[_key48];
          }
        ...
        function createStaticStore(init) {
          ...
          var _loop11 = function _loop11(_key49) {
            Object.defineProperty(store, _key49, {
              get: function get() {
                return getValue(_key49);
              },
              enumerable: true
            });
          };
          for (var _key49 in init) {
            _loop11(_key49);
          }
        ...
        function chainFunctions() {
          for (var _len23 = arguments.length, args = new Array(_len23), _key51 = 0; _key51 < _len23; _key51++) {
          ...
          return function () {
            var result;
            for (var _len24 = arguments.length, innerArgs = new Array(_len24), _key52 = 0; _key52 < _len24; _key52++) {
        ...
        var Grid = lazy(function () {
          return __vitePreload(function () {
            return module.import('./Grid-legacy-HOvd4Q38.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var Portal = lazy(function () {
          return __vitePreload(function () {
            return module.import('./Portal-legacy-CXtVRyXF.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var TextPage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./Text-legacy-B2Blkotl.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var CreatePage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./Create-legacy-X9Y5q6B4.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var ViewportPage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./Viewport-legacy-DY3LmHxX.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var ButtonsPage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./Buttons-legacy-IDKWTupD.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var FlexPage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./Flex-legacy-bN-jW7dW.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var FlexSizePage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./FlexSize-legacy-CxvQkmml.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var FlexColumnSizePage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./FlexColumnSize-legacy-a9mdk4z2.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var FlexColumnPage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./FlexColumn-legacy-dVBUuBIu.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var ButtonsMaterialPage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./ButtonsMaterial-legacy-D-hPOyUX.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var SuperFlexPage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./SuperFlex-legacy-jzcg-_Us.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var Entity = lazy(function () {
          return __vitePreload(function () {
            return module.import('./Entity-legacy-D6hXeMGC.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var People = lazy(function () {
          return __vitePreload(function () {
            return module.import('./People-legacy-BVpgP1zJ.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var LoginPage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./Login-legacy-BmKclThx.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
...
//# sourceMappingURL=index-legacy-CdaobZC_.js.map
