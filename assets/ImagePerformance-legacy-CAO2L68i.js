    ...
    System.register([ "./index-legacy-BQB2da4P.js" ], function(exports, module) {
        ...
        return {
            ...
            execute: function execute() {
                var ImagePerformance = exports("default", function() {
                    ...
                    var fetchImages = function() {
                        var _ref = _asyncToGenerator(_regenerator().m(function _callee() {
                            var page1, page2, combined, newImages, _t;
                            return _regenerator().w(function(_context) {
                                while (1) switch (_context.p = _context.n) {
                                  ...
                                  case 1:
                                    page1 = _context.v;
                                    _context.n = 2;
                                    return api.get("/movie/popular?page=2");

                                  case 2:
                                    page2 = _context.v;
                                    combined = [].concat(_toConsumableArray(page1.results), _toConsumableArray(page2.results)).slice(0, 40);
                                    newImages = combined.map(function(item) {
                                        return {
                                            id: item.id,
                                            ...
                                            return createComponent(View, {
                                                ...
                                                onEvent: {
                                                    loaded: function loaded() {
                                                        return handleImageLoaded(index(), item.id);
                                                    }
                                                }
                                            });
                                        }
