...
function createWebGLContext(canvas2, forceWebGL2 = false, contextSpy) {
  ...
  const gl = (
    ...
    canvas2.getContext(forceWebGL2 ? "webgl2" : "webgl", config) || canvas2.getContext("experimental-webgl", config)
  );
  if (!gl) {
...
function dataURIToBlob(dataURI) {
  ...
  return new Blob(byteArrays, { type: type2 });
}
...
class CoreNode extends EventEmitter {
  ...
  updateIsRenderable() {
    ...
    if (this.texture !== null) {
      ...
      // check shader
      (this.props.shader !== null || this.hasColorProps === true) && // check dimensions
  ...
  calculateClippingRect(parentClippingRect) {
    const { clippingRect, props: props2, globalTransform: gt } = this;
    const { clipping } = props2;
  ...
  renderQuads(renderer2) {
    if (this.parentHasRenderTexture === true) {
      ...
      if (rtt === false || this.parentRenderTexture !== renderer2.activeRttNode)
        return;
    }
    const p = this.props;
...
class CoreShaderManager {
  constructor(stage) {
     ...
     */
    __publicField(this, "valuesCache", /* @__PURE__ */ new Map());
    __publicField(this, "valuesCacheUsage", /* @__PURE__ */ new Map());
...
class TextureMemoryManager {
  constructor(stage, settings) {
    ...
    __publicField(this, "targetThreshold", 0.5);
...
class Stage {
  ...
  constructor(options) {
    ...
    var _a;
    this.options = options;
    const { canvas: canvas2, clearColor, appWidth, appHeight, boundsMargin, enableContextSpy, forceWebGL2, numImageWorkers: numImageWorkers2, textureMemory, renderEngine, fontEngines, createImageBitmapSupport, platform, maxRetryCount } = options;
   ...
   */
  drawFrame() {
    const { renderer: renderer2, renderRequested, root } = this;
    this.txMemManager;
  ...
  resolveNodeDefaults(props2) {
    ...
    const pivot = (_p = props2.pivot) != null ? _p : 0.5;
...
class RendererMain extends EventEmitter {
  ...
  constructor(settings, target) {
    ...
    const { appWidth, appHeight, deviceLogicalPixelRatio: deviceLogicalPixelRatio2, devicePhysicalPixelRatio, inspector } = settings;
    let platform;
  ...
  resolveTxSettings(textureMemory) {
    ...
    return {
      ...
      targetThresholdLevel: (_d = (_c = textureMemory == null ? void 0 : textureMemory.targetThresholdLevel) != null ? _c : currentTxSettings == null ? void 0 : currentTxSettings.targetThresholdLevel) != null ? _d : 0.5,
  ...
  updateAppDimensions() {
    const { appWidth, appHeight, deviceLogicalPixelRatio: deviceLogicalPixelRatio2, devicePhysicalPixelRatio } = this.stage.options;
    const deviceLogicalWidth = appWidth * deviceLogicalPixelRatio2;
    const deviceLogicalHeight = appHeight * deviceLogicalPixelRatio2;
...
function resolveNodeDefaults(props2) {
  ...
  return {
    ...
    zIndex: (_z = props2.zIndex) != null ? _z : 0,
    zIndexLocked: (_A = props2.zIndexLocked) != null ? _A : 0,
    parent: (_B = props2.parent) != null ? _B : null,
    texture: (_C = props2.texture) != null ? _C : null,
    textureOptions: (_D = props2.textureOptions) != null ? _D : {},
    shader: (_E = props2.shader) != null ? _E : defaultShader,
    ...
    srcX: props2.srcX,
    srcY: props2.srcY,
    scale: (_G = props2.scale) != null ? _G : null,
    scaleX: (_I = (_H = props2.scaleX) != null ? _H : props2.scale) != null ? _I : 1,
    scaleY: (_K = (_J = props2.scaleY) != null ? _J : props2.scale) != null ? _K : 1,
    mount: (_L = props2.mount) != null ? _L : 0,
    mountX: (_N = (_M = props2.mountX) != null ? _M : props2.mount) != null ? _N : 0,
    mountY: (_P = (_O = props2.mountY) != null ? _O : props2.mount) != null ? _P : 0,
    pivot: (_Q = props2.pivot) != null ? _Q : 0.5,
    pivotX: (_S = (_R = props2.pivotX) != null ? _R : props2.pivot) != null ? _S : 0.5,
    pivotY: (_U = (_T = props2.pivotY) != null ? _T : props2.pivot) != null ? _U : 0.5,
    rotation: (_V = props2.rotation) != null ? _V : 0,
    rtt: (_W = props2.rtt) != null ? _W : false,
    data: {},
    imageType: props2.imageType
  };
}
...
function updateRootPosition() {
  var _a, _b, _c;
  let { canvas: canvas2, settings } = this;
...
class DOMRendererMain {
  ...
  createShader(shaderType, props2) {
    return { shaderType, props: props2, program: {} };
  }
  createTexture(textureType, props2) {
    ...
    return { type: type2, props: props2 };
  }
  on(name, callback) {
...
class ElementNode extends Object {
  ...
  set fontWeight(v) {
    var _a, _b;
    this._fontWeight = v;
    const family = this.fontFamily || ((_a = Config.fontSettings) == null ? void 0 : _a.fontFamily);
    const weight = (_b = Config.fontWeightAlias && Config.fontWeightAlias[v]) != null ? _b : v;
  ...
  chain(props2, animationSettings) {
    ...
    this._animationQueue.push({ props: props2, animationSettings });
    return this;
  }
  async start() {
  ...
  render(topNode) {
    ...
    if (isElementText(node)) {
      ...
      node.lng = renderer$2.createTextNode(
        props2
      );
      if (parent.requiresLayout()) {
...
const HolePunch = {
  ...
  update() {
    ...
    this.uniform2f("u_size", props2.w * 0.5, props2.h * 0.5);
...
const fontLoadPromises$1 = /* @__PURE__ */ new Map();
const normalizedMetrics$1 = /* @__PURE__ */ new Map();
const nodesWaitingForFont$1 = /* @__PURE__ */ Object.create(null);
...
const type$3 = "sdf";
const isFontLoaded$1 = (fontFamily) => {
...
const SdfFontHandler = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
...
class WebGlCtxTexture extends CoreContextTexture {
  ...
  async onLoadRequest() {
    ...
    if (typeof ImageBitmap !== "undefined" && tdata instanceof ImageBitmap || tdata instanceof ImageData || // not using typeof HTMLI mageElement due to web worker
    isHTMLImageElement(tdata) === true) {
      ...
      const { mipmaps, type: type2, blockInfo } = tdata;
  ...
  getTextureCoords(node) {
    ...
    if (resizeMode !== void 0 && resizeMode.type === "cover" && texture.dimensions !== null) {
      ...
      if (scaleX < scale) {
        ...
        x1 = (1 - desiredSize / dimensions.w) * ((_a = resizeMode.clipX) != null ? _a : 0.5);
        x2 = x1 + desiredSize / dimensions.w;
      }
      if (scaleY < scale) {
        const desiredSize = precision * node.props.h;
        y1 = (1 - desiredSize / dimensions.h) * ((_b = resizeMode.clipY) != null ? _b : 0.5);
...
const renderQuads$1 = (renderer2, layout, vertexBuffer, renderProps) => {
  ...
  const renderOp = new WebGlRenderOp(renderer2, {
    sdfShaderProps: {
      ...
      // Use proper font scaling in shader
...
const normalizedMetrics = /* @__PURE__ */ new Map();
const nodesWaitingForFont = /* @__PURE__ */ Object.create(null);
...
const CanvasFontHandler = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
...
const renderText = (props2) => {
  const { text, fontFamily, fontStyle, fontSize, textAlign, maxLines, lineHeight, verticalAlign, overflowSuffix, maxWidth, maxHeight, wordBreak } = props2;
...
const parsedArgbColors = /* @__PURE__ */ new Map();
const parsedRgbaColors = /* @__PURE__ */ new Map();
...
function makeEventListenerStack(target, options) {
  ...
  return [
    (type2, handler, overwriteOptions) => {
...
function createStaticStore(init2) {
  const copy = { ...init2 }, store = { ...init2 }, cache2 = {};
  const getValue = (key) => {
...
function HashRouter(props2) {
  ...
  return createRouter({
    ...
    utils: {
      ...
      beforeLeave,
      queryWrapper: props2.forceProxy || !SUPPORTS_PROXY ? (getQuery) => {
        return createMemoWithoutProxy(getQuery, props2.queryParams);
      } : void 0,
      paramsWrapper: props2.forceProxy || !SUPPORTS_PROXY ? (buildParams, branches) => {
...
function MarqueeText(props2) {
  ...
  const scrollGap = createMemo(() => {
    var _a;
    return (_a = props2.scrollGap) != null ? _a : props2.clipWidth * 0.5;
  });
...
function List(props2) {
  const fallback = "fallback" in props2 && { fallback: () => props2.fallback };
...
function createVirtual(component, props2, keyHandlers) {
  ...
  const uniformSize = createMemo(() => {
    return props2.uniformSize !== false;
  });
...
const styles$1 = {
  ...
  Thumbnail: {
    ...
    $focus: {
      scale: 1.1,
      border: { color: theme.primaryLight, width: 6, gap: 0 }
    },
    $hover: {
      scale: 1.07,
...
const Browse = (props2) => {
  ...
  const provider = createMemo(() => {
    return createInfiniteScroll(props2.data());
  });
...
const fetchPopular = (type2) => {
  return handleResults(api.get("/".concat(type2, "/popular")));
};
let genreListCache;
...
function getRecommendations({ type: type2, id }) {
  return api.get("/".concat(type2, "/").concat(id, "/recommendations")).then(({ results }) => {
    if (results.length) {
      return ensureItems(convertItemsToTiles(results.slice(0, 7)), 7);
    }
    return api.get("/trending/".concat(type2, "/week?page=1")).then(
      ({ results: results2 }) => ensureItems(convertItemsToTiles(results2.slice(0, 7)), 7)
    );
  });
}
function getCredits({ type: type2, id }) {
  return api.get("/".concat(type2, "/").concat(id, "/credits")).then(({ cast }) => ensureItems(convertItemsToTiles(cast.slice(0, 7)), 7));
}
function getInfo({ type: type2, id }) {
  let rt = type2 === "movie" ? {
    rtCrit: 86,
    rtFan: 92
  } : {};
...
const RoundedWithBorder = {
  ...
  update(node) {
    ...
    const outerRadius = [
      Math.max(0, contentRadius[0] + borderGap + Math.max(bTop, bLeft)),
      // top-left
      Math.max(0, contentRadius[1] + borderGap + Math.max(bTop, bRight)),
      // top-right
      Math.max(0, contentRadius[2] + borderGap + Math.max(bBottom, bRight)),
      // bottom-right
      Math.max(0, contentRadius[3] + borderGap + Math.max(bBottom, bLeft))
      // bottom-left
    ];
    this.uniform4fa(
      "u_radius",
...
const Player = lazy(() => __vitePreload(() => import("./Player-P5AAjEEK.js"), true ? [] : void 0));
const Grid = lazy(() => __vitePreload(() => import("./Grid-CZ-v9JER.js"), true ? [] : void 0));
const Loops = lazy(() => __vitePreload(() => import("./Loops-DBBoz6s9.js"), true ? [] : void 0));
const Infinite = lazy(() => __vitePreload(() => import("./Infinite-Dxn7km5X.js"), true ? [] : void 0));
const TMDBGrid = lazy(() => __vitePreload(() => import("./TMDBGrid-CVExEGQI.js"), true ? [] : void 0));
const Portal = lazy(() => __vitePreload(() => import("./Portal-CHswanx6.js"), true ? [] : void 0));
const MatrixPage = lazy(() => __vitePreload(() => import("./Matrix-Cc9rVrRF.js"), true ? [] : void 0));
const TextPage = lazy(() => __vitePreload(() => import("./Text-BImeUmGf.js"), true ? [] : void 0));
const TextPosterPage = lazy(() => __vitePreload(() => import("./TextPoster-DUv1tkHw.js"), true ? [] : void 0));
const CreatePage = lazy(() => __vitePreload(() => import("./Create-CAC91G-8.js"), true ? [] : void 0));
const ViewportPage = lazy(() => __vitePreload(() => import("./Viewport-D_EBHrGk.js"), true ? [] : void 0));
const PositioningPage = lazy(() => __vitePreload(() => import("./Positioning-Mify9B4W.js"), true ? [] : void 0));
const LayoutPage = lazy(() => __vitePreload(() => import("./Layout-fPWa4Bjv.js"), true ? [] : void 0));
const FocusBasicsPage = lazy(() => __vitePreload(() => import("./FocusBasics-xYXeUYqm.js"), true ? [] : void 0));
const KeyHandlingPage = lazy(() => __vitePreload(() => import("./KeyHandling-DYO0edOd.js"), true ? [] : void 0));
const TransitionsPage = lazy(() => __vitePreload(() => import("./Transitions-CS914QC6.js"), true ? [] : void 0));
const ComponentsPage = lazy(() => __vitePreload(() => import("./Components-DkozoyWy.js"), true ? [] : void 0));
const FocusHandlingPage = lazy(() => __vitePreload(() => import("./FocusHandling-BF7oFYSc.js"), true ? [] : void 0));
const GradientsPage = lazy(() => __vitePreload(() => import("./Gradients-DrOhVARW.js"), true ? [] : void 0));
const FlexPage = lazy(() => __vitePreload(() => import("./Flex-cfALTZi6.js"), true ? [] : void 0));
const FlexGrowPage = lazy(() => __vitePreload(() => import("./FlexGrow-CIpCHAsq.js"), true ? [] : void 0));
const FlexMenuPage = lazy(() => __vitePreload(() => import("./FlexMenu--9m1i-Sq.js"), true ? [] : void 0));
const FlexSizePage = lazy(() => __vitePreload(() => import("./FlexSize-CJ2uD7Vj.js"), true ? [] : void 0));
const FlexColumnSizePage = lazy(() => __vitePreload(() => import("./FlexColumnSize-BTmY6hSD.js"), true ? [] : void 0));
const FlexColumnPage = lazy(() => __vitePreload(() => import("./FlexColumn-C2sMWLF0.js"), true ? [] : void 0));
const ButtonsMaterialPage = lazy(() => __vitePreload(() => import("./ButtonsMaterial-rShlF6Yy.js"), true ? [] : void 0));
const SuperFlexPage = lazy(() => __vitePreload(() => import("./SuperFlex-BvLQv2nv.js"), true ? [] : void 0));
const Entity = lazy(() => __vitePreload(() => import("./Entity-B9OldEFL.js"), true ? [] : void 0));
const People = lazy(() => __vitePreload(() => import("./People-mvL7ZxSV.js"), true ? [] : void 0));
const FireboltPage = lazy(() => __vitePreload(() => import("./Firebolt-u_joNU1E.js"), true ? [] : void 0));
const LoginPage = lazy(() => __vitePreload(() => import("./Login-ToxiHBTR.js"), true ? [] : void 0));
const VirtualPage = lazy(() => __vitePreload(() => import("./Virtual-C0n9Sc4g.js"), true ? [] : void 0));
const TagsPage = lazy(() => __vitePreload(() => import("./Tags-BZ6yxlNe.js"), true ? [] : void 0));
        ...
        return [createComponent(Route, {
          ...
          get children() {
            return [createComponent(Route, {
              ...
              path: "nested",
              get component() {
                return lazy(() => __vitePreload(() => import("./Nested-DD7gqqm_.js"), true ? [] : void 0));
              }
            }), createComponent(Route, {
              path: "textposter",
              ...
              path: "keepalive",
              get component() {
                return lazy(() => __vitePreload(() => import("./KeepAlive-DIPP21En.js"), true ? [] : void 0));
              }
            }), createComponent(Route, {
              path: "suspense",
              get component() {
                return lazy(() => __vitePreload(() => import("./suspense-CcMUCgbb.js"), true ? [] : void 0));
              }
            }), createComponent(Route, {
              path: "superflex",
