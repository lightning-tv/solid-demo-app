...
(function () {
  ...
  System.register(['./index-legacy-B0YqatHW.js', './Button-legacy-C09y2T3l.js'], function (exports, module) {
    'use strict';

    var ElementNode, assertTruthy, createComponent, View, mergeProps, memo, combineStyles, styles, createSignal, createMemo, createEffect, on, styles$1, Text, styles$2, styles$3, styles$4, For, Show, onMount, Column$1, setGlobalBackground, ButtonContainer;
    return {
