...
(function () {
  ...
  System.register(['./index-legacy-Cg-6IaHl.js', './Button-legacy-Iqtqg-3h.js'], function (exports, module) {
    'use strict';

    var createSignal, createMemo, createEffect, on, createComponent, View, mergeProps, combineStyles, styles, Text, styles$1, styles$2, For, Show, Column, Row, onMount, setGlobalBackground, ButtonContainer;
    return {
          ...
          return createComponent(View, mergeProps(props, {
            ...
            get children() {
              return createComponent(Text, {
                ...
                get style() {
                  var _props$tone3;
                  return combineStyles(styles.Text.tones[(_props$tone3 = props.tone) !== null && _props$tone3 !== void 0 ? _props$tone3 : styles.tone],
                  //
                  styles.Text.base);
                },
                get children() {
          ...
          return createComponent(ButtonContainer, mergeProps(props, {
            ...
            get children() {
              return createComponent(Text, {
                ...
                get style() {
                  return combineStyles(styles$1.Text.tones[tone()],
                  //
                  styles$1.Text.base);
                },
                get children() {
