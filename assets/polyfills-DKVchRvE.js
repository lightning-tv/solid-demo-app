...
var toLength$6 = function (argument) {
  var len = toIntegerOrInfinity$9(argument);
...
var exportGlobalErrorCauseWrapper = function (ERROR_NAME, wrapper) {
  ...
  $$H({ global: true, constructor: true, arity: 1, forced: FORCED$5 }, O);
};
...
var exportWebAssemblyErrorCauseWrapper = function (ERROR_NAME, wrapper) {
  if (WebAssembly && WebAssembly[ERROR_NAME]) {
    ...
    $$H({ target: WEB_ASSEMBLY, stat: true, constructor: true, arity: 1, forced: FORCED$5 }, O);
  }
};
...
var environment = (function () {
  ...
  if (classof$c(globalThis$u.process) === 'process') return 'NODE';
...
var nativeReverse = uncurryThis$v([].reverse);
var test$1 = [1, 2];
...
var arraySlice$5 = uncurryThis$u([].slice);
...
var fill = uncurryThis$r(arrayFill);
var reverse = uncurryThis$r([].reverse);
...
if (!NATIVE_ARRAY_BUFFER$1) {
  ...
  var $setInt8 = uncurryThis$r(DataViewPrototype$2.setInt8);
...
var exec$7 = uncurryThis$q(constructorRegExp.exec);
...
var speciesConstructor$3 = function (O, defaultConstructor) {
  ...
  var S;
  return C === undefined || isNullOrUndefined$2(S = anObject$k(C)[SPECIES$4]) ? defaultConstructor : aConstructor$1(S);
};
...
var setSpecies$3 = function (CONSTRUCTOR_NAME) {
  ...
  if (DESCRIPTORS$e && Constructor && !Constructor[SPECIES$3]) {
    defineBuiltInAccessor$8(Constructor, SPECIES$3, {
      configurable: true,
