(function () {
  ...
  var ie8DomDefine = !DESCRIPTORS$A && !fails$T(function () {
    // eslint-disable-next-line es/no-object-defineproperty -- required for testing
  ...
  var v8PrototypeDefineBug = DESCRIPTORS$y && fails$S(function () {
    // eslint-disable-next-line es/no-object-defineproperty -- required for testing
  ...
  var CONFIGURABLE_LENGTH = DESCRIPTORS$u && !fails$R(function () {
  ...
  var isForced$5 = function (feature, detection) {
    ...
    return value === POLYFILL ? true
      : value === NATIVE ? false
      : isCallable$m(detection) ? fails$Q(detection)
      : !!detection;
  };
  ...
  */
  ...
  var setSymbolDescriptor = DESCRIPTORS$s && fails$O(function () {
  ...
  var $defineProperties = function defineProperties(O, Properties) {
    ...
    $forEach$2(keys, function (key) {
      if (!DESCRIPTORS$s || call$x($propertyIsEnumerable$1, properties, key)) $defineProperty(O, key, properties[key]);
    });
    return O;
  };
  ...
  var FORCED$e = !NATIVE_SYMBOL$2 || fails$M(function () { getOwnPropertySymbolsModule$1.f(1); });
  ...
  var createProperty$8 = function (object, key, value) {
    if (DESCRIPTORS$p) definePropertyModule$1.f(object, key, createPropertyDescriptor$3(0, value));
  ...
  var NEW_ITERATOR_PROTOTYPE = !isObject$i(IteratorPrototype$4) || fails$F(function () {
    var test = {};
  ...
  var FAILS_ON_PRIMITIVES$4 = fails$A(function () { $isExtensible(1); });
  ...
  var collection$3 = function (CONSTRUCTOR_NAME, wrapper, common) {
    ...
    var REPLACE = isForced$3(
      CONSTRUCTOR_NAME,
      !isCallable$c(NativeConstructor) || !(IS_WEAK || NativePrototype.forEach && !fails$y(function () {
  ...
  var objectAssign = !$assign || fails$w(function () {
    ...
    while (argumentsLength > index) {
      ...
      while (length > j) {
        key = keys[j++];
        if (!DESCRIPTORS$i || call$p(propertyIsEnumerable, S, key)) T[key] = S[key];
      }
    } return T;
  } : $assign;
  ...
  var IE_BUG = DESCRIPTORS$h && fails$v(function () {
    // eslint-disable-next-line es/no-object-create -- safe
  ...
  var FAILS_ON_PRIMITIVES$3 = fails$u(function () { $freeze(1); });
  ...
  var FORCED$5 = !DESCRIPTORS$g || fails$t(function () { nativeGetOwnPropertyDescriptor$1(1); });
  ...
  var FAILS_ON_PRIMITIVES$2 = fails$s(function () { return !Object.getOwnPropertyNames(1); });
  ...
  var FAILS_ON_PRIMITIVES = fails$q(function () { nativeGetPrototypeOf(1); });
