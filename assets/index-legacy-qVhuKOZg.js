        ...
        class SdfTrFontFace extends TrFontFace {
          constructor(type, options) {
            ...
            fetch(atlasDataUrl).then( /*#__PURE__*/function () {
              var _ref24 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee14(response) {
    ...
    `;
        ...
        function createResource(pSource, pFetcher, pOptions) {
          ...
          var contexts = new Set(),
            _ref25 = (options.storage || createSignal)(options.initialValue),
        ...
        function withScrolling(isRow) {
          ...
          return (componentRef, selectedElement, selected = 0, lastSelected) => {
            var _ref28, _componentRef$_target, _componentRef$offset, _selectedElement$axis, _selectedElement$dime;
            if (!componentRef.children.length) return;
            var gap = componentRef.gap || 0;
            var scroll = componentRef.scroll || "auto";
            var rootPosition = (_ref28 = (_componentRef$_target = componentRef._targetPosition) !== null && _componentRef$_target !== void 0 ? _componentRef$_target : componentRef[axis]) !== null && _ref28 !== void 0 ? _ref28 : 0;
        ...
        var Grid = lazy(() => __vitePreload(() => module.import('./Grid-legacy-XQLfBNgR.js'), false ? __VITE_PRELOAD__ : void 0));
        var Portal = lazy(() => __vitePreload(() => module.import('./Portal-legacy-BYiiYw3r.js'), false ? __VITE_PRELOAD__ : void 0));
        var TextPage = lazy(() => __vitePreload(() => module.import('./Text-legacy-BMZZPybf.js'), false ? __VITE_PRELOAD__ : void 0));
        var CreatePage = lazy(() => __vitePreload(() => module.import('./Create-legacy-BG1kr5P6.js'), false ? __VITE_PRELOAD__ : void 0));
        var ViewportPage = lazy(() => __vitePreload(() => module.import('./Viewport-legacy-CyEqkCJF.js'), false ? __VITE_PRELOAD__ : void 0));
        var ButtonsPage = lazy(() => __vitePreload(() => module.import('./Buttons-legacy-BcXIvE8h.js'), false ? __VITE_PRELOAD__ : void 0));
        var FlexPage = lazy(() => __vitePreload(() => module.import('./Flex-legacy-DMD2OUGL.js'), false ? __VITE_PRELOAD__ : void 0));
        var FlexSizePage = lazy(() => __vitePreload(() => module.import('./FlexSize-legacy-CSq-XtNu.js'), false ? __VITE_PRELOAD__ : void 0));
        var FlexColumnSizePage = lazy(() => __vitePreload(() => module.import('./FlexColumnSize-legacy-DhVO4QRy.js'), false ? __VITE_PRELOAD__ : void 0));
        var FlexColumnPage = lazy(() => __vitePreload(() => module.import('./FlexColumn-legacy-p2LDjRap.js'), false ? __VITE_PRELOAD__ : void 0));
        var ButtonsMaterialPage = lazy(() => __vitePreload(() => module.import('./ButtonsMaterial-legacy-Dm0GIIOm.js'), false ? __VITE_PRELOAD__ : void 0));
        var SuperFlexPage = lazy(() => __vitePreload(() => module.import('./SuperFlex-legacy-SxdnG_nI.js'), false ? __VITE_PRELOAD__ : void 0));
        var Entity = lazy(() => __vitePreload(() => module.import('./Entity-legacy-BttI59Pb.js'), false ? __VITE_PRELOAD__ : void 0));
        var People = lazy(() => __vitePreload(() => module.import('./People-legacy-DMKxh4G8.js'), false ? __VITE_PRELOAD__ : void 0));
        var LoginPage = lazy(() => __vitePreload(() => module.import('./Login-legacy-t5N-HP3r.js'), false ? __VITE_PRELOAD__ : void 0));
...
//# sourceMappingURL=index-legacy-qVhuKOZg.js.map
