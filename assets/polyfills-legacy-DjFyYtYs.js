(function () {
	...
	var defineGlobalProperty$3 = function (key, value) {
	  try {
	    defineProperty$a(globalThis$K, key, { value: value, configurable: true, writable: true });
	  } catch (error) {
	...
	*/
	...
	var environment = (function () {
	  ...
	  if (classof$c(globalThis$A.process) === 'process') return 'NODE';
	...
	$$I({ target: 'Array', proto: true, arity: 1, forced: FORCED$1 }, {
	  // eslint-disable-next-line no-unused-vars -- required for `.length`
	...
	var ArrayBuffer$5 = globalThis$z.ArrayBuffer;
	...
	var ArrayBuffer$4 = globalThis$y.ArrayBuffer;
	...
	var $ArrayBuffer$1 = globalThis$v.ArrayBuffer;
