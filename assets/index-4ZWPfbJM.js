const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Buttons-B6mQS-N6.js","assets/Button-BRDy66rN.js","assets/Components-D6TgFIyq.js","assets/Entity-EJIu_p1j.js","assets/Login-Dt6QTMAn.js"])))=>i.map(i=>d[i]);
...
function calculateFlex(node) {
  ...
  if (isRow && node._calcHeight) {
    node.height = ((_a2 = children2[0]) == null ? void 0 : _a2.height) || node.height;
  } else if (node._calcWidth) {
    node.width = ((_b = children2[0]) == null ? void 0 : _b.width) || node.width;
  }
...
const propagateKeyDown = (e, mappedEvent, isHold) => {
  ...
  for (const elm of focusPath$1) {
    ...
    if (mappedEvent) {
      ...
      if (isFunction(onKeyHandler) && onKeyHandler.call(elm, e, elm, finalFocusElm) === true) {
        break;
      }
    } else {
    ...
    if (isFunction(fallbackFunction) && fallbackFunction.call(elm, e, mappedEvent, elm, finalFocusElm) === true) {
      break;
    }
  }
  return false;
...
const Grid = lazy(() => __vitePreload(() => import("./Grid-xdQ6y08O.js"), true ? [] : void 0));
const Portal = lazy(() => __vitePreload(() => import("./Portal-DcKVbQNB.js"), true ? [] : void 0));
const TextPage = lazy(() => __vitePreload(() => import("./Text-CfzJFbbN.js"), true ? [] : void 0));
const TextPosterPage = lazy(() => __vitePreload(() => import("./TextPoster-Cybbqvkl.js"), true ? [] : void 0));
const CreatePage = lazy(() => __vitePreload(() => import("./Create-CdEL2dKk.js"), true ? [] : void 0));
const ViewportPage = lazy(() => __vitePreload(() => import("./Viewport-B7yOKIfV.js"), true ? [] : void 0));
const ButtonsPage = lazy(() => __vitePreload(() => import("./Buttons-B6mQS-N6.js"), true ? __vite__mapDeps([0,1]) : void 0));
const PositioningPage = lazy(() => __vitePreload(() => import("./Positioning-PvlFG6qG.js"), true ? [] : void 0));
const TransitionsPage = lazy(() => __vitePreload(() => import("./Transitions-B_V-iHIM.js"), true ? [] : void 0));
const ComponentsPage = lazy(() => __vitePreload(() => import("./Components-D6TgFIyq.js"), true ? __vite__mapDeps([2,1]) : void 0));
const FocusHandlingPage = lazy(() => __vitePreload(() => import("./FocusHandling-BfUs-IRy.js"), true ? [] : void 0));
const GradientsPage = lazy(() => __vitePreload(() => import("./Gradients-C9SETTfW.js"), true ? [] : void 0));
const FlexPage = lazy(() => __vitePreload(() => import("./Flex-BThUImMR.js"), true ? [] : void 0));
const FlexSizePage = lazy(() => __vitePreload(() => import("./FlexSize-CZAKPS0F.js"), true ? [] : void 0));
const FlexColumnSizePage = lazy(() => __vitePreload(() => import("./FlexColumnSize-9n_GvxZw.js"), true ? [] : void 0));
const FlexColumnPage = lazy(() => __vitePreload(() => import("./FlexColumn-dGfgRSFJ.js"), true ? [] : void 0));
const ButtonsMaterialPage = lazy(() => __vitePreload(() => import("./ButtonsMaterial-BIPpgaBy.js"), true ? [] : void 0));
const SuperFlexPage = lazy(() => __vitePreload(() => import("./SuperFlex-iqbldu41.js"), true ? [] : void 0));
const Entity = lazy(() => __vitePreload(() => import("./Entity-EJIu_p1j.js"), true ? __vite__mapDeps([3,1]) : void 0));
const People = lazy(() => __vitePreload(() => import("./People-CwKnzc6X.js"), true ? [] : void 0));
const LoginPage = lazy(() => __vitePreload(() => import("./Login-Dt6QTMAn.js"), true ? __vite__mapDeps([4,1]) : void 0));
