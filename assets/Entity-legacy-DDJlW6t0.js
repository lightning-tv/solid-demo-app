...
(function () {
  ...
  System.register(['./index-legacy-Csf0RXrT.js', './Button-legacy-iVwB4uqg.js'], function (exports, module) {
    'use strict';

    var createSignal, useNavigate, createEffect, on, setGlobalBackground, createComponent, Show, View, ContentBlock, Row, Column, styles, memo, Text, TileRow, assertTruthy, Button;
    return {
