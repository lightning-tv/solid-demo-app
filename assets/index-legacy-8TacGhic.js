      ...
      execute: function execute() {
        ...
        var Inspector = /*#__PURE__*/function () {
          ...
          return _createClass(Inspector, [{
            ...
            value: function createDiv(id, properties) {
              ...
              for (var _key42 in properties) {
                this.updateNodeProperty(div,
                // really typescript? really?
                _key42, properties[_key42]);
              }
              return div;
            }
          }, {
            ...
            value: function createProxy(node, div) {
              ...
              return new Proxy(node, {
                set: function set(target, property, value) {
                  _this63.updateNodeProperty(div, property, value);
                  return Reflect.set(target, property, value);
                },
                get: function get(target, property, receiver) {
                  if (property === 'destroy') {
                    _this63.destroyNode(target.id);
                  }
                  if (property === 'animate') {
                    return function (props, settings) {
                      ...
                      return new Proxy(anim, {
                        get: function get(target, property, receiver) {
                          if (property === 'start') {
                            _this63.animateNode(div, props, settings);
                          }
            ...
            value) {
              ...
              if (property === 'data') {
                for (var _key43 in value) {
                  // eslint-disable-next-line @typescript-eslint/no-unsafe-member-access
                  var keyValue = value[_key43];
                  if (keyValue === undefined) {
                    div.removeAttribute("data-".concat(_key43));
                  } else {
                    div.setAttribute("data-".concat(_key43), String(keyValue));
                  }
                }
                return;
              }
        ...
        function createMatcher(path, partial, matchFilters) {
          ...
          return function (location) {
            ...
            for (var i = 0; i < len; i++) {
              ...
              var _key44 = dynamic ? segment.slice(1) : segment;
              if (dynamic && matchSegment(locSegment, matchFilter(_key44))) {
                match.params[_key44] = locSegment;
        ...
        function createRoutes(routeDef) {
          ...
          return asArray(routeDef.path).reduce(function (acc, originalPath) {
            var _iterator17 = _createForOfIteratorHelper(expandOptionals(originalPath)),
              _step17;
            try {
              for (_iterator17.s(); !(_step17 = _iterator17.n()).done;) {
                var expandedPath = _step17.value;
        ...
        function accessWith(valueOrFn) {
          for (var _len21 = arguments.length, args = new Array(_len21 > 1 ? _len21 - 1 : 0), _key47 = 1; _key47 < _len21; _key47++) {
        ...
        function createStaticStore(init) {
          ...
          var _loop11 = function _loop11(_key48) {
            Object.defineProperty(store, _key48, {
              get: function get() {
                return getValue(_key48);
              },
              enumerable: true
            });
          };
          for (var _key48 in init) {
            _loop11(_key48);
          }
        ...
        function getChildrenByPosition(node, x, y) {
          ...
          while (queue.length > 0) {
            ...
            var _iterator20 = _createForOfIteratorHelper(queue),
              _step20;
            try {
              for (_iterator20.s(); !(_step20 = _iterator20.n()).done;) {
                var currentNode = _step20.value;
        ...
        function chainFunctions() {
          for (var _len22 = arguments.length, args = new Array(_len22), _key50 = 0; _key50 < _len22; _key50++) {
          ...
          return function () {
            var result;
            for (var _len23 = arguments.length, innerArgs = new Array(_len23), _key51 = 0; _key51 < _len23; _key51++) {
        ...
        var Grid = lazy(function () {
          return __vitePreload(function () {
            return module.import('./Grid-legacy-B6N7Rq_G.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var Portal = lazy(function () {
          return __vitePreload(function () {
            return module.import('./Portal-legacy-CWYPp9pd.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var TextPage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./Text-legacy-t_tYSKlg.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var CreatePage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./Create-legacy-QUTbWdDw.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var ViewportPage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./Viewport-legacy-KkiW9b-K.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var ButtonsPage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./Buttons-legacy-D_yK0jr0.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var FlexPage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./Flex-legacy-IXrFXHN4.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var FlexSizePage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./FlexSize-legacy-B992NI8x.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var FlexColumnSizePage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./FlexColumnSize-legacy-Byt2CX09.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var FlexColumnPage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./FlexColumn-legacy-DfZhxHHE.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var ButtonsMaterialPage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./ButtonsMaterial-legacy-CalYBVZt.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var SuperFlexPage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./SuperFlex-legacy-UQgzro0u.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var Entity = lazy(function () {
          return __vitePreload(function () {
            return module.import('./Entity-legacy-DOretWHb.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var People = lazy(function () {
          return __vitePreload(function () {
            return module.import('./People-legacy-BrqnAO0E.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
        var LoginPage = lazy(function () {
          return __vitePreload(function () {
            return module.import('./Login-legacy-CaVVyWBb.js');
          }, false ? __VITE_PRELOAD__ : void 0);
        });
