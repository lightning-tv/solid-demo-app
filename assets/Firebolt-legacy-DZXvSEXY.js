            ...
            execute: function execute() {
                ...
                var _HDMIInput = {
                    ...
                    lowLatencyMode: function lowLatencyMode(params) {
                        return MockProps.mock("HDMIInput", "lowLatencyMode", params, undefined, 0, true);
                    },
                    autoLowLatencyModeCapable: function autoLowLatencyModeCapable(params) {
                        return MockProps.mock("HDMIInput", "autoLowLatencyModeCapable", params, undefined, 1, true);
                    },
                    edidVersion: function edidVersion(params) {
                        return MockProps.mock("HDMIInput", "edidVersion", params, undefined, 1, "2.0");
                    }
                };
                var _Device = {
                    id: function id(params) {
                ...
                function transform(result, transforms) {
                    ...
                    Object.keys(methods).forEach(function(key) {
                        ...
                        var _rpc_method$split = rpc_method.split("."), _rpc_method$split2 = _slicedToArray(_rpc_method$split, 2), module = _rpc_method$split2[0], method = _rpc_method$split2[1];
                        var params = {};
