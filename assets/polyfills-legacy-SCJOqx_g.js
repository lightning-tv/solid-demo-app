(function () {
  ...
  var ordinaryToPrimitive$2 = function (input, pref) {
    var fn, val;
    if (pref === 'string' && isCallable$q(fn = input.toString) && !isObject$s(val = call$C(fn, input))) return val;
    if (isCallable$q(fn = input.valueOf) && !isObject$s(val = call$C(fn, input))) return val;
    if (pref !== 'string' && isCallable$q(fn = input.toString) && !isObject$s(val = call$C(fn, input))) return val;
  ...
  var toPrimitive$3 = function (input, pref) {
    if (!isObject$r(input) || isSymbol$5(input)) return input;
    var exoticToPrim = getMethod$7(input, TO_PRIMITIVE$1);
    var result;
    if (exoticToPrim) {
      if (pref === undefined) pref = 'default';
      result = call$B(exoticToPrim, input, pref);
      if (!isObject$r(result) || isSymbol$5(result)) return result;
  ...
  var ie8DomDefine = !DESCRIPTORS$B && !fails$U(function () {
    // eslint-disable-next-line es/no-object-defineproperty -- required for testing
  ...
  objectGetOwnPropertyDescriptor.f = DESCRIPTORS$A ? $getOwnPropertyDescriptor$2 : function getOwnPropertyDescriptor(O, P) {
    ...
    if (hasOwn$r(O, P)) return createPropertyDescriptor$8(!call$A(propertyIsEnumerableModule$2.f, O, P), O[P]);
  };
  ...
  var v8PrototypeDefineBug = DESCRIPTORS$z && fails$T(function () {
    // eslint-disable-next-line es/no-object-defineproperty -- required for testing
  ...
  var CONFIGURABLE_LENGTH = DESCRIPTORS$v && !fails$S(function () {
  ...
  var isForced$5 = function (feature, detection) {
    ...
    return value === POLYFILL ? true
      : value === NATIVE ? false
      : isCallable$l(detection) ? fails$R(detection)
      : !!detection;
  };
  ...
  */
  ...
  var setSymbolDescriptor = DESCRIPTORS$t && fails$P(function () {
  ...
  var $defineProperty = function defineProperty(O, P, Attributes) {
    ...
    if (hasOwn$j(AllSymbols, key)) {
      if (!Attributes.enumerable) {
        if (!hasOwn$j(O, HIDDEN)) nativeDefineProperty$1(O, HIDDEN, createPropertyDescriptor$6(1, nativeObjectCreate(null)));
        O[HIDDEN][key] = true;
      } else {
  ...
  var $defineProperties = function defineProperties(O, Properties) {
    ...
    $forEach$2(keys, function (key) {
      if (!DESCRIPTORS$t || call$y($propertyIsEnumerable$1, properties, key)) $defineProperty(O, key, properties[key]);
    });
    return O;
  };
  ...
  $$1l({ global: true, constructor: true, wrap: true, forced: !NATIVE_SYMBOL$4, sham: !NATIVE_SYMBOL$4 }, {
    Symbol: $Symbol
  });
  ...
  $$1l({ target: SYMBOL, stat: true, forced: !NATIVE_SYMBOL$4 }, {
    useSetter: function () { USE_SETTER = true; },
    useSimple: function () { USE_SETTER = false; }
  });

  $$1l({ target: 'Object', stat: true, forced: !NATIVE_SYMBOL$4, sham: !DESCRIPTORS$t }, {
    // `Object.create` method
    // https://tc39.es/ecma262/#sec-object.create
    create: $create,
    // `Object.defineProperty` method
  ...
  $$1l({ target: 'Object', stat: true, forced: !NATIVE_SYMBOL$4 }, {
    // `Object.getOwnPropertyNames` method
    // https://tc39.es/ecma262/#sec-object.getownpropertynames
  ...
  var stringifyWithSymbolsFix = function (it, replacer) {
    ...
    args[1] = function (key, value) {
      ...
      if (isCallable$h($replacer)) value = call$w($replacer, this, $String$1(key), value);
  ...
  var FORCED$g = !NATIVE_SYMBOL$1 || fails$N(function () { getOwnPropertySymbolsModule$1.f(1); });
  ...
  var isPossiblePrototype$1 = function (argument) {
    return isObject$m(argument) || argument === null;
  };
  ...
  var inheritIfRequired$6 = function ($this, dummy, Wrapper) {
    ...
    if (
      ...
      NewTarget !== Wrapper &&
      isObject$k(NewTargetPrototype = NewTarget.prototype) &&
  ...
  var createProperty$6 = function (object, key, value) {
    if (DESCRIPTORS$q) definePropertyModule$2.f(object, key, createPropertyDescriptor$4(0, value));
  ...
  var getIterator$4 = function (argument, usingIterator) {
    ...
    if (aCallable$j(iteratorMethod)) return anObject$r(call$u(iteratorMethod, argument));
  ...
  var NEW_ITERATOR_PROTOTYPE = !isObject$h(IteratorPrototype$4) || fails$G(function () {
    var test = {};
  ...
  $$X({ global: true, forced: globalThis$y.globalThis !== globalThis$y }, {
  ...
  var collection$3 = function (CONSTRUCTOR_NAME, wrapper, common) {
    ...
    var REPLACE = isForced$3(
      CONSTRUCTOR_NAME,
      !isCallable$b(NativeConstructor) || !(IS_WEAK || NativePrototype.forEach && !fails$z(function () {
  ...
  var objectAssign = !$assign || fails$x(function () {
    ...
    while (argumentsLength > index) {
      ...
      while (length > j) {
        key = keys[j++];
        if (!DESCRIPTORS$j || call$q(propertyIsEnumerable, S, key)) T[key] = S[key];
      }
    } return T;
  } : $assign;
  ...
  // https://tc39.es/ecma262/#sec-object.defineproperties
  // eslint-disable-next-line es/no-object-defineproperties -- safe
  $$R({ target: 'Object', stat: true, forced: Object.defineProperties !== defineProperties, sham: !DESCRIPTORS$i }, {
    defineProperties: defineProperties
  });
  ...
  // https://tc39.es/ecma262/#sec-object.defineproperty
  // eslint-disable-next-line es/no-object-defineproperty -- safe
  $$Q({ target: 'Object', stat: true, forced: Object.defineProperty !== defineProperty$1, sham: !DESCRIPTORS$h }, {
  ...
  var IE_BUG = DESCRIPTORS$g && fails$w(function () {
    // eslint-disable-next-line es/no-object-create -- safe
  ...
  var FORCED$7 = !DESCRIPTORS$f || fails$v(function () { nativeGetOwnPropertyDescriptor$1(1); });

  // `Object.getOwnPropertyDescriptor` method
  // https://tc39.es/ecma262/#sec-object.getownpropertydescriptor
  $$O({ target: 'Object', stat: true, forced: FORCED$7, sham: !DESCRIPTORS$f }, {
  ...
  // https://tc39.es/ecma262/#sec-object.getownpropertydescriptors
  $$M({ target: 'Object', stat: true, sham: !DESCRIPTORS$e }, {
  ...
  // `Object.getPrototypeOf` method
  // https://tc39.es/ecma262/#sec-object.getprototypeof
  $$K({ target: 'Object', stat: true, forced: FAILS_ON_PRIMITIVES, sham: !CORRECT_PROTOTYPE_GETTER }, {
  ...
  // `parseInt` method
  // https://tc39.es/ecma262/#sec-parseint-string-radix
  $$H({ global: true, forced: parseInt !== $parseInt$1 }, {
    parseInt: $parseInt$1
  });
  ...
  function get$1(target, propertyKey /* , receiver */) {
    ...
    if (isObject$a(prototype = getPrototypeOf$4(target))) return get$1(prototype, propertyKey, receiver);
  }
  ...
  function set$1(target, propertyKey, V /* , receiver */) {
    ...
    if (!ownDescriptor) {
      if (isObject$9(prototype = getPrototypeOf$3(target))) {
