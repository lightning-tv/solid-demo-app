(function () {
	...
	var toString$n = uncurryThis$V({}.toString);
	...
	var getMethod$8 = function (V, P) {
	  var func = V[P];
	  return isNullOrUndefined$9(func) ? undefined : aCallable$l(func);
	};
	...
	var ordinaryToPrimitive$2 = function (input, pref) {
	  var fn, val;
	  if (pref === 'string' && isCallable$r(fn = input.toString) && !isObject$u(val = call$C(fn, input))) return val;
	  if (isCallable$r(fn = input.valueOf) && !isObject$u(val = call$C(fn, input))) return val;
	  if (pref !== 'string' && isCallable$r(fn = input.toString) && !isObject$u(val = call$C(fn, input))) return val;
	...
	var defineGlobalProperty$3 = function (key, value) {
	  try {
	    defineProperty$a(globalThis$N, key, { value: value, configurable: true, writable: true });
	  } catch (error) {
	...
	var toString$m = uncurryThis$R(1.0.toString);
	...
	var toPrimitive$2 = function (input, pref) {
	  if (!isObject$t(input) || isSymbol$4(input)) return input;
	  var exoticToPrim = getMethod$7(input, TO_PRIMITIVE$1);
	  var result;
	  if (exoticToPrim) {
	    if (pref === undefined) pref = 'default';
	    result = call$B(exoticToPrim, input, pref);
	    if (!isObject$t(result) || isSymbol$4(result)) return result;
	...
	var ie8DomDefine = !DESCRIPTORS$z && !fails$R(function () {
	  // eslint-disable-next-line es/no-object-defineproperty -- required for testing
	...
	objectGetOwnPropertyDescriptor.f = DESCRIPTORS$y ? $getOwnPropertyDescriptor$2 : function getOwnPropertyDescriptor(O, P) {
	  ...
	  if (hasOwn$s(O, P)) return createPropertyDescriptor$8(!call$A(propertyIsEnumerableModule$2.f, O, P), O[P]);
	};
	...
	var v8PrototypeDefineBug = DESCRIPTORS$x && fails$Q(function () {
	  // eslint-disable-next-line es/no-object-defineproperty -- required for testing
	...
	var EXISTS = hasOwn$r(FunctionPrototype$1, 'name');
	...
	if (NATIVE_WEAK_MAP$1 || shared$4.state) {
	  ...
	  set$3 = function (it, metadata) {
	    if (hasOwn$q(it, STATE)) throw new TypeError$7(OBJECT_ALREADY_INITIALIZED);
	    metadata.facade = it;
	...
	var CONFIGURABLE_LENGTH = DESCRIPTORS$t && !fails$P(function () {
	...
	var makeBuiltIn$2 = makeBuiltIn$3.exports = function (value, name, options) {
	  ...
	  if (!hasOwn$p(value, 'name') || (CONFIGURABLE_FUNCTION_NAME$2 && value.name !== name)) {
	    if (DESCRIPTORS$t) defineProperty$9(value, 'name', { value: name, configurable: true });
	  ...
	  try {
	    if (options && hasOwn$p(options, 'constructor') && options.constructor) {
	      if (DESCRIPTORS$t) defineProperty$9(value, 'prototype', { writable: false });
	...
	var objectKeysInternal = function (object, names) {
	  ...
	  var result = [];
	  var key;
	  for (key in O) !hasOwn$o(hiddenKeys$4, key) && hasOwn$o(O, key) && push$e(result, key);
	...
	var isForced$4 = function (feature, detection) {
	  ...
	  return value === POLYFILL ? true
	    : value === NATIVE ? false
	    : isCallable$m(detection) ? fails$O(detection)
	    : !!detection;
	};
	...
	*/
	...
	var wellKnownSymbolDefine = function (NAME) {
	  ...
	  if (!hasOwn$m(Symbol, NAME)) defineProperty$7(Symbol, NAME, {
	...
	var $Symbol = globalThis$F.Symbol;
	var SymbolPrototype$1 = $Symbol && $Symbol[PROTOTYPE$1];
	var RangeError$4 = globalThis$F.RangeError;
	var TypeError$6 = globalThis$F.TypeError;
	var QObject = globalThis$F.QObject;
	...
	var setSymbolDescriptor = DESCRIPTORS$r && fails$M(function () {
	...
	var $defineProperty = function defineProperty(O, P, Attributes) {
	  ...
	  if (hasOwn$k(AllSymbols, key)) {
	    if (!Attributes.enumerable) {
	      if (!hasOwn$k(O, HIDDEN)) nativeDefineProperty$1(O, HIDDEN, createPropertyDescriptor$6(1, nativeObjectCreate(null)));
	      O[HIDDEN][key] = true;
	    } else {
	...
	var $defineProperties = function defineProperties(O, Properties) {
	  ...
	  $forEach$2(keys, function (key) {
	    if (!DESCRIPTORS$r || call$y($propertyIsEnumerable$1, properties, key)) $defineProperty(O, key, properties[key]);
	  });
	  return O;
	};
	...
	var $getOwnPropertyNames = function getOwnPropertyNames(O) {
	  ...
	  $forEach$2(names, function (key) {
	    if (!hasOwn$k(AllSymbols, key) && !hasOwn$k(hiddenKeys$1, key)) push$c(result, key);
	  });
	  return result;
	};
	...
	if (!NATIVE_SYMBOL$5) {
	  $Symbol = function Symbol() {
	    ...
	    var setter = function (value) {
	      var $this = this === undefined ? globalThis$F : this;
	...
	$$1a({ global: true, constructor: true, wrap: true, forced: !NATIVE_SYMBOL$5, sham: !NATIVE_SYMBOL$5 }, {
	  Symbol: $Symbol
	});
	...
	$$1a({ target: SYMBOL, stat: true, forced: !NATIVE_SYMBOL$5 }, {
	  useSetter: function () { USE_SETTER = true; },
	  useSimple: function () { USE_SETTER = false; }
	});

	$$1a({ target: 'Object', stat: true, forced: !NATIVE_SYMBOL$5, sham: !DESCRIPTORS$r }, {
	  // `Object.create` method
	  // https://tc39.es/ecma262/#sec-object.create
	  create: $create,
	  // `Object.defineProperty` method
	...
	$$1a({ target: 'Object', stat: true, forced: !NATIVE_SYMBOL$5 }, {
	  // `Object.getOwnPropertyNames` method
	  // https://tc39.es/ecma262/#sec-object.getownpropertynames
	...
	var getJsonReplacerFunction = function (replacer) {
	  ...
	  for (var i = 0; i < rawLength; i++) {
	    ...
	    else if (typeof element == 'number' || classof$e(element) === 'Number' || classof$e(element) === 'String') push$b(keys, toString$j(element));
	  }
	...
	var exec$6 = uncurryThis$F(/./.exec);
	var charAt$8 = uncurryThis$F(''.charAt);
	...
	var stringifyWithSymbolsFix = function (it, replacer) {
	  ...
	  args[1] = function (key, value) {
	    ...
	    if (isCallable$i($replacer)) value = call$w($replacer, this, $String$1(key), value);
	...
	var FORCED$d = !NATIVE_SYMBOL$2 || fails$K(function () { getOwnPropertySymbolsModule$1.f(1); });

	// `Object.getOwnPropertySymbols` method
	// https://tc39.es/ecma262/#sec-object.getownpropertysymbols
	$$16({ target: 'Object', stat: true, forced: FORCED$d }, {
	  getOwnPropertySymbols: function getOwnPropertySymbols(it) {
	    var $getOwnPropertySymbols = getOwnPropertySymbolsModule$1.f;
	    return $getOwnPropertySymbols ? $getOwnPropertySymbols(toObject$g(it)) : [];
	  }
	});
	...
	var NativeSymbol = globalThis$E.Symbol;
	var SymbolPrototype = NativeSymbol && NativeSymbol.prototype;

	if (DESCRIPTORS$q && isCallable$h(NativeSymbol) && (!('description' in SymbolPrototype) ||
	  // Safari 12 bug
	  ...
	  var thisSymbolValue = uncurryThis$E(SymbolPrototype.valueOf);
	  var symbolDescriptiveString = uncurryThis$E(SymbolPrototype.toString);
	  var regexp = /^Symbol\((.*)\)[^)]+$/;
	  ...
	  defineBuiltInAccessor$d(SymbolPrototype, 'description', {
	    ...
	    get: function description() {
	      ...
	      var desc = NATIVE_SYMBOL$1 ? stringSlice$9(string, 7, -1) : replace$7(string, regexp, '$1');
	...
	var functionUncurryThisAccessor = function (object, key, method) {
	  try {
	    // eslint-disable-next-line es/no-object-getownpropertydescriptor -- safe
	    return uncurryThis$D(aCallable$j(Object.getOwnPropertyDescriptor(object, key)[method]));
	  } catch (error) { /* empty */ }
	};
	...
	var WebAssembly = globalThis$D[WEB_ASSEMBLY];
	...
	var createProperty$8 = function (object, key, value) {
	  if (DESCRIPTORS$o) definePropertyModule$2.f(object, key, createPropertyDescriptor$4(0, value));
	...
	$$13({ target: 'Array', proto: true, arity: 1, forced: FORCED$b }, {
	  // eslint-disable-next-line no-unused-vars -- required for `.length`
	...
	$$11({ target: 'Array', proto: true, forced: !HAS_SPECIES_SUPPORT$3 }, {
	...
	// `Array.prototype.find` method
	// https://tc39.es/ecma262/#sec-array.prototype.find
	$$10({ target: 'Array', proto: true, forced: SKIPS_HOLES$1 }, {
	...
	$$_({ target: 'Array', proto: true }, {
	  flat: function flat(/* depthArg = 1 */) {
	    ...
	    A.length = flattenIntoArray(A, O, O, sourceLen, 0, depthArg === undefined ? 1 : toIntegerOrInfinity$b(depthArg));
	    return A;
	  }
	});
	...
	var getIterator$4 = function (argument, usingIterator) {
	  ...
	  if (aCallable$i(iteratorMethod)) return anObject$r(call$u(iteratorMethod, argument));
	...
	var FORCED$a = NEGATIVE_ZERO$1 || !arrayMethodIsStrict$4('indexOf');

	// `Array.prototype.indexOf` method
	// https://tc39.es/ecma262/#sec-array.prototype.indexof
	$$X({ target: 'Array', proto: true, forced: FORCED$a }, {
	...
	var NEW_ITERATOR_PROTOTYPE = !isObject$j(IteratorPrototype$4) || fails$D(function () {
	  var test = {};
	...
	$$U({ target: 'Array', proto: true, arity: 1, forced: FORCED$9 }, {
	  // eslint-disable-next-line no-unused-vars -- required for `.length`
	...
	var environment = (function () {
	  ...
	  if (classof$c(globalThis$C.process) === 'process') return 'NODE';
	...
	var FORCED$8 = CHROME_BUG || !arrayMethodIsStrict$3('reduce');

	// `Array.prototype.reduce` method
	// https://tc39.es/ecma262/#sec-array.prototype.reduce
	$$T({ target: 'Array', proto: true, forced: FORCED$8 }, {
	...
	var push$a = uncurryThis$A(test.push);
	...
	var FORCED$7 = FAILS_ON_UNDEFINED || !FAILS_ON_NULL || !STRICT_METHOD$2 || !STABLE_SORT$1;
	...
	$$Q({ target: 'Array', proto: true, forced: !HAS_SPECIES_SUPPORT }, {
	  splice: function splice(start, deleteCount /* , ...items */) {
	    ...
	    if (argumentsLength === 0) {
	      ...
	      actualDeleteCount = min$7(max$2(toIntegerOrInfinity$a(deleteCount), 0), len - actualStart);
	    }
	...
	$$P({ target: 'Array', proto: true, arity: 1, forced: FORCED$6 }, {
	  // eslint-disable-next-line no-unused-vars -- required for `.length`
	...
	var ArrayBuffer$5 = globalThis$B.ArrayBuffer;
	var TypeError$5 = globalThis$B.TypeError;
	...
	var ArrayBuffer$4 = globalThis$A.ArrayBuffer;
	var ArrayBufferPrototype$4 = ArrayBuffer$4 && ArrayBuffer$4.prototype;
	var slice$5 = ArrayBufferPrototype$4 && uncurryThis$z(ArrayBufferPrototype$4.slice);
	...
	if (DESCRIPTORS$l && !('detached' in ArrayBufferPrototype$3)) {
	...
	var getBuiltInNodeModule$1 = function (name) {
	  if (IS_NODE$3) {
	    try {
	      return globalThis$z.process.getBuiltinModule(name);
	    } catch (error) { /* empty */ }
	    try {
	...
	var $ArrayBuffer$1 = globalThis$x.ArrayBuffer;
	var $MessageChannel = globalThis$x.MessageChannel;
	var detach = false;
	...
	var structuredClone = globalThis$w.structuredClone;
	var ArrayBuffer$3 = globalThis$w.ArrayBuffer;
	var DataView$2 = globalThis$w.DataView;
	var min$6 = Math.min;
	var ArrayBufferPrototype$2 = ArrayBuffer$3.prototype;
	var DataViewPrototype$1 = DataView$2.prototype;
	var slice$4 = uncurryThis$y(ArrayBufferPrototype$2.slice);
	...
	var getInt8 = uncurryThis$y(DataViewPrototype$1.getInt8);
	...
	if ($transfer$1) $$O({ target: 'ArrayBuffer', proto: true }, {
	...
	if ($transfer) $$N({ target: 'ArrayBuffer', proto: true }, {
	...
	var FAILS_ON_PRIMITIVES$2 = fails$y(function () { $isExtensible(1); });
	...
	var collection$3 = function (CONSTRUCTOR_NAME, wrapper, common) {
	  ...
	  $$L({ global: true, constructor: true, forced: Constructor !== NativeConstructor }, exported);
	...
	var objectAssign = !$assign || fails$v(function () {
	  ...
	  if (DESCRIPTORS$i && $assign({ b: 1 }, $assign(defineProperty$1({}, 'a', {
	    enumerable: true,
	    get: function () {
	  ...
	  while (argumentsLength > index) {
	    ...
	    while (length > j) {
	      key = keys[j++];
	      if (!DESCRIPTORS$i || call$q(propertyIsEnumerable, S, key)) T[key] = S[key];
	    }
	  } return T;
	} : $assign;
	...
	var IE_BUG = DESCRIPTORS$h && fails$u(function () {
	  // eslint-disable-next-line es/no-object-create -- safe
	...
	var FAILS_ON_PRIMITIVES$1 = fails$t(function () { $freeze(1); });

	// `Object.freeze` method
	// https://tc39.es/ecma262/#sec-object.freeze
	$$I({ target: 'Object', stat: true, forced: FAILS_ON_PRIMITIVES$1, sham: !FREEZING$1 }, {
	...
	var FORCED$5 = !DESCRIPTORS$g || fails$s(function () { nativeGetOwnPropertyDescriptor$1(1); });

	// `Object.getOwnPropertyDescriptor` method
	// https://tc39.es/ecma262/#sec-object.getownpropertydescriptor
	$$G({ target: 'Object', stat: true, forced: FORCED$5, sham: !DESCRIPTORS$g }, {
	...
	// https://tc39.es/ecma262/#sec-date.prototype-@@toprimitive
	if (!hasOwn$d(DatePrototype, TO_PRIMITIVE)) {
	...
	// https://tc39.es/ecma262/#sec-object.getownpropertydescriptors
	$$F({ target: 'Object', stat: true, sham: !DESCRIPTORS$f }, {
	...
	// `Object.getPrototypeOf` method
	// https://tc39.es/ecma262/#sec-object.getprototypeof
	$$E({ target: 'Object', stat: true, forced: FAILS_ON_PRIMITIVES, sham: !CORRECT_PROTOTYPE_GETTER }, {
	...
	if (!TO_STRING_TAG_SUPPORT) {
	  defineBuiltIn$b(Object.prototype, 'toString', toString$f, { unsafe: true });
	}
	...
	// `Set.prototype.intersection` method
	// https://github.com/tc39/proposal-set-methods
	$$o({ target: 'Set', proto: true, real: true, forced: INCORRECT }, {
	...
	// `Set.prototype.isDisjointFrom` method
	// https://github.com/tc39/proposal-set-methods
	$$n({ target: 'Set', proto: true, real: true, forced: !setMethodAcceptSetLike$4('isDisjointFrom') }, {
	...
	// `Set.prototype.isSubsetOf` method
	// https://github.com/tc39/proposal-set-methods
	$$m({ target: 'Set', proto: true, real: true, forced: !setMethodAcceptSetLike$3('isSubsetOf') }, {
	...
	// `Set.prototype.isSupersetOf` method
	// https://github.com/tc39/proposal-set-methods
	$$l({ target: 'Set', proto: true, real: true, forced: !setMethodAcceptSetLike$2('isSupersetOf') }, {
	...
	var u$ArrayCopyWithin = uncurryThis$g($ArrayCopyWithin);
	...
	var arrayValues = uncurryThis$e(ArrayIterators.values);
	var arrayKeys = uncurryThis$e(ArrayIterators.keys);
	var arrayEntries = uncurryThis$e(ArrayIterators.entries);
	...
	var splice$1 = uncurryThis$9([].splice);
	var id = 0;
	  ...
	  return defineBuiltIns$1(create$1(IteratorPrototype), {
	    ...
	    'return': function () {
	      ...
	      if (IS_ITERATOR) {
	        ...
	        return returnMethod ? call$5(returnMethod, iterator) : createIterResultObject$2(undefined, true);
	      }
	      if (state.inner) try {
